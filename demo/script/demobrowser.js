...
(function(){var gB="on",gA="px",gz="visible",gy="qx.debug",gx="Boolean",gw="qx.event.type.Mouse",gv="qx.event.type.Drag",gu="qx.event.type.Focus",gt="excluded",gs="Integer",fC="hidden",fB="_applyPadding",fA="qx.event.type.Event",fz="opacity",fy="contextmenu",fx="String",fw="tabIndex",fv="qx.event.type.Touch",fu="qx.event.type.Data",ft="focused",gI="changeVisibility",gJ="mshtml",gG="qx.event.type.KeySequence",gH="qx.client",gE=".",gF="absolute",gC="backgroundColor",gD="drag",gK="div",gL="disabled",gb="move",ga="dragstart",gd="qx.dynlocale",gc="dragchange",gf="dragend",ge="transitionEnd",gh="resize",gg="Decorator",fY="zIndex",fX="object",ej="default",ek="Color",em="qxType",en="",eo="changeToolTipText",ep="appear",eq="beforeContextmenuOpen",er="__eK",es="qx.ui.core.Transform",et="_applyNativeContextMenu",gW="Wrong 'height' value. ",gV="content",gU="_applyBackgroundColor",gT="_applyFocusable",hb="changeShadow",ha="__eD",gY="qx.event.type.KeyInput",gX="createChildControl",hd="__eJ",hc="Invalid left decorator inset detected: ",eS="_applyTransform",eT="Font",eQ="theme",eR="_applyShadow",eW="Invalid layout data: ",eX="Could not add widget to itself: ",eU="_applyEnabled",eV="_applySelectable",eO="Number",eP="_applyKeepActive",eB="transition",eA="transform",eD="_applyVisibility",eC="_applyTransparentVisibility",ex="__eI",ew="repeat",ez="qxDraggable",ey="__eR",ev="paddingLeft",eu="_applyDroppable",fd="_applyTransition",fe="protector",ff="#",fg="cursor",eY="qx.event.type.MouseWheel",fa="_applyCursor",fb="_applyDraggable",fc="changeTextColor",fh="$$widget",fi="changeContextMenu",eL="paddingTop",eK="The 'after' widget is not a child of this widget!",eJ="changeSelectable",eI=" of the widget ",eH="hideFocus",eG="Invalid top decorator inset detected: ",eF="none",eE="outline",eN="The 'before' widget is not a child of this widget!",eM="_applyAppearance",fj="hovered",fk="_applyOpacity",fl="url(",fm=")",fn="qx.ui.core.Widget",fo="minHeight is larger than maxHeight!",fp="__eP",fq="_applyFont",fr="qx.ui.core.ITransition",fs="qxDroppable",fG="The layout ",fF="changeZIndex",fE="changeTransition",fD="changeEnabled",fK="__eN",fJ="changeFont",fI="_applyDecorator",fH="_applyZIndex",fM="_applyTextColor",fL="qx.ui.menu.Menu",fT="Invalid right decorator inset detected: ",fU="Invalid widget to add: ",fR="changeDecorator",fS="_applyToolTipText",fP=" returned an invalid size hint!",fQ="true",fN="widget",fO="changeBackgroundColor",fV="_applyTabIndex",fW="Invalid bottom decorator inset detected: ",gl="changeAppearance",gk="/",gn="qxKeepFocus",gm="_applyContextMenu",gp="container",go="paddingBottom",gr="changeNativeContextMenu",gq="qx.ui.tooltip.ToolTip",gj="qxKeepActive",gi="_applyKeepFocus",gP="__eE",gQ="paddingRight",gR="minWidth is larger than maxWidth!",gS="changeLocale",gM="Wrong 'width' value. ",gN="changeTransform",gO="qx/static/blank.gif";
qx.Class.define(fn,{extend:qx.ui.core.LayoutItem,include:[qx.locale.MTranslation,qx.data.MBinding],construct:function(){qx.ui.core.LayoutItem.call(this);
...
},events:{appear:fA,disappear:fA,createChildControl:fu,resize:fu,move:fu,mousemove:gw,mouseover:gw,mouseout:gw,mousedown:gw,mouseup:gw,click:gw,dblclick:gw,contextmenu:gw,beforeContextmenuOpen:gw,mousewheel:eY,touchstart:fv,touchend:fv,touchmove:fv,touchcancel:fv,keyup:gG,keydown:gG,keypress:gG,keyinput:gY,focus:gu,blur:gu,focusin:gu,focusout:gu,activate:gu,deactivate:gu,capture:fA,losecapture:fA,drop:gv,dragleave:gv,dragover:gv,drag:gv,dragstart:gv,dragend:gv,dragchange:gv,droprequest:gv},properties:{paddingTop:{check:gs,init:0,apply:fB,themeable:true},paddingRight:{check:gs,init:0,apply:fB,themeable:true},paddingBottom:{check:gs,init:0,apply:fB,themeable:true},paddingLeft:{check:gs,init:0,apply:fB,themeable:true},padding:{group:[eL,gQ,go,ev],shorthand:true,themeable:true},transition:{check:fr,nullable:true,event:fE,apply:fd},transform:{check:es,nullable:true,event:gN,apply:eS},zIndex:{nullable:true,init:null,apply:fH,event:fF,check:gs,themeable:true},decorator:{nullable:true,init:null,apply:fI,event:fR,check:gg,themeable:true},shadow:{nullable:true,init:null,apply:eR,event:hb,check:gg,themeable:true},backgroundColor:{nullable:true,check:ek,apply:gU,event:fO,themeable:true},textColor:{nullable:true,check:ek,apply:fM,event:fc,themeable:true,inheritable:true},font:{nullable:true,apply:fq,check:eT,event:fJ,themeable:true,inheritable:true},opacity:{check:eO,apply:fk,themeable:true,nullable:true,init:null},cursor:{check:fx,apply:fa,themeable:true,inheritable:true,nullable:true},toolTip:{check:gq,nullable:true},toolTipText:{check:fx,nullable:true,event:eo,apply:fS},toolTipIcon:{check:fx,nullable:true,event:eo},blockToolTip:{check:gx,init:false},visibility:{check:[gz,fC,gt],init:gz,apply:eD,event:gI},transparentVisibility:{check:[gz,fC,gt],init:gz,apply:eC},enabled:{check:gx,inheritable:true,apply:eU,event:fD,init:true},anonymous:{init:false,check:gx},tabIndex:{check:gs,nullable:true,apply:fV},focusable:{check:gx,init:false,apply:gT},keepFocus:{check:gx,init:false,apply:gi},keepActive:{check:gx,init:false,apply:eP},draggable:{check:gx,init:false,apply:fb},droppable:{check:gx,init:false,apply:eu},selectable:{check:gx,init:false,event:eJ,apply:eV},contextMenu:{check:fL,apply:gm,nullable:true,event:fi},nativeContextMenu:{check:gx,init:false,themeable:true,event:gr,apply:et},appearance:{check:fx,init:fN,apply:eM,event:gl}},statics:{__eF:{},DEBUG:false,getWidgetByElement:function(cg,ch){while(cg){var ci=cg.$$widget;
if(ci!=null){var cj=qx.core.ObjectRegistry.fromHashCode(ci);
if(!ch||!cj.getAnonymous()){return cj;
}}try{cg=cg.parentNode;
}catch(e){return null;
}}return null;
},contains:function(parent,dc){while(dc){if(parent==dc){return true;
}dc=dc.getLayoutParent();
}return false;
...
},_setLayout:function(bA){if(qx.core.Variant.isSet(gy,gB)){if(bA){this.assertInstance(bA,qx.ui.layout.Abstract);
}}
if(this.__eN){this.__eN.connectToWidget(null);
}
if(bA){bA.connectToWidget(this);
}this.__eN=bA;
qx.ui.core.queue.Layout.add(this);
},setLayoutParent:function(parent){if(this.$$parent===parent){return;
}var cq=this.getContainerElement();
var cp=this.$$parent;
qx.core.property.Multi.moveObject(this,parent,cp);

if(this.$$parent&&!this.$$parent.$$disposed){this.$$parent.getContentElement().remove(cq);
}this.$$parent=parent||null;

if(parent&&!parent.$$disposed){this.$$parent.getContentElement().add(cq);
}qx.ui.core.queue.Visibility.add(this);
},_updateInsets:null,__eO:function(a,b){if(a==b){return false;
}
if(a==null||b==null){return true;
}var ie=qx.theme.manager.Decoration.getInstance();
var ih=ie.resolve(a).getInsets();
var ig=ie.resolve(b).getInsets();

if(ih.top!=ig.top||ih.right!=ig.right||ih.bottom!=ig.bottom||ih.left!=ig.left){return true;
}return false;
},renderLayout:function(W,top,X,Y){var bi=qx.ui.core.LayoutItem.prototype.renderLayout.call(this,W,top,X,Y);
if(!bi){return;
}var bb=this.getContainerElement();
var content=this.getContentElement();
var bf=bi.size||this._updateInsets;
var bj=gA;
var bg={};
if(bi.position){bg.left=W+bj;
bg.top=top+bj;
}if(bi.size){bg.width=X+bj;
bg.height=Y+bj;
}
if(bi.position||bi.size){bb.setStyles(bg);
}
if(bf||bi.local||bi.margin){var ba=this.getInsets();
var innerWidth=X-ba.left-ba.right;
var innerHeight=Y-ba.top-ba.bottom;
innerWidth=innerWidth<0?0:innerWidth;
innerHeight=innerHeight<0?0:innerHeight;
}var bd={};

if(this._updateInsets){bd.left=ba.left+bj;
bd.top=ba.top+bj;
}
if(bf){bd.width=innerWidth+bj;
bd.height=innerHeight+bj;
}
if(bf||this._updateInsets){content.setStyles(bd);
}
if(bi.size){var bh=this.__eK;

if(bh){bh.setStyles({width:X+gA,height:Y+gA});
}}
if(bi.size||this._updateInsets){if(this.__eI){this.__eI.resize(X,Y);
}}
if(bi.size){if(this.__eJ){var ba=this.__eJ.getInsets();
var be=X+ba.left+ba.right;
var bc=Y+ba.top+ba.bottom;
this.__eJ.resize(be,bc);
}}
if(bf||bi.local||bi.margin){if(this.__eN&&this.hasLayoutChildren()){this.__eN.renderLayout(innerWidth,innerHeight);
}else if(this.hasLayoutChildren()){throw new Error("At least one child in control "+this._findTopControl()+" requires a layout, but no one was defined!");
}}if(bi.position&&this.hasListener(gb)){this.fireDataEvent(gb,this.getBounds());
}
if(bi.size&&this.hasListener(gh)){this.fireDataEvent(gh,this.getBounds());
}delete this._updateInsets;
return bi;
},__eP:null,clearSeparators:function(){var U=this.__eP;

if(!U){return;
}var V=qx.ui.core.Widget.__eG;
var content=this.getContentElement();
var T;
...
},renderSeparator:function(hr,hs){var ht=qx.ui.core.Widget.__eG.getDecoratorElement(hr);
this.getContentElement().add(ht);
ht.resize(hs.width,hs.height);
ht.setStyles({left:hs.left+gA,top:hs.top+gA});
if(!this.__eP){this.__eP=[ht];
}else{this.__eP.push(ht);
}},_computeSizeHint:function(){var cc=this.getWidth();
var cb=this.getMinWidth();
var bW=this.getMaxWidth();
var ca=this.getHeight();
var bX=this.getMinHeight();
var bY=this.getMaxHeight();

if(qx.core.Variant.isSet(gy,gB)){if(cb!==null&&bW!==null){this.assert(cb<=bW,gR);
}
if(bX!==null&&bY!==null){this.assert(bX<=bY,fo);
}}var cd=this._getContentHint();
var bV=this.getInsets();
var cf=bV.left+bV.right;
var ce=bV.top+bV.bottom;

if(cc==null){cc=cd.width+cf;
}
if(ca==null){ca=cd.height+ce;
}
if(cb==null){cb=cf;

if(cd.minWidth!=null){cb+=cd.minWidth;
}}
if(bX==null){bX=ce;

if(cd.minHeight!=null){bX+=cd.minHeight;
}}
if(bW==null){if(cd.maxWidth==null){bW=Infinity;
}else{bW=cd.maxWidth+cf;
}}
if(bY==null){if(cd.maxHeight==null){bY=Infinity;
}else{bY=cd.maxHeight+ce;
}}return {width:cc,minWidth:cb,maxWidth:bW,height:ca,minHeight:bX,maxHeight:bY};
},invalidateLayoutCache:function(){qx.ui.core.LayoutItem.prototype.invalidateLayoutCache.call(this);

if(this.__eN){this.__eN.invalidateLayoutCache();
}},_getContentHint:function(){var cs=this.__eN;

if(cs){if(this.hasLayoutChildren()){var ct=cs.getSizeHint();

if(qx.core.Variant.isSet(gy,gB)){var cr=fG+cs.toString()+eI+this.toString()+fP;
this.assertInteger(ct.width,gM+cr);
this.assertInteger(ct.height,gW+cr);
}return ct;
}else{return {width:0,height:0};
}}else{return {width:100,height:50};
}},_getHeightForWidth:function(bN){var bR=this.getInsets();
var bU=bR.left+bR.right;
var bT=bR.top+bR.bottom;
var bS=bN-bU;
var bP=this._getLayout();

if(bP&&bP.hasHeightForWidth()){var bO=bP.getHeightForWidth(bN);
}else{bO=this._getContentHeightForWidth(bS);
}var bQ=bO+bT;
return bQ;
...
if(this.__eI){var dT=this.__eI.getInsets();

if(qx.core.Variant.isSet(gy,gB)){this.assertNumber(dT.top,eG+dT.top);
this.assertNumber(dT.right,fT+dT.right);
this.assertNumber(dT.bottom,fW+dT.bottom);
this.assertNumber(dT.left,hc+dT.left);
}top+=dT.top;
dU+=dT.right;
dW+=dT.bottom;
dV+=dT.left;
...
},show:function(){this.setVisibility(gz);
},hide:function(){this.setVisibility(fC);
},exclude:function(){this.setVisibility(gt);
},isVisible:function(){return this.getVisibility()===gz;
},isHidden:function(){return this.getVisibility()!==gz;
},isExcluded:function(){return this.getVisibility()===gt;
...
if(qx.core.Variant.isSet(gy,gB)){dC.qxType=gp;
dC.qxClass=this.classname;
}var dB={zIndex:0,position:gF};
return new qx.html.Element(gK,dB,dC);
},__eQ:function(){var cm=this._createContentElement();

if(qx.core.Variant.isSet(gy,gB)){cm.setAttribute(em,gV);
}cm.setStyles({"position":gF,"zIndex":10});
return cm;
},_createContentElement:function(){return new qx.html.Element(gK,{overflowX:fC,overflowY:fC});
...
},__eR:null,getLayoutChildren:function(){var ef=this.__eR;

if(!ef){return this.__eS;
}var eg;

for(var i=0,l=ef.length;i<l;i++){var ee=ef[i];

if(ee.hasUserBounds()||ee.isExcluded()){if(eg==null){eg=ef.concat();
}qx.lang.Array.remove(eg,ee);
}}return eg||ef;
},scheduleLayoutUpdate:function(){qx.ui.core.queue.Layout.add(this);
},invalidateLayoutChildren:function(){var r=this.__eN;

if(r){r.invalidateChildrenCache();
}qx.ui.core.queue.Layout.add(this);
},hasLayoutChildren:function(){var hW=this.__eR;
...
if(!hX.hasUserBounds()&&!hX.isExcluded()){return true;
}}return false;
},getChildrenContainer:function(){return this;
},__eS:[],_getChildren:function(){return this.__eR||this.__eS;
},_indexOf:function(by){var bz=this.__eR;

if(!bz){return -1;
}return bz.indexOf(by);
},_hasChildren:function(){var dF=this.__eR;
return dF!=null&&(!!dF[0]);
},addChildrenToQueue:function(dq){var dr=this.__eR;
...
}},_add:function(cn,co){if(cn.getLayoutParent()==this){qx.lang.Array.remove(this.__eR,cn);
}
if(this.__eR){this.__eR.push(cn);
}else{this.__eR=[cn];
}this.__eT(cn,co);
},_addAt:function(ea,eb,ec){if(!this.__eR){this.__eR=[];
}if(ea.getLayoutParent()==this){qx.lang.Array.remove(this.__eR,ea);
}var ed=this.__eR[eb];

if(ed===ea){return ea.setLayoutProperties(ec);
}
if(ed){qx.lang.Array.insertBefore(this.__eR,ea,ed);
}else{this.__eR.push(ea);
}this.__eT(ea,ec);
},_addBefore:function(dd,de,df){if(qx.core.Variant.isSet(gy,gB)){this.assertInArray(de,this._getChildren(),eN);
}
if(dd==de){return;
}
if(!this.__eR){this.__eR=[];
}if(dd.getLayoutParent()==this){qx.lang.Array.remove(this.__eR,dd);
}qx.lang.Array.insertBefore(this.__eR,dd,de);
this.__eT(dd,df);
},_addAfter:function(hT,hU,hV){if(qx.core.Variant.isSet(gy,gB)){this.assertInArray(hU,this._getChildren(),eK);
}
if(hT==hU){return;
}
if(!this.__eR){this.__eR=[];
}if(hT.getLayoutParent()==this){qx.lang.Array.remove(this.__eR,hT);
}qx.lang.Array.insertAfter(this.__eR,hT,hU);
this.__eT(hT,hV);
},_remove:function(dP){if(!this.__eR){throw new Error("This widget has no children!");
}qx.lang.Array.remove(this.__eR,dP);
this.__eU(dP);
},_removeAt:function(hD){if(!this.__eR){throw new Error("This widget has no children!");
}var hE=this.__eR[hD];
qx.lang.Array.removeAt(this.__eR,hD);
this.__eU(hE);
return hE;
},_removeAll:function(){if(!this.__eR){return;
}var cx=this.__eR.concat();
this.__eR.length=0;

for(var i=cx.length-1;i>=0;i--){this.__eU(cx[i]);
}qx.ui.core.queue.Layout.add(this);
},_afterAddChild:null,_afterRemoveChild:null,__eT:function(N,O){if(qx.core.Variant.isSet(gy,gB)){this.assertInstance(N,qx.ui.core.LayoutItem,fU+N);
this.assertNotIdentical(N,this,eX+N);

if(O!=null){this.assertType(O,fX,eW+O);
}}var parent=N.getLayoutParent();

if(parent&&parent!=this){parent._remove(N);
}N.setLayoutParent(this);
if(O){N.setLayoutProperties(O);
}else{this.updateLayoutProperties();
}if(this._afterAddChild){this._afterAddChild(N);
}},__eU:function(ii){if(qx.core.Variant.isSet(gy,gB)){this.assertNotUndefined(ii);
}
if(ii.getLayoutParent()!==this){throw new Error("Remove Error: "+ii+" is not a child of this widget!");
}ii.setLayoutParent(null);
if(this.__eN){this.__eN.invalidateChildrenCache();
}qx.ui.core.queue.Layout.add(this);
if(this._afterRemoveChild){this._afterRemoveChild(ii);
}},capture:function(bB){this.getContainerElement().capture(bB);
},releaseCapture:function(){this.getContainerElement().releaseCapture();
},_applyPadding:function(bv,bw,name){this._updateInsets=true;
qx.ui.core.queue.Layout.add(this);
},_createProtectorElement:function(){if(this.__eK){return;
}var s=this.__eK=new qx.html.Element;

if(qx.core.Variant.isSet(gy,gB)){s.setAttribute(em,fe);
}s.setStyles({position:gF,top:0,left:0,zIndex:7});
var t=this.getBounds();

if(t){this.__eK.setStyles({width:t.width+gA,height:t.height+gA});
}if(qx.core.Variant.isSet(gH,gJ)){s.setStyles({backgroundImage:fl+qx.util.ResourceManager.getInstance().toUri(gO)+fm,backgroundRepeat:ew});
}this.getContainerElement().add(s);
},_applyDecorator:function(h,j){if(qx.core.Variant.isSet(gy,gB)){if(h&&typeof h===fX){if(qx.ui.core.Widget.DEBUG){this.warn("Decorator instances may increase memory usage and processing time. Often it is better to lay them out to a theme file. Hash code of decorator object: "+h);
}}}var n=qx.ui.core.Widget.__eG;
var k=this.getContainerElement();
if(!this.__eK&&!qx.bom.client.Feature.CSS_POINTER_EVENTS){this._createProtectorElement();
}if(j){k.remove(this.__eI);
n.poolDecorator(this.__eI);
}if(h){var m=this.__eI=n.getDecoratorElement(h);
m.setStyle(fY,5);
k.add(m);
}else{delete this.__eI;
}this._applyBackgroundColor(this.getBackgroundColor());
this._applyOpacity(this.getOpacity());
if(this.__eO(j,h)){this._updateInsets=true;
qx.ui.core.queue.Layout.add(this);
}else if(h){var o=this.getBounds();

if(o){m.resize(o.width,o.height);
this.__eK&&
this.__eK.setStyles({width:o.width+gA,height:o.height+gA});
}}},_applyShadow:function(w,x){var E=qx.ui.core.Widget.__eH;
var z=this.getContainerElement();
if(x){z.remove(this.__eJ);
E.poolDecorator(this.__eJ);
}if(w){var B=this.__eJ=E.getDecoratorElement(w);
z.add(B);
var D=B.getInsets();
B.setStyles({left:(-D.left)+gA,top:(-D.top)+gA});
var C=this.getBounds();

if(C){var A=C.width+D.left+D.right;
var y=C.height+D.top+D.bottom;
B.resize(A,y);
}B.tint(null);
}else{delete this.__eJ;
}},_applyToolTipText:function(hF,hG){if(qx.core.Variant.isSet(gd,gB)){if(this.__eM){return;
}var hH=qx.locale.Manager.getInstance();
this.__eM=hH.addListener(gS,function(){if(hF&&hF.translate){this.setToolTipText(hF.translate());
}},this);
}},_applyTextColor:function(f,g){},_applyTransition:function(bK,bL){var bM=bL&&bL.controlsOpacity();

if(this.getTransparentVisibility()!=gz){if(bK){if(!bM&&bK.controlsOpacity()){this.addListener(ge,this.__ut);
this.addListener(ep,this.__uu);
}}else if(bM){this.removeListener(ge,this.__onTransitionEndOpacityHelper);
this.removeListener(ep,this.__uu);
}}
if(bK){bK=bK.getStyle();
}this.getContainerElement().setStyle(eB,bK);
},__ut:function(e){if(e.getProperty()!=fz){return;
}
if(this.getOpacity()==0){this.setVisibility(this.getTransparentVisibility());
}},__uu:function(e){if(this.getOpacity()!=0&&this.getTransparentVisibility()!=gz){this._applyOpacity(this.getOpacity());
}},_applyTransparentVisibility:function(u,v){},_applyOpacity:function(I,J){if(J==0&&this.getTransparentVisibility()!=gz&&!this.isVisible()){this.show();
return;
}this.getContainerElement().setStyle(fz,I==1?null:I);

if(qx.core.Variant.isSet(gH,gJ)){if(this.__eI){this.__eI.setStyle(fz,I==1?null:I);
}if(qx.bom.element.Decoration.isAlphaImageLoaderEnabled()){if(!qx.Class.isSubClassOf(this.getContentElement().constructor,qx.html.Image)){var K=(I==1||I==null)?null:0.99;
this.getContentElement().setStyle(fz,K);
}}}},_applyTransform:function(c,d){this.getContainerElement().setStyle(eA,c==null?null:c.getStyle());
},_applyZIndex:function(bn,bo){this.getContainerElement().setStyle(fY,bn==null?0:bn);
...
if(parent&&(dR==null||dQ==null||dR===gt||dQ===gt)){parent.invalidateLayoutChildren();
}qx.ui.core.queue.Visibility.add(this);
},_applyCursor:function(dx,dy){if(dx==null&&!this.isSelectable()){dx=ej;
}this.getContainerElement().setStyle(fg,dx,qx.bom.client.Engine.OPERA);
},_applyBackgroundColor:function(hk,hl){var hm=this.getBackgroundColor();
var ho=this.getContainerElement();

if(this.__eI){this.__eI.tint(hm);
ho.setStyle(gC,null);
}else{var hn=qx.theme.manager.Color.getInstance().resolve(hm);
ho.setStyle(gC,hn);
}},_applyFont:function(cS,cT){},__eV:null,$$stateChanges:null,_forwardStates:null,hasState:function(hi){var hj=this.__eV;
return !!hj&&!!hj[hi];
},addState:function(dK){var dL=this.__eV;
...
if(forward&&forward[dK]&&dO){var dM;

for(var dN in dO){dM=dO[dN];

if(dM instanceof qx.ui.core.Widget){dO[dN].addState(dK);
}}}},removeState:function(cU){var cV=this.__eV;
...
}}}},replaceState:function(bp,bq){var br=this.__eV;
...
}}}},__eW:null,__eX:null,__uj:null,syncAppearance:function(){var cB=qx.theme.manager.Appearance.getInstance();
var cA=this.__eV;
var cO=this.__uj;
if(!cO){if(this.$$subparent){var cN=this;
var cD=[];

do{cD.push(cN.$$subcontrol||cN.getAppearance());
}while(cN=cN.$$subparent);
cO=cD.reverse().join(gk).replace(/#[0-9]+/g,en);
}else{cO=this.getAppearance();
}}var cC=en;

if(cA){var cE=qx.Bootstrap.getKeys(cA);
var cF=cE.length;

if(cF==1){cC=gE+cE[0];
}else if(cF>1){cC=gE+cE.sort().join(gE);
}}var cG=qx.ui.core.Widget.__eF;
var cI=cO+cC;
var cM=cG[cI];

if(!cM){cM=cG[cI]=cB.styleFrom(cO,cA,null,this.getAppearance());
var cQ;
var cy=qx.core.property.Group;

for(var cH in cM){var cP=qx.core.property.Util.getPropertyDefinition(this.constructor,cH);
if(cP.group){if(cP.shorthand){var cR=cM[cH];

if(cR instanceof Array){cM[cH]=cR.length==4?cR:cy.expandShortHand(cR);
}else{cM[cH]=[cR,cR,cR,cR];
}}cQ=cP.group;

for(var i=0,l=cQ.length;i<l;i++){var cJ=cQ[i];
var cL=cM[cJ];

if(cL===undefined||qx.lang.Object.findWinnerKey(cM,cH,cJ)===cJ){cM[cQ[i]]=cM[cH][i];
}}delete cM[cH];
}}}var cz=this.__eW;

if(cz){var cK=cG[cz];
}this.__eW=cI;
qx.core.property.Multi.importData(this,cM,cK,eQ);
},getThemedValue:function(L){var M=this.__eW;
return M?qx.ui.core.Widget.__eF[M][L]:undefined;
},getInheritedValue:function(hO){var hQ=this.constructor;
var hP=hQ.$$inheritables||qx.core.property.Multi.getInheritableProperties(hQ);

if(hP[hO]){var parent=this.$$parent;
return parent&&parent.get(hO);
}},_applyAppearance:function(hg,hh){this.debug("Appearance changed: "+hh+" => "+hg);
...
}}}},syncWidget:function(){},getEventTarget:function(){var dz=this;

while(dz.getAnonymous()){dz=dz.getLayoutParent();

if(!dz){return null;
}}return dz;
},getFocusTarget:function(){var dA=this;

if(!dA.getEnabled()){return null;
}
while(dA.getAnonymous()||!dA.getFocusable()){dA=dA.getLayoutParent();

if(!dA||!dA.getEnabled()){return null;
}}return dA;
...
if(dJ==null){dJ=1;
}dI.setAttribute(fw,dJ);
if(qx.core.Variant.isSet(gH,gJ)){dI.setAttribute(eH,fQ);
}else{dI.setStyle(eE,eF);
}}else{if(dI.isNativelyFocusable()){dI.setAttribute(fw,-1);
}else if(dH){dI.setAttribute(fw,null);
}}},_applyKeepFocus:function(ck){var cl=this.getFocusElement();
cl.setAttribute(gn,ck?gB:null);
},_applyKeepActive:function(hR){var hS=this.getContainerElement();
hS.setAttribute(gj,hR?gB:null);
},_applyTabIndex:function(hq){if(hq==null){hq=1;
}else if(hq<1||hq>32000){throw new Error("TabIndex property must be between 1 and 32000");
}
if(this.getFocusable()&&hq!=null){this.getFocusElement().setAttribute(fw,hq);
}},_applySelectable:function(bI,bJ){if(bJ!==null){this._applyCursor(this.getCursor());
}this.getContainerElement().setSelectable(bI);
this.getContentElement().setSelectable(bI);
},_applyEnabled:function(eh,ei){if(eh===false){this.addState(gL);
this.removeState(fj);
if(this.isFocusable()){this.removeState(ft);
...
}}},_applyNativeContextMenu:function(di,dj,name){},_applyContextMenu:function(he,hf){if(hf){hf.removeState(fy);

if(hf.getOpener()==this){hf.resetOpener();
}
if(!he){this.removeListener(fy,this._onContextMenuOpen);
hf.removeListener(gI,this._onBeforeContextMenuOpen,this);
}}
if(he){he.setOpener(this);
he.addState(fy);

if(!hf){this.addListener(fy,this._onContextMenuOpen);
he.addListener(gI,this._onBeforeContextMenuOpen,this);
}}},_onContextMenuOpen:function(e){this.getContextMenu().openAtMouse(e);
e.stop();
},_onBeforeContextMenuOpen:function(e){if(e.getData()==gz&&this.hasListener(eq)){this.fireDataEvent(eq,e);
}},_onStopEvent:function(e){e.stopPropagation();
},_applyDraggable:function(hu,hv){if(!this.isEnabled()&&hu===true){hu=false;
}qx.ui.core.DragDropCursor.getInstance();
if(hu){this.addListener(ga,this._onDragStart);
this.addListener(gD,this._onDrag);
this.addListener(gf,this._onDragEnd);
this.addListener(gc,this._onDragChange);
}else{this.removeListener(ga,this._onDragStart);
this.removeListener(gD,this._onDrag);
this.removeListener(gf,this._onDragEnd);
this.removeListener(gc,this._onDragChange);
}this.getContainerElement().setAttribute(ez,hu?gB:null);
},_applyDroppable:function(dD,dE){if(!this.isEnabled()&&dD===true){dD=false;
}this.getContainerElement().setAttribute(fs,dD?gB:null);
},_onDragStart:function(e){qx.ui.core.DragDropCursor.getInstance().placeToMouse(e);
this.getApplicationRoot().setGlobalCursor(ej);
},_onDrag:function(e){qx.ui.core.DragDropCursor.getInstance().placeToMouse(e);
},_onDragEnd:function(e){qx.ui.core.DragDropCursor.getInstance().moveTo(-1000,-1000);
this.getApplicationRoot().resetGlobalCursor();
},_onDragChange:function(e){var hB=qx.ui.core.DragDropCursor.getInstance();
var hC=e.getCurrentAction();
hC?hB.setAction(hC):hB.resetAction();
},visualizeFocus:function(){this.addState(ft);
},visualizeBlur:function(){this.removeState(ft);
},scrollChildIntoView:function(dt,du,dv,dw){this.scrollChildIntoViewX(dt,du,dw);
this.scrollChildIntoViewY(dt,dv,dw);
},scrollChildIntoViewX:function(bk,bl,bm){this.getContentElement().scrollChildIntoViewX(bk.getContainerElement(),bl,bm);
},scrollChildIntoViewY:function(cu,cv,cw){this.getContentElement().scrollChildIntoViewY(cu.getContainerElement(),cv,cw);
...
},hasChildControl:function(bx){if(!this.__eY){return false;
}return !!this.__eY[bx];
},__eY:null,_getCreatedChildControls:function(){return this.__eY;
},getChildControl:function(bF,bG){if(!this.__eY){if(bG){return null;
}this.__eY={};
}var bH=this.__eY[bF];
...
},_showChildControl:function(hY){var ia=this.getChildControl(hY);
ia.show();
return ia;
},_excludeChildControl:function(ib){var ic=this.getChildControl(ib,true);

if(ic){ic.exclude();
}},_isChildControlVisible:function(dm){var dn=this.getChildControl(dm,true);

if(dn){return dn.isVisible();
}return false;
},_createChildControl:function(hw){if(!this.__eY){this.__eY={};
}else if(this.__eY[hw]){throw new Error("Child control '"+hw+"' already created!");
}var hA=hw.indexOf(ff);

if(hA==-1){var hx=this._createChildControlImpl(hw);
}else{var hx=this._createChildControlImpl(hw.substring(0,hA));
}
if(!hx){throw new Error("Unsupported control: "+hw);
}hx.$$subcontrol=hw;
hx.$$subparent=this;
var hy=this.__eV;
var forward=this._forwardStates;

if(hy&&forward&&hx instanceof qx.ui.core.Widget){for(var hz in hy){if(forward[hz]){hx.addState(hz);
}}}this.fireDataEvent(gX,hx);
return this.__eY[hw]=hx;
},_createChildControlImpl:function(H){return null;
},_disposeChildControls:function(){var hL=this.__eY;

if(!hL){return;
}var hJ=qx.ui.core.Widget;

for(var hK in hL){var hI=hL[hK];

if(!hJ.contains(this,hI)){hI.destroy();
}else{hI.dispose();
}}delete this.__eY;
...
},getContainerLocation:function(dX){var dY=this.getContainerElement().getDomElement();
return dY?qx.bom.element.Location.get(dY,dX):null;
},getContentLocation:function(dk){var dl=this.getContentElement().getDomElement();
return dl?qx.bom.element.Location.get(dl,dk):null;
},setDomLeft:function(F){var G=this.getContainerElement().getDomElement();

if(G){G.style.left=F+gA;
}else{throw new Error("DOM element is not yet created!");
}},setDomTop:function(p){var q=this.getContainerElement().getDomElement();

if(q){q.style.top=p+gA;
}else{throw new Error("DOM element is not yet created!");
}},setDomPosition:function(hM,top){var hN=this.getContainerElement().getDomElement();

if(hN){hN.style.left=hM+gA;
hN.style.top=top+gA;
}else{throw new Error("DOM element is not yet created!");
...
},clone:function(){var P=qx.ui.core.LayoutItem.prototype.clone.call(this);

if(this.getChildren){var Q=this.getChildren();

for(var i=0,l=Q.length;i<l;i++){P.add(Q[i].clone());
}}return P;
}},destruct:function(){if(!qx.core.ObjectRegistry.inShutDown){if(qx.core.Variant.isSet(gd,gB)){if(this.__eM){qx.locale.Manager.getInstance().removeListenerById(this.__eM);
...
}if(!qx.core.ObjectRegistry.inShutDown){var db=qx.ui.core.Widget;
var da=this.getContainerElement();

if(this.__eI){da.remove(this.__eI);
db.__eG.poolDecorator(this.__eI);
}
if(this.__eJ){da.remove(this.__eJ);
db.__eH.poolDecorator(this.__eJ);
}this.clearSeparators();
this.__eI=this.__eJ=this.__eP=null;
}else{this._disposeArray(fp);
this._disposeObjects(ex,hd);
}this._disposeArray(ey);
this.__eV=this.__eY=null;
this._disposeObjects(fK,ha,gP,er);
}});
})();
