...
(function(){var n="vertical",m="main",l="Flex:1",k="Flex:1; Min:250",j="Auto",i="Flex:2",h="Flex:0",g="Flex:2; Max:100",f="Flex:1; Max:100",e="Flex:1; Max:200",b="Flex:2; Min:250",d="Flex:0; Min:350",c="demobrowser.demo.layout.VSplit";
...
var a=new qx.ui.container.Composite(new qx.ui.layout.Canvas()).set({padding:20,allowShrinkX:false,allowShrinkY:false});
scroll.add(a);
a.add(this.getSplitPaneTwoFlexSimple(),{left:0});
a.add(this.getSplitPaneTwoFlexWithOneMin(),{left:210});
a.add(this.getSplitPaneTwoFlexWithOneMax(),{left:420});
a.add(this.getSplitPaneTwoFlexWithTwoMin(),{left:630});
a.add(this.getSplitPaneTwoFlexWithTwoMax(),{left:840});
a.add(this.getSplitPaneOneFlexSimple(),{top:550,left:0});
a.add(this.getSplitPaneOneFlexSimpleWithMax(),{top:550,left:210});
a.add(this.getSplitPaneOneFlexSimpleWithMin(),{top:550,left:420});
a.add(this.getSplitPaneAuto(),{top:550,left:630});
},getSplitPaneTwoFlexSimple:function(){var y=new qx.ui.splitpane.Pane(n);
y.setHeight(400);
y.setDecorator(m);
var x=new qx.ui.form.TextArea(l);
x.setDecorator(null);
x.setWrap(true);
y.add(x,1);
...
y.add(z,2);
return y;
},getSplitPaneTwoFlexWithOneMin:function(){var p=new qx.ui.splitpane.Pane(n);
p.setHeight(400);
p.setDecorator(m);
...
p.add(q,2);
return p;
},getSplitPaneTwoFlexWithOneMax:function(){var E=new qx.ui.splitpane.Pane(n);
E.setHeight(400);
E.setDecorator(m);
var D=new qx.ui.form.TextArea(l);
D.setDecorator(null);
D.setWrap(true);
E.add(D,1);
...
E.add(F,2);
return E;
},getSplitPaneTwoFlexWithTwoMin:function(){var s=new qx.ui.splitpane.Pane(n);
s.setHeight(400);
s.setDecorator(m);
var r=new qx.ui.form.TextArea(k);
r.setDecorator(null);
r.setWrap(true);
r.setMinHeight(250);
s.add(r,1);
var t=new qx.ui.form.TextArea(b);
t.setDecorator(null);
t.setWrap(true);
t.setMinHeight(250);
s.add(t,2);
return s;
},getSplitPaneTwoFlexWithTwoMax:function(){var N=new qx.ui.splitpane.Pane(n);
N.setHeight(400);
N.setDecorator(m);
var M=new qx.ui.form.TextArea(f);
M.setDecorator(null);
M.setWrap(true);
M.setMaxHeight(100);
N.add(M,1);
var O=new qx.ui.form.TextArea(g);
O.setDecorator(null);
O.setWrap(true);
O.setMaxHeight(100);
N.add(O,2);
return N;
},getSplitPaneOneFlexSimple:function(){var H=new qx.ui.splitpane.Pane(n);
H.setHeight(400);
H.setDecorator(m);
var G=new qx.ui.form.TextArea(h);
G.setDecorator(null);
G.setWrap(true);
H.add(G,0);
...
H.add(I);
return H;
},getSplitPaneOneFlexSimpleWithMax:function(){var v=new qx.ui.splitpane.Pane(n);
v.setHeight(400);
v.setDecorator(m);
var u=new qx.ui.form.TextArea(h);
u.setDecorator(null);
u.setWrap(true);
v.add(u,0);
var w=new qx.ui.form.TextArea(e);
w.setDecorator(null);
w.setWrap(true);
w.setMaxHeight(200);
v.add(w);
return v;
},getSplitPaneOneFlexSimpleWithMin:function(){var K=new qx.ui.splitpane.Pane(n);
K.setHeight(400);
K.setDecorator(m);
var J=new qx.ui.form.TextArea(d);
J.setDecorator(null);
J.setWrap(true);
J.setMinHeight(350);
K.add(J,0);
var L=new qx.ui.form.TextArea(l);
L.setDecorator(null);
L.setWrap(true);
K.add(L);
return K;
},getSplitPaneAuto:function(){var B=new qx.ui.splitpane.Pane(n);
B.setDecorator(m);
var A=new qx.ui.form.TextArea(j);
A.setDecorator(null);
A.setWrap(true);
B.add(A,0);
var C=new qx.ui.form.TextArea(j);
C.setDecorator(null);
C.setWrap(true);
B.add(C);
return B;
