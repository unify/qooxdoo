...
(function(){var g=" / ",f="horizontal",e="demobrowser.demo.virtual.Table",d="__QI",c="white",b="#EEE",a="vertical";
qx.Class.define(e,{extend:qx.application.Standalone,members:{__QI:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
this.__QI=new qx.ui.virtual.cell.Cell();
},getCellProperties:function(j,k){return this.__QI.getCellProperties(j+g+k);
