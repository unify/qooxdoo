...
},addSplitPaneTwoFlexSimple:function(){var M=new qx.ui.splitpane.Pane(p);
M.setWidth(400);
M.setHeight(60);
M.setDecorator(o);
...
N.setWrap(true);
M.add(N,2);
},addSplitPaneTwoFlexWithOneMin:function(){var u=new qx.ui.splitpane.Pane(p);
u.setWidth(400);
u.setHeight(60);
u.setDecorator(o);
this.getRoot().add(u,{left:20,top:100});
...
v.setWrap(true);
u.add(v,2);
},addSplitPaneTwoFlexWithOneMax:function(){var A=new qx.ui.splitpane.Pane(p);
A.setWidth(400);
A.setHeight(60);
A.setDecorator(o);
this.getRoot().add(A,{left:20,top:180});
var z=new qx.ui.form.TextArea(n);
z.setDecorator(null);
z.setWrap(true);
A.add(z,1);
var B=new qx.ui.form.TextArea(i);
B.setDecorator(null);
B.setWrap(true);
B.setMaxWidth(100);
A.add(B,2);
},addSplitPaneTwoFlexWithTwoMin:function(){var r=new qx.ui.splitpane.Pane(p);
r.setWidth(400);
r.setHeight(60);
r.setDecorator(o);
this.getRoot().add(r,{left:20,top:260});
...
s.setMinWidth(250);
r.add(s,2);
},addSplitPaneTwoFlexWithTwoMax:function(){var G=new qx.ui.splitpane.Pane(p);
G.setWidth(400);
G.setHeight(60);
G.setDecorator(o);
...
H.setMaxWidth(100);
G.add(H,2);
},addSplitPaneOneFlexSimple:function(){var J=new qx.ui.splitpane.Pane(p);
J.setWidth(400);
J.setHeight(60);
J.setDecorator(o);
this.getRoot().add(J,{left:500,top:20});
var I=new qx.ui.form.TextArea(j);
I.setDecorator(null);
I.setWrap(true);
J.add(I,0);
var K=new qx.ui.form.TextArea(n);
K.setDecorator(null);
K.setWrap(true);
J.add(K);
},addSplitPaneOneFlexSimpleWithMax:function(){var D=new qx.ui.splitpane.Pane(p);
D.setWidth(400);
D.setHeight(60);
D.setDecorator(o);
...
C.setWrap(true);
D.add(C,0);
var E=new qx.ui.form.TextArea(g);
E.setDecorator(null);
E.setWrap(true);
E.setMaxWidth(200);
D.add(E);
...
y.setWrap(true);
x.add(y);
},addSplitPaneAuto:function(){var b=new qx.ui.splitpane.Pane(p);
b.setDecorator(o);
this.getRoot().add(b,{left:500,top:340});
var a=new qx.ui.form.TextArea(l);
a.setDecorator(null);
a.setWrap(true);
b.add(a,0);
