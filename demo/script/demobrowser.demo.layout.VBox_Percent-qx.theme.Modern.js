...
A.add(this.getBox5());
A.add(this.getBox6());
},getBox1:function(){var B=new qx.ui.layout.VBox();
var D=new qx.ui.container.Composite(B).set({decorator:f,backgroundColor:c,height:300,allowGrowY:false});
B.setSpacing(5);
...
return i;
},getBox3:function(){var G=new qx.ui.layout.VBox();
var I=new qx.ui.container.Composite(G).set({decorator:f,backgroundColor:c,allowGrowY:false});
G.setSpacing(5);
var K=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
var J=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
var H=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
...
I.add(H,{flex:1});
return I;
},getBox4:function(){var l=new qx.ui.layout.VBox();
...
n.add(p,{height:d,flex:1});
n.add(o,{height:d,flex:1});
n.add(m,{height:d,flex:1});
return n;
},getBox5:function(){var v=new qx.ui.layout.VBox();
var x=new qx.ui.container.Composite(v).set({decorator:f,backgroundColor:c,height:100,allowGrowY:false});
v.setSpacing(5);
...
x.add(z,{height:d,flex:1});
x.add(y,{height:d,flex:1});
