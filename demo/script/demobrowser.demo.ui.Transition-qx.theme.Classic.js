...
qx.$$build = 1282828494674;
qx.$$type = "build";
  
if (!window.qxsettings) qxsettings = {};
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.ui.Transition","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.ui.Transition-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"5f3e791c4d2a"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var n="execute",m="main",l="opacity",k="red",j="Move",i="transitionEnd",h="transform",g="left",f="Fade",d="top",a="Transform",c="hidden",b="demobrowser.demo.ui.Transition";
...
s.add(u,{left:20,top:20});
u.addListener(n,function(e){var o=r.getLayoutProperties();
var p=o.top==20;
r.setLayoutProperties({"top":p?100:20,"left":p?400:200});
});
var t=new qx.ui.form.Button(f);
s.add(t,{left:20,top:50});
t.addListener(n,function(e){r.setOpacity(r.getOpacity()==0?1:0);
});
var w=new qx.ui.form.Button(a);
s.add(w,{left:20,top:80});
w.addListener(n,function(e){r.setTransform(r.getTransform()?null:v);
});
var r=new qx.ui.core.Widget;
r.setBackgroundColor(k);
r.setDecorator(m);
r.setTransparentVisibility(c);
s.add(r,{left:200,top:20});
var x=new qx.ui.core.MultiTransition;
x.add(new qx.ui.core.Transition(d));
x.add(new qx.ui.core.Transition(g));
x.add(new qx.ui.core.Transition(l));
x.add(new qx.ui.core.Transition(h));
r.setTransition(x);
var v=new qx.ui.core.Transform;
v.setRotate(-20);
v.setScale(1.6);
v.setTranslateY(40);
r.addListener(i,function(e){var q=e.getProperty();
this.debug("Transition ended: "+q);
});
}}});
})();
...
(function(){var a="qx.ui.core.ITransition";
qx.Interface.define(a,{members:{getStyle:function(){},controlsOpacity:function(){}}});
})();
(function(){var b="qx.ui.core.MultiTransition",a=",";
qx.Class.define(b,{extend:qx.core.Object,implement:qx.ui.core.ITransition,construct:function(){qx.core.Object.call(this);
this.__Qd=[];
},members:{__Qd:null,add:function(f){{};
this.__Qd.push(f);
},remove:function(c){{};
qx.lang.Array.remove(this.__Qd,c);
},getStyle:function(){var g=[];
var h=this.__Qd;

for(var i=0,l=h.length;i<l;i++){g.push(h[i].getStyle());
}return g.join(a);
},controlsOpacity:function(){var d=this.__Qd;
var e=false;

for(var i=0,l=d.length;i<l;i++){e=d[i].controlsOpacity();

if(e){break;
}}return e;
}}});
})();
(function(){var p="_applyTransition",o="opacity",n="ease",m=" ",l="Integer",k="ease-in",j="ease-in-out",i="qx.ui.core.Transition",h="left",g="ms",c="all",f="linear",e="top",b="transform",a="ease-out",d="ms ";
qx.Class.define(i,{extend:qx.core.Object,implement:qx.ui.core.ITransition,construct:function(u,v,w,x){qx.core.Object.call(this);

if(u!=null){this.setProperty(u);
}
if(v!=null){this.setDuration(v);
}
if(w!=null){this.setTiming(w);
}
if(x!=null){this.setDelay(x);
}},properties:{property:{check:[e,h,o,b],nullable:true,apply:p},duration:{check:l,init:300,apply:p},timing:{check:[n,f,k,a,j],init:n,apply:p},delay:{check:l,init:0,apply:p}},members:{__Qe:null,_applyTransition:function(r,s,t){this.__Qe=null;
},getStyle:function(){var q=this.__Qe;

if(q==null){q=this.__Qe=this.__Qf();
}return q;
},controlsOpacity:function(){return this.getProperty()==o;
},__Qf:function(){var y=qx.lang.String.hyphenate(qx.bom.element2.Style.property(this.getProperty()||c));
return y+m+this.getDuration()+d+this.getTiming()+m+this.getDelay()+g;
}}});
})();
...
(function(){var j="_applyTransform",i="Number",h=")",g="deg)",f="px)",e="qx.ui.core.Transform",d="skewX(",c="Integer",b="skewY",a="Array",y="scaleY",x="translateY",w="String",v="translateY(",u="translateX(",t="translateX",s="skewX",r="scaleY(",q="skewY(",p="rotate(",n="scaleX",o="scaleX(",l=" ",m="matrix(",k=",";
qx.Class.define(e,{extend:qx.core.Object,properties:{origin:{check:w,nullable:true},matrix:{check:a,nullable:true,apply:j},translateX:{check:i,nullable:true,apply:j},translateY:{check:i,nullable:true,apply:j},translate:{group:[t,x],shorthand:true},scaleX:{check:i,nullable:true,apply:j},scaleY:{check:i,nullable:true,apply:j},scale:{group:[n,y],shorthand:true},rotate:{check:c,nullable:true,apply:j},skewX:{check:i,nullable:true,apply:j},skewY:{check:i,nullable:true,apply:j},skew:{group:[s,b],shorthand:true}},members:{__Qg:null,_applyTransform:function(){this.__Qg=null;
},getStyle:function(){var I=this.__Qg;

if(I==null){I=this.__Qg=this.__Qh();
}return I;
},__Qh:function(){var z;
...
var B=this.getTranslateX();

if(B!=null){z.push(u+B+f);
}var H=this.getTranslateY();

if(H!=null){z.push(v+H+f);
}var D=this.getScaleX();

if(D!=null){z.push(o+D+h);
}var E=this.getScaleY();

if(E!=null){z.push(r+E+h);
}var A=this.getRotate();

if(A!=null){z.push(p+A+g);
}var G=this.getSkewX();

if(G!=null){z.push(d+G+g);
}var F=this.getSkewY();

if(F!=null){z.push(q+F+g);
}z=z.join(l);
}return z;
}}});
})();
