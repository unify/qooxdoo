...
cs.addListener(bB,function(e){if(e.getData()){var cF=cw.getSelectionMode();

if(cF==bC||cF==bG){this.debug("Drag selection is only available for the modes multi or additive");
}}cw.setDragSelection(e.getData());
});
cp.addListener(bB,function(e){if(e.getData()){var cE=cw.getSelectionMode();
