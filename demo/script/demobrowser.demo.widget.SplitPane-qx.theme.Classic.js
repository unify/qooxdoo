...
(function(){var A="value",z="horizontal",y="first",x="both",w="Trash",v="second",u="main",t="Show first pane",s="Documents (D:)",r="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",W="Windows (C:)",V="Toggle Splitpane Orientation",U="Inbox",T="Desktop",S="_container1",R="execute",Q="Presets",P="Network",O="__Rl",N="changeSelection",H="Sent",I="/",F="Files",G="_container2",D="vertical",E="Workspace",B="Junk #",C="Data",J="Show both panes",K="Show second pane",M="demobrowser.demo.widget.SplitPane",L="Edit";
qx.Class.define(M,{extend:qx.application.Standalone,members:{__Rl:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var ba=new qx.ui.container.Scroll();
var Y=new qx.ui.container.Composite(new qx.ui.layout.Basic());
Y.setAllowStretchX(false);
ba.add(Y);
var bg=new qx.ui.splitpane.Pane(z).set({width:450,height:300});
this.__Rl=bg;
var bj=new qx.ui.container.Composite(new qx.ui.layout.Grow).set({width:200,height:100,decorator:u});
var bm=new qx.ui.container.Composite(new qx.ui.layout.VBox(10)).set({padding:10,maxWidth:450,decorator:u});
var bd=this.__Rm();
var bc=new qx.ui.form.Button(V).set({allowGrowX:false,allowGrowY:false});
bc.addListener(R,this._toggle,this);
var be=new qx.ui.basic.Label(r);
be.setRich(true);
bj.add(bd);
bm.add(bc);
bm.add(be);
...
bg.add(bj,0);
bg.add(bm,1);
Y.add(bg,{left:20,top:40});
this.getRoot().add(ba,{edge:0});
var bb=new qx.ui.layout.VBox(5);
var bh=new qx.ui.container.Composite(bb);
var bk=new qx.ui.form.RadioButton(t);
var bl=new qx.ui.form.RadioButton(K);
var bi=new qx.ui.form.RadioButton(J);
bk.setUserData(A,y);
bl.setUserData(A,v);
bi.setUserData(A,x);
bi.setValue(true);
...
bh.add(bl);
bh.add(bi);
var bf=new qx.ui.form.RadioGroup(bk,bl,bi);
bf.addListener(N,this._changeVisiblity,this);
Y.add(bh,{left:490,top:42});
bc.focus();
},_toggle:function(){var X=this.__Rl.getOrientation();
this.__Rl.setOrientation(X==z?D:z);
},_changeVisiblity:function(e){var bn=e.getData()[0].getUserData(A);

if(bn==x){this._container1.show();
this._container2.show();
}else if(bn==y){this._container1.show();
this._container2.exclude();
}else if(bn==v){this._container1.exclude();
this._container2.show();
}},__Rm:function(){var l=new qx.ui.tree.Tree();
l.setDecorator(null);
var q=new qx.ui.tree.TreeFolder(I);
q.setOpen(true);
l.setRoot(q);
var o=new qx.ui.tree.TreeFolder(T);
o.setOpen(true);
q.add(o);
var f=new qx.ui.tree.TreeFolder(F);
var c=new qx.ui.tree.TreeFolder(E);
var d=new qx.ui.tree.TreeFolder(P);
var b=new qx.ui.tree.TreeFolder(w);
o.add(f,c,d,b);
var m=new qx.ui.tree.TreeFile(W);
var a=new qx.ui.tree.TreeFile(s);
c.add(m,a);
var p=new qx.ui.tree.TreeFolder(U);
var g=new qx.ui.tree.TreeFolder(Q);
var k=new qx.ui.tree.TreeFolder(H);
var j=new qx.ui.tree.TreeFolder(w);

for(var i=0;i<100;i++){j.add(new qx.ui.tree.TreeFile(B+i));
}var n=new qx.ui.tree.TreeFolder(C);
var h=new qx.ui.tree.TreeFolder(L);
p.add(g,k,j,n,h);
q.add(p);
return l;
}},destruct:function(){this._disposeObjects(O,S,G);
}});
})();
