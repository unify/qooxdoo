...
(function(){var bI="0px",bH="outline",bG="mshtml",bF="hideFocus",bE="none",bD="true",bC="qx.client",bB="div",bA="16px",bz="840px",bo="left",bn="<option value=''></option>",bm="1px solid #AAA",bl="'>",bk="value='",bj="</option>",bi="change",bh="select",bg="clear:both",bf="Insert Table",bP="Georgia",bQ="<p>This low-level widget can be used separately at ",bN="Indent More",bO="Change font family",bL="demobrowser/demo/icons/htmlarea/format-fill-color.png",bM="Align Right",bJ="Format Italic",bK="qx/icon/Oxygen/16/actions/format-text-underline.png",bR="350px",bS='<h1>About</h1><p>qooxdoo (pronounced [ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No <acronym title="HyperText Markup Language">HTML</acronym>, <acronym title="Cascading Style Sheets">CSS</acronym> nor <acronym title="Document Object Model">DOM</acronym> knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art <acronym title="Graphical User Interface">GUI</acronym> toolkit and an advanced client-server communication layer. It is Open Source under an <acronym title="GNU Lesser General Public License">LGPL</acronym>/<acronym title="Eclipse Public License">EPL</acronym> dual <a href="http://qooxdoo.org/license" class="wikilink1" title="license">license</a>.</p>',bs="white",br="buttons at the toolbar.</p>",bu="Times New Roman",bt="qx/icon/Oxygen/16/actions/format-indent-more.png",bw="Comic Sans MS",bv="Tahoma",by="20px 20px",bx="float",bq="<h1>HtmlArea low-level widget</h1>",bp="Align Left",b="qx/icon/Oxygen/16/actions/format-justify-center.png",c="input",d="Align Justify",f="demobrowser/demo/icons/htmlarea/insert-text.png",g="Insert Horizontal Ruler",h="demobrowser/demo/icons/htmlarea/insert-horizontal-rule.png",k="demobrowser/demo/icons/htmlarea/format-list-unordered.png",l="HTML Code:",m="Set Text Background Color",n="Insert Link",bW="You can play around with this widget by hitting the ",bV="Undo Last Change",bU="Set Text Color",bT="demobrowser/demo/icons/htmlarea/format-text-color.png",cb="traditional web pages / single-page applications.<br/> ",ca="demobrowser/demo/icons/htmlarea/insert-table.png",bY="qx/icon/Oxygen/16/actions/edit-undo.png",bX="qx/icon/Oxygen/16/actions/edit-clear.png",cd="Arial Black",cc="Impact",M="Change font size",N="Redo Last Undo Step",K="Format Bold",L="off",Q="qx/icon/Oxygen/16/actions/format-text-strikethrough.png",R="br",O="marginRight",P="image",I="<option qxKeepFocus='on' qxSelectable='off'",J="click",v="<option qxKeepFocus='on' qxSelectable='off' ",u="Remove Format",x="qx/icon/Oxygen/16/actions/insert-image.png",w="<p style='margin-bottom:10px'><b>No UI-level code</b> is included in this demo.",r="on",q="Insert HTML Code",t="qx/icon/Oxygen/16/actions/insert-link.png",s="Insert Ordered List",p="demobrowser.demo.bom.HtmlArea",o="qx/icon/Oxygen/16/actions/format-justify-left.png",W="Courier",X="Courier New",Y="4px",ba="qx/icon/Oxygen/16/actions/format-justify-right.png",S="qx/icon/Oxygen/16/actions/format-text-bold.png",T="Insert Image",U="qx/icon/Oxygen/16/actions/format-indent-less.png",V="demobrowser/demo/icons/htmlarea/format-list-ordered.png",bb="",bc="Align Center",F="qx/icon/Oxygen/16/actions/edit-redo.png",E="Lucida Console",D="innerHTML",C="qx/icon/Oxygen/16/actions/format-text-italic.png",B="Arial",A="qx/icon/Oxygen/16/actions/format-justify-fill.png",z="Verdana",y="Indent Less",H="Format Strikethrough",G="Format Underline",bd="Inserted Unordered List",be="It is the foundation for the UI widget component.</p>";
qx.Class.define(p,{extend:qx.application.Native,members:{__LO:null,__LP:null,__LQ:null,__LR:null,__LS:null,main:function(){qx.application.Native.prototype.main.call(this);
this.__LO=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(this.__LO,{margin:by});
var cz=qx.bom.Element.create(bB);
qx.bom.element.Style.setStyles(cz,{width:bz,padding:bI,margin:bI});
var cy=bq+bQ+cb+be+w+bW+br;
qx.bom.element.Attribute.set(cz,D,cy);
this.__LP=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(this.__LP,{width:bz,padding:bI,margin:bI,lineHeight:bI,border:bm});
this.__LQ=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(this.__LQ,{width:bz,height:bR,border:bm,borderTop:bI,backgroundColor:bs});
qx.dom.Element.insertEnd(this.__LQ,this.__LO);
var cx=bS;
this.__LR=new qx.bom.htmlarea.HtmlArea(this.__LQ,cx,null,"blank.html");
this.__Md();
qx.dom.Element.insertBegin(this.__LP,this.__LO);
qx.dom.Element.insertBegin(cz,this.__LO);
qx.dom.Element.insertBegin(this.__LO,document.body);
},__LT:function(e){var cf=window.prompt("FontSize: ","");
this.setFontSize(parseInt(cf));
},__LU:function(e){var ce=window.prompt("Color (Hex): ","#");
this.setTextColor(ce);
},__LV:function(e){var cA=window.prompt("BgColor (Hex): ","#");
this.setTextBackgroundColor(cA);
},__LW:function(e){var a={src:qx.util.ResourceManager.getInstance().toUri("demobrowser/demo/icons/htmlarea/qooxdoo_logo.png"),border:0,title:"qooxdoo logo",alt:"qooxdoo logo"};
this.insertImage(a);
},__LX:function(e){var cJ="<table border='1'>"+"<tbody>"+"<tr>"+"<td>First Row, First cell</td>"+"<td>First Row, Second cell</td>"+"</tr>"+"<tr>"+"<td>Second Row, First cell</td>"+"<td>Second Row, Second cell</td>"+"</tr>"+"</tbody>"+"</table>";
this.insertHtml(cJ);
},__LY:function(e){var co=window.prompt("Link: ","http://");
this.insertHyperLink(co);
},__Ma:function(e){var cw=window.prompt(l,bb);
this.insertHtml(cw);
},__Mb:function(){var cE=qx.bom.Element.create(bB);
qx.bom.element.Style.setStyles(cE,{"float":bo});
var cG;
var cF=qx.bom.Element.create(bh,{title:bO});

if(qx.core.Variant.isSet(bC,bG)){qx.bom.element.Attribute.set(cF,bF,bD);
}else{qx.bom.element.Style.set(cF,bH,bE);
}cG=qx.bom.Collection.html(bn);
qx.dom.Element.insertEnd(cG[0],cF);
var cH=[bv,z,bu,B,cd,X,W,bP,cc,bw,E];
var cD;
var cI;

for(var i=0,j=cH.length;i<j;i++){cD=I+bk+cH[i]+bl+cH[i]+bj;
cI=qx.bom.Collection.html(cD);

if(qx.core.Variant.isSet(bC,bG)){qx.bom.element.Attribute.set(cI[0],bF,bD);
}else{qx.bom.element.Style.set(cI[0],bH,bE);
}qx.dom.Element.insertEnd(cI[0],cF);
}qx.event.Registration.addListener(cF,bi,function(e){var cB=e.getTarget();
var cC=cB.selectedIndex;

if(cC!=0){this.setFontFamily(cB.options[cC].value);
cB.options[0].selected=true;
}},this.__LR);
qx.dom.Element.insertBegin(cF,cE);
return cE;
},__Mc:function(){var cq=qx.bom.Element.create(bB);
qx.bom.element.Style.setStyles(cq,{"marginRight":bA,"float":bo});
var cs;
var cr=qx.bom.Element.create(bh,{title:M});

if(qx.core.Variant.isSet(bC,bG)){qx.bom.element.Attribute.set(cr,bF,bD);
}else{qx.bom.element.Style.set(cr,bH,bE);
}cs=qx.bom.Collection.html(bn);
qx.dom.Element.insertEnd(cs[0],cr);
var ct;
var cp;

for(var i=1;i<=7;i++){cp=v+bk+i+bl+i+bj;
ct=qx.bom.Collection.html(cp);

if(qx.core.Variant.isSet(bC,bG)){qx.bom.element.Attribute.set(ct[0],bF,bD);
}else{qx.bom.element.Style.set(ct[0],bH,bE);
}qx.dom.Element.insertEnd(ct[0],cr);
}qx.event.Registration.addListener(cr,bi,function(e){var cu=e.getTarget();
var cv=cu.selectedIndex;

if(cv!=0){this.setFontSize(cu.options[cv].value);
cu.options[0].selected=true;
}},this.__LR);
qx.dom.Element.insertBegin(cr,cq);
return cq;
},__Md:function(){var ch=[{bold:{text:K,image:S,action:this.__LR.setBold},italic:{text:bJ,image:C,action:this.__LR.setItalic},underline:{text:G,image:bK,action:this.__LR.setUnderline},strikethrough:{text:H,image:Q,action:this.__LR.setStrikeThrough},removeFormat:{text:u,image:bX,action:this.__LR.removeFormat}},{alignLeft:{text:bp,image:o,action:this.__LR.setJustifyLeft},alignCenter:{text:bc,image:b,action:this.__LR.setJustifyCenter},alignRight:{text:bM,image:ba,action:this.__LR.setJustifyRight},alignJustify:{text:d,image:A,action:this.__LR.setJustifyFull}},{fontFamily:{custom:this.__Mb},fontSize:{custom:this.__Mc},fontColor:{text:bU,image:bT,action:this.__LU},textBackgroundColor:{text:m,image:bL,action:this.__LV}},{indent:{text:bN,image:bt,action:this.__LR.insertIndent},outdent:{text:y,image:U,action:this.__LR.insertOutdent}},{insertImage:{text:T,image:x,action:this.__LW},insertTable:{text:bf,image:ca,action:this.__LX},insertLink:{text:n,image:t,action:this.__LY},insertHTML:{text:q,image:f,action:this.__Ma},insertHR:{text:g,image:h,action:this.__LR.insertHorizontalRuler}},{ol:{text:s,image:V,action:this.__LR.insertOrderedList},ul:{text:bd,image:k,action:this.__LR.insertUnorderedList}},{undo:{text:bV,image:bY,action:this.__LR.undo},redo:{text:N,image:F,action:this.__LR.redo}}];
var cj,cn,cg,cl;

for(var i=0,j=ch.length;i<j;i++){cn={};
cn[O]=i==j-1?bI:bA;
cn[bx]=bo;
cj=qx.bom.Element.create(bB);
...
cl={type:P,src:qx.util.ResourceManager.getInstance().toUri(ci),title:cm.text,qxKeepFocus:r,qxSelectable:L};
cg=qx.bom.Element.create(c,cl);
qx.bom.element.Style.setStyles(cg,{width:bA,height:bA,padding:Y});

if(qx.core.Variant.isSet(bC,bG)){qx.bom.element.Attribute.set(cg,bF,bD);
}else{qx.bom.element.Style.set(cg,bH,bE);
}qx.event.Registration.addListener(cg,J,cm.action,this.__LR);
}qx.dom.Element.insertEnd(cg,cj);
}qx.dom.Element.insertEnd(cj,this.__LP);
}qx.dom.Element.insertEnd(qx.bom.Element.create(R,{style:bg}),this.__LP);
}}});
})();
