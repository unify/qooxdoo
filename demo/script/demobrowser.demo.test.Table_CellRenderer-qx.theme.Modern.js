...
(function(){var l="px",k="Cell ",j="x",h="demobrowser.demo.table.MUtil",g="500px",f="Column #",e="#FFE",d="div",c="absolute";
...
},updateContent:function(){},setFocusedCell:function(n,o){},getKeepFirstVisibleRowComplete:function(){return true;
},_updateScrollBarVisibility:function(){},getSelectionManager:function(){return J;
},getNewTablePaneHeader:function(E){return function(C){var D=new qx.ui.table.pane.Header(C);
return D;
};
},getNewTablePane:function(S){return function(m){return new qx.ui.table.pane.Pane(m);
};
},getEnabled:function(){return true;
}};
return F;
},getSelectionMock:function(){return {isSelectedIndex:function(O){return O==0;
...
},getColumnWidth:function(N){return 100;
...
},getPaneModelMock:function(){var R={getColumnAtX:function(x){return x;
},getColumnCount:function(){return 4;
},getX:function(M){return M;
...
},isColumnSortable:function(p){return true;
},getColumnName:function(y){return f+y;
...
for(var i=0;i<4;i++){B.push(k+i+j+A);
}return B;
},getValue:function(P,Q){return k+P+j+Q;
}};
},getPaneMock:function(){return {getFirstVisibleRow:function(){return 0;
}};
},getScrollerMock:function(){var v=this.getTableMock();
var u=this.getPaneModelMock();
var w=this.getPaneMock();
return {getTable:function(){return v;
},getTablePaneModel:function(){return u;
},getTablePane:function(){return w;
}};
},_getNewTableDiv:function(K){var L=qx.bom.Element.create(d);
qx.bom.element.Style.setStyles(L,{position:c,left:this._tableLeft+l,width:(K||150)+l,top:20+l,height:g,backgroundColor:e});
this._tableLeft+=(K||150)+20;
document.body.appendChild(L);
return L;
}}});
})();
(function(){var R="",Q="Hello",P="icon/16/actions/go-down.png",O="World",N="bold",M="Juhu",L="</div>",K="waiting",J="icon/16/actions/go-next.png",I="http://resources.qooxdoo.org/images/logo.gif",bw="$ ",bv="string",bu="border: 1px dotted green",bt="inactive",bs="decoration",br="multi<br>line",bq="between",bp="<",bo="<div style='position:absolute;height:20px;width:",bn="px;top:",Y="qx/decoration/Modern",ba="icon/16/actions/go-previous.png",W="icon",X="number",U="px'>",V="<i>italic</i>",S="0$",T="qx/icon/Tango",bb="<b>bold</b>",bc="icon/16/actions/go-up.png",bf="boolean",be="demobrowser.demo.test.Table_CellRenderer",bh="tooltip",bg="red",bj="icon/16/emotes/face-sad.png",bi="icon/16/emotes/face-smile.png",bd="left",bm=">=",bl="active",bk="object";
qx.Class.define(be,{extend:qx.application.Native,include:[demobrowser.demo.table.MUtil],members:{main:function(){qx.application.Native.prototype.main.call(this);
this.setUp();
...
qx.util.AliasManager.getInstance().add(bs,Y);
qx.util.AliasManager.getInstance().add(W,T);
},__Ph:function(ci,top,cj,ck,cl){var cm=[bo,cj,bn,top,U];
ck.createDataCellHtml(cl,cm);
cm.push(L);
ci.innerHTML+=cm.join(R);
},testDefaultRenderer:function(bM){var bN=100;
var bP={value:[null,M,32,new Date()],styleLeft:[0],styleWidth:[bN],styleHeight:[20],style:[R]};
var bO=this._getNewTableDiv(bN);
var top=0;
qx.util.Permutation.permute(bP,function(d){this.__Ph(bO,top,bN,bM,d);
top+=20;
},this);
},testBooleanRenderer:function(){var bT=70;
var bS=30;
var bU=new qx.ui.table.cellrenderer.Boolean();
var bQ={value:[null,true,false],styleLeft:[0],styleWidth:[bT],styleHeight:[bS],style:[R]};
var bR=this._getNewTableDiv(bT);
var top=0;
qx.util.Permutation.permute(bQ,function(H){this.__Ph(bR,top,bT,bU,H);
top+=bS;
},this);
bU.setIconFalse(bj);
bU.setIconTrue(bi);
qx.util.Permutation.permute(bQ,function(c){this.__Ph(bR,top,bT,bU,c);
top+=bS;
},this);
},testDateRenderer:function(){var h=180;
var j=new qx.ui.table.cellrenderer.Date();
var l={value:new Date(),styleLeft:[0],styleWidth:[h],styleHeight:[20],style:[R]};
var g=qx.util.format.DateFormat;
var k=[g.getDateTimeInstance(),g.getDateInstance()];
var e=this._getNewTableDiv(h);
var top=0;

for(var i=0;i<k.length;i++){var f=k[i];
j.setDateFormat(f);
this.__Ph(e,top,h,j,l);
top+=20;
}},testNumberRenderer:function(){var ca=new qx.ui.table.cellrenderer.Number();
var bY=100;
var cc={value:Math.PI,styleLeft:[0],styleWidth:[bY],styleHeight:[20],style:[R]};
var bX=qx.util.format.NumberFormat;
var cb=[bX.getIntegerInstance(),new bX().set({minimumFractionDigits:3,maximumFractionDigits:5,prefix:bw})];
var bV=this._getNewTableDiv(bY);
var top=0;

for(var i=0;i<cb.length;i++){var bW=cb[i];
ca.setNumberFormat(bW);
this.__Ph(bV,top,bY,ca,cc);
top+=20;
}},testImageRenderer:function(){var bz=new qx.ui.table.cellrenderer.Image();
var bx=50;
var bA={value:[null,P,bc,ba,J,I],styleLeft:[0],styleWidth:[bx],styleHeight:[20],style:[R],tooltip:[R,bh]};
var by=this._getNewTableDiv(bx);
var top=0;
qx.util.Permutation.permute(bA,function(bG){this.__Ph(by,top,bx,bz,bG);
top+=20;
},this);
},testStringRenderer:function(){var u=new qx.ui.table.cellrenderer.String();
var t=100;
var s=20;
var q={value:[null,Q,O],styleLeft:[0],styleWidth:[t],styleHeight:[s],style:[R]};
var r=this._getNewTableDiv(t);
var top=0;
qx.util.Permutation.permute(q,function(G){this.__Ph(r,top,t,u,G);
top+=20;
},this);
},testPasswordRenderer:function(){var E=new qx.ui.table.cellrenderer.Password();
var D=100;
var C=20;
var A={value:[null,Q,O],styleLeft:[0],styleWidth:[D],styleHeight:[C],style:[R]};
var B=this._getNewTableDiv(D);
var top=0;
qx.util.Permutation.permute(A,function(cn){this.__Ph(B,top,D,E,cn);
top+=20;
},this);
},testHtmlRenderer:function(){var bL=new qx.ui.table.cellrenderer.Html();
var bK=100;
var bJ=50;
var bH={value:[null,bb,V,br],styleLeft:[0],styleWidth:[bK],styleHeight:[bJ],style:[R]};
var bI=this._getNewTableDiv(bK);
var top=0;
qx.util.Permutation.permute(bH,function(b){this.__Ph(bI,top,bK,bL,b);
top+=20;
},this);
},testConditionalRenderer:function(){var bF=new qx.ui.table.cellrenderer.Conditional();
bF.addNumericCondition(bp,0,null,bg,null,null);
bF.addNumericCondition(bm,100,bd,null,null,null);
bF.addBetweenCondition(bq,0,2,null,null,null,N,null);
bF.addRegex(S,null,null,N,bu);
var bE=100;
var bD=20;
var bB={value:[null,1,2,100,200,-100,0],styleLeft:[0],styleWidth:[bE],table:[this.tableMock],styleHeight:[bD],style:[R]};
var bC=this._getNewTableDiv(bE);
var top=0;
qx.util.Permutation.permute(bB,function(F){this.__Ph(bC,top,bE,bF,F);
top+=20;
},this);
},testDynamicRenderer:function(){var ch=new qx.ui.table.cellrenderer.Dynamic();
ch.setCellRendererFactoryFunction(function(m){var o=m.value;
var n=qx.ui.table.cellrenderer;

switch(typeof o){case bv:if(o.match(/^icon\//)){return new n.Image();
}else{return new n.String();
}case bf:return new n.Boolean();
case X:return new n.Number();
case bk:if(o instanceof Date){return new n.Date();
}return new n.Default();
}});
var cg=100;
var cf=20;
var cd={value:[null,M,new Date(),30,P,false],styleLeft:[0],styleWidth:[cg],styleHeight:[cf],table:[this.tableMock],style:[R]};
var ce=this._getNewTableDiv(cg);
var top=0;
qx.util.Permutation.permute(cd,function(p){this.__Ph(ce,top,cg,ch,p);
top+=20;
},this);
},testReplaceRenderer:function(){var z=new qx.ui.table.cellrenderer.Replace();
z.setReplaceMap({1:bl,2:bt,3:K});
z.addReversedReplaceMap();
var y=100;
var x=20;
var v={value:[1,2,3],styleLeft:[0],styleWidth:[y],table:[this.tableMock],styleHeight:[x],style:[R]};
var w=this._getNewTableDiv(y);
var top=0;
qx.util.Permutation.permute(v,function(a){this.__Ph(w,top,y,z,a);
top+=20;
},this);
...
}},members:{__qp:16,__qq:16,__qr:null,_insetY:2,_identifyImage:function(t){throw new Error("_identifyImage is abstract");
},_getImageInfos:function(x){var y=this._identifyImage(x);
if(y==null||typeof x==d){y={url:y,tooltip:null};
}var z=null;

if(x.width&&x.height){z={width:x.imageWidth,height:x.imageHeight};
}else{z=this.__qs(y.url);
}y.width=z.width;
y.height=z.height;
return y;
},__qs:function(B){var E=qx.util.ResourceManager.getInstance();
...
},createDataCellHtml:function(G,H){this.__qr=this._getImageInfos(G);
return qx.ui.table.cellrenderer.Abstract.prototype.createDataCellHtml.call(this,G,H);
},_getCellClass:function(w){return qx.ui.table.cellrenderer.Abstract.prototype._getCellClass.call(this)+m;
},_getContentHtml:function(A){var content=l;
if(this.__qr.url){content=qx.bom.element.Decoration.create(this.__qr.url,j,{width:this.__qr.width+r,height:this.__qr.height+r,display:qx.bom.client.Engine.GECKO&&qx.bom.client.Engine.VERSION<1.9?g:h,verticalAlign:b,position:f});
}return content;
},_getCellAttributes:function(u){var v=this.__qr.tooltip;
...
this.initIconTrue();
this.initIconFalse();
},properties:{iconTrue:{check:g,init:e,apply:f},iconFalse:{check:g,init:b,apply:a}},members:{__Ot:null,__Ou:false,__Os:null,_applyIconTrue:function(h){this.__Ot=this.__Os.resolve(h);
},_applyIconFalse:function(l){this.__Ou=this.__Os.resolve(l);
...
switch(i.value){case true:j.url=this.__Ot;
break;
case false:j.url=this.__Ou;
break;
default:j.url=null;
break;
}return j;
}},destruct:function(){this.__Os=null;
}});
})();
(function(){var w="",v="==",u=">",t="between",s="<",r="regex",q="!between",p=">=",o="!=",n="<=",k=";",m='g',l=":",j="qx.ui.table.cellrenderer.Conditional";
qx.Class.define(j,{extend:qx.ui.table.cellrenderer.Default,construct:function(x,y,z,A){qx.ui.table.cellrenderer.Default.call(this);
...
this.__Oy=z||w;
this.__Oz=A||w;
},members:{__Ow:null,__Ox:null,__Oy:null,__Oz:null,__OA:function(Q,R){if(Q[1]!=null){R["text-align"]=Q[1];
}
if(Q[2]!=null){R["color"]=Q[2];
}
if(Q[3]!=null){R["font-style"]=Q[3];
}
if(Q[4]!=null){R["font-weight"]=Q[4];
...
}},addRegex:function(J,K,L,M,N,O){if(J!=null){var P=[r,K,L,M,N,J,O];
}
if(P!=null){this.conditions.push(P);
}else{throw new Error("regex cannot be null!");
}},_getCellStyle:function(B){if(!this.conditions.length){return B.style||w;
}var G=B.table.getTableModel();
var i;
var I;
var C;
var E={"text-align":this.__Ow,"color":this.__Ox,"font-style":this.__Oy,"font-weight":this.__Oz};

for(i in this.conditions){I=false;

if(qx.lang.Array.contains(this.numericAllowed,this.conditions[i][0])){if(this.conditions[i][6]==null){C=B.value;
}else{C=G.getValueById(this.conditions[i][6],B.row);
}
switch(this.conditions[i][0]){case v:if(C==this.conditions[i][5]){I=true;
}break;
case o:if(C!=this.conditions[i][5]){I=true;
}break;
case u:if(C>this.conditions[i][5]){I=true;
}break;
case s:if(C<this.conditions[i][5]){I=true;
}break;
case p:if(C>=this.conditions[i][5]){I=true;
}break;
case n:if(C<=this.conditions[i][5]){I=true;
}break;
}}else if(qx.lang.Array.contains(this.betweenAllowed,this.conditions[i][0])){if(this.conditions[i][7]==null){C=B.value;
}else{C=G.getValueById(this.conditions[i][7],B.row);
}
switch(this.conditions[i][0]){case t:if(C>=this.conditions[i][5]&&C<=this.conditions[i][6]){I=true;
}break;
case q:if(C<this.conditions[i][5]&&C>this.conditions[i][6]){I=true;
}break;
}}else if(this.conditions[i][0]==r){if(this.conditions[i][6]==null){C=B.value;
}else{C=G.getValueById(this.conditions[i][6],B.row);
}var D=new RegExp(this.conditions[i][5],m);
I=D.test(C);
}if(I==true){this.__OA(this.conditions[i],E);
}}var H=[];

for(var F in E){if(E[F]){H.push(F,l,E[F],k);
}}return H.join(w);
...
},members:{__qv:null,__qu:16,__qt:16,_identifyImage:function(e){var f={imageWidth:this.__qt,imageHeight:this.__qu};
