...
(function(){var l="Stopping recurrent 2-second timer",k="Recurrent 2-second timer with limit 3:",j="__Pi",i="\n",h="One-shot 1-second timer: ",g=" ",f="demobrowser.demo.test.TimerManager",e="Recurrent 5-second timer: ",d="Start timers",c="execute";
qx.Class.define(f,{extend:qx.application.Standalone,members:{__Pi:null,startTimers:function(){var m=qx.util.TimerManager.getInstance();
m.start(function(a,b){this.__Pj(e+b);
},5000,this,null,0);
m.start(function(t,u){this.__Pj(h+u);
},0,this,null,1000);
m.start(function(n,o){this.__Pj(k+o);

if(++n.count==3){this.__Pj(l);
m.stop(o);
}},2000,this,{count:0},2000);
},__Pj:function(v){v=Date.parse(new Date)+g+v+i;
this.__Pi.setValue(this.__Pi.getValue()+v);
...
r.addListener(c,function(){r.setEnabled(false);
this.startTimers();
},this);
