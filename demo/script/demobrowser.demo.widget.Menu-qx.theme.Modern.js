...
(function(){var dU="execute",dT="changeValue",dS="icon/16/actions/edit-cut.png",dR="changeSelection",dQ="icon/16/actions/edit-paste.png",dP="Copy",dO="Paste",dN="icon/16/actions/edit-copy.png",dM="Cut",dL="icon/16/actions/system-search.png",dg="New",df="Undo",de="icon/16/actions/document-save.png",dd="Redo",dc="icon/22/apps/preferences-users.png",db="icon/16/actions/document-print.png",da="icon/16/actions/document-open.png",cY="icon/16/actions/edit-undo.png",cX="Save",cW="icon/16/actions/edit-redo.png",ec="Print",ed="Open",ea="icon/16/actions/document-new.png",eb="Online Forum",dX="__Re",dY="icon/16/actions/format-justify-fill.png",dV="Search in files",dW="C",ee="Left aligned",ef="Perl",dE="View",dD="C Dialect",dG="Info...",dF="Save as...",dI="Show line numbers",dH="Quickstart",dK="icon/16/actions/contact-new.png",dJ="Ctrl+N",dC="Actions",dB="Show console",bN="Search",bO="Help",bP="Show status bar",bQ="icon/16/actions/format-justify-left.png",bR="ANSI to OEM",bS="Centered",bT="Website 3",bU="Edit",bV="icon/16/actions/format-justify-center.png",bW="Ctrl+O",ej="__Rd",ei="icon/16/actions/go-previous.png",eh="C Sharp",eg="Close",en="Split Button",em="Website 2",el="__Rj",ek="icon/16/actions/document-save-as.png",ep="Python",eo="icon/16/apps/utilities-help.png",cw="Show tree",cx="Options",cu="Spaces to tabs",cv="Right aligned",cA="Action 1",cB="OEM to ANSI",cy="Line 431",cz="JavaScript",cs="icon",ct="Action 2",cf="Folder ",ce="XML",ch="Line 313",cg="Paragraph",cb="demobrowser.demo.widget.Menu",ca="icon/16/actions/application-exit.png",cd="C Plus Plus",cc="Line 26",bY="Item ",bX="ASCII table",cG="__Rf",cH="Option 1",cI="Search next...",cJ="Line 12",cC="Action 3",cD="Replace in files",cE="Uppercase",cF="Ctrl+P",cK="__Rh",cL="Topics",cp="Panes",co="Justified",cn="Ctrl+X",cm="Search previous...",cl="Back",ck="main",cj="__Rk",ci="__Ri",cr="Show ruler",cq="icon/16/actions/format-justify-right.png",cM="icon/16/actions/go-next.png",cN="Ctrl+Z",cO="command ",cP="Option 3",cQ="Next",cR="Ctrl+R",cS="Show macros",cT="Show tags",cU="Capitals",cV="Format",dk="File",dj="Show tabs",di="Tabs to spaces",dh="Search...",dp="Line 1039",dn="Option 2",dm="__Rg",dl="Objective C",dr="Exit",dq="move to",dy="Ctrl+S",dz="Syntax",dw="Ctrl+C",dx="Website 1",du="Menu Button",dv="Line 30",ds="Lowercase",dt="Replace",dA="HTML";
qx.Class.define(cb,{extend:qx.application.Standalone,members:{__Rd:null,__Re:null,__Rf:null,__Rg:null,__Rh:null,__Ri:null,__Rj:null,__Rk:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var ez=new qx.ui.container.Scroll();
var ey=new qx.ui.container.Composite(new qx.ui.layout.Canvas);
ey.setPadding(20);
ey.setAllowStretchX(false);
ez.add(ey);
this.getRoot().add(ez,{edge:0});
this.createCommands();
ey.add(this.getMenuButton(),{left:20,top:20});
ey.add(this.getSplitButton(),{left:150,top:20});
ey.add(this.getMenuBar(),{left:20,top:100});
ey.add(this.getList(),{left:20,top:200});
this.getRoot().setContextMenu(this.getRootContextMenu());
},getRootContextMenu:function(){var bE=new qx.ui.menu.Menu();
var bF=new qx.ui.menu.Menu();

for(var i=0;i<30;i++){bF.add(new qx.ui.menu.Button(cf+(i+1)));
}bE.add(new qx.ui.menu.Button(dq,null,null,bF));
bE.add(new qx.ui.menu.Separator());

for(var i=0;i<7;i++){bE.add(new qx.ui.menu.Button(cO+(i+1)));
}return bE;
...
},createCommands:function(){this.__Rd=new qx.ui.core.Command(dJ);
this.__Rd.addListener(dU,this.debugCommand);
this.__Re=new qx.ui.core.Command(bW);
this.__Re.addListener(dU,this.debugCommand);
this.__Rf=new qx.ui.core.Command(dy);
this.__Rf.addListener(dU,this.debugCommand);
this.__Rg=new qx.ui.core.Command(cN);
this.__Rg.addListener(dU,this.debugCommand);
this.__Rh=new qx.ui.core.Command(cR);
this.__Rh.addListener(dU,this.debugCommand);
this.__Ri=new qx.ui.core.Command(cn);
this.__Ri.addListener(dU,this.debugCommand);
this.__Rj=new qx.ui.core.Command(dw);
this.__Rj.addListener(dU,this.debugCommand);
this.__Rk=new qx.ui.core.Command(cF);
this.__Rk.addListener(dU,this.debugCommand);
this.__Rk.setEnabled(false);
},getMenuButton:function(){var eA=new qx.ui.menu.Menu;
eA.add(new qx.ui.menu.RadioButton(cH));
eA.add(new qx.ui.menu.RadioButton(dn));
eA.add(new qx.ui.menu.RadioButton(cP));
var eI=new qx.ui.menu.Menu;
eI.add(new qx.ui.menu.RadioButton(cA));
eI.add(new qx.ui.menu.RadioButton(ct));
eI.add(new qx.ui.menu.RadioButton(cC));
var eH=new qx.ui.form.RadioGroup;
eH.add.apply(eH,eA.getChildren());
eH.addListener(dR,this.debugRadio);
var eF=new qx.ui.form.RadioGroup;
eF.add.apply(eF,eI.getChildren());
eF.addListener(dR,this.debugRadio);
var eD=new qx.ui.menu.Menu();
var eG=new qx.ui.menu.Button(df,cY,this.__Rg);
var eN=new qx.ui.menu.Button(dd,cW,this.__Rh);
var eC=new qx.ui.menu.Button(dM,dS,this.__Ri);
var eK=new qx.ui.menu.Button(dP,dN,this.__Rj);
var eE=new qx.ui.menu.Button(dO,dQ,this.__Rk);
var eB=new qx.ui.menu.Button(cx,dL,null,eA);
var eL=new qx.ui.menu.Button(dC,dK,null,eI);
var eJ=new qx.ui.menu.Button(ec,db);
eG.addListener(dU,this.debugButton);
eN.addListener(dU,this.debugButton);
eC.addListener(dU,this.debugButton);
eK.addListener(dU,this.debugButton);
eE.addListener(dU,this.debugButton);
eB.addListener(dU,this.debugButton);
eL.addListener(dU,this.debugButton);
eJ.addListener(dU,this.debugButton);
eD.add(eG);
eD.add(eN);
eD.addSeparator();
eD.add(eC);
...
eD.addSeparator();
eD.add(eJ);
var eM=new qx.ui.form.MenuButton(du,dc,eD);
return eM;
},getSplitButton:function(){var eq=new qx.ui.menu.Menu;
var eu=new qx.ui.menu.Button(dx);
var es=new qx.ui.menu.Button(em);
var et=new qx.ui.menu.Button(bT);
eq.setMinWidth(120);
eu.addListener(dU,this.debugButton);
es.addListener(dU,this.debugButton);
et.addListener(dU,this.debugButton);
eq.add(eu);
eq.add(es);
eq.add(et);
var er=new qx.ui.form.SplitButton(en,dc,eq);
er.addListener(dU,this.debugButton);
return er;
},getMenuBar:function(){var H=new qx.ui.container.Composite(new qx.ui.layout.Grow);
H.setDecorator(ck);
...
var K=new qx.ui.toolbar.Part;
toolbar.add(Q);
toolbar.add(G);
toolbar.addSpacer();
toolbar.add(K);
var P=new qx.ui.toolbar.SplitButton(cl,ei,this.getBackMenu());
var M=new qx.ui.toolbar.SplitButton(cQ,cM,this.getForwardMenu());
var F=new qx.ui.toolbar.Button(dg,ea,this.__Rd);
var J=new qx.ui.toolbar.Button(ed,da,this.__Re);
var O=new qx.ui.toolbar.Button(cX,de,this.__Rf);
P.addListener(dU,this.debugButton);
M.addListener(dU,this.debugButton);
F.addListener(dU,this.debugButton);
J.addListener(dU,this.debugButton);
O.addListener(dU,this.debugButton);
Q.add(P);
Q.add(M);
Q.addSeparator();
Q.add(F);
...
Q.add(O);
Q.setShow(cs);
var I=new qx.ui.toolbar.MenuButton(dk);
var E=new qx.ui.toolbar.MenuButton(bU);
var D=new qx.ui.toolbar.MenuButton(bN);
var R=new qx.ui.toolbar.MenuButton(dE);
var N=new qx.ui.toolbar.MenuButton(cV);
I.setMenu(this.getFileMenu());
E.setMenu(this.getEditMenu());
D.setMenu(this.getSearchMenu());
R.setMenu(this.getViewMenu());
N.setMenu(this.getFormatMenu());
G.add(I);
G.add(E);
G.add(D);
G.add(R);
G.add(N);
var L=new qx.ui.toolbar.MenuButton(bO);
L.setMenu(this.getHelpMenu());
K.add(L);
return H;
},getBackMenu:function(){var z=new qx.ui.menu.Menu;
var A=new qx.ui.menu.Button(ch);
var C=new qx.ui.menu.Button(dp);
var y=new qx.ui.menu.Button(cJ);
var B=new qx.ui.menu.Button(cc);
A.addListener(dU,this.debugButton);
C.addListener(dU,this.debugButton);
y.addListener(dU,this.debugButton);
B.addListener(dU,this.debugButton);
z.add(A);
z.add(C);
z.add(y);
z.add(B);
return z;
},getForwardMenu:function(){var ev=new qx.ui.menu.Menu;
var ew=new qx.ui.menu.Button(cy);
var ex=new qx.ui.menu.Button(dv);
ew.addListener(dU,this.debugButton);
ex.addListener(dU,this.debugButton);
ev.add(ew);
ev.add(ex);
return ev;
},getFileMenu:function(){var bj=new qx.ui.menu.Menu;
var bh=new qx.ui.menu.Button(dg,ea,this.__Rd);
var bl=new qx.ui.menu.Button(ed,da,this.__Re);
var bk=new qx.ui.menu.Button(eg);
var bo=new qx.ui.menu.Button(cX,de,this.__Rf);
var bn=new qx.ui.menu.Button(dF,ek);
var bm=new qx.ui.menu.Button(ec,db);
var bi=new qx.ui.menu.Button(dr,ca);
bh.addListener(dU,this.debugButton);
bl.addListener(dU,this.debugButton);
bk.addListener(dU,this.debugButton);
bo.addListener(dU,this.debugButton);
bn.addListener(dU,this.debugButton);
bm.addListener(dU,this.debugButton);
bi.addListener(dU,this.debugButton);
bj.add(bh);
bj.add(bl);
bj.add(bk);
bj.add(bo);
...
bj.add(bi);
return bj;
},getEditMenu:function(){var bc=new qx.ui.menu.Menu;
var bf=new qx.ui.menu.Button(df,cY,this.__Rg);
var be=new qx.ui.menu.Button(dd,cW,this.__Rh);
var bb=new qx.ui.menu.Button(dM,dS,this.__Ri);
var bg=new qx.ui.menu.Button(dP,dN,this.__Rj);
var bd=new qx.ui.menu.Button(dO,dQ,this.__Rk);
bf.addListener(dU,this.debugButton);
be.addListener(dU,this.debugButton);
bb.addListener(dU,this.debugButton);
bg.addListener(dU,this.debugButton);
bd.addListener(dU,this.debugButton);
bc.add(bf);
bc.add(be);
bc.addSeparator();
bc.add(bb);
...
bc.add(bd);
return bc;
},getSearchMenu:function(){var p=new qx.ui.menu.Menu;
var n=new qx.ui.menu.Button(dh,dL);
var s=new qx.ui.menu.Button(cI);
var o=new qx.ui.menu.Button(cm);
var r=new qx.ui.menu.Button(dt);
var m=new qx.ui.menu.Button(dV,dL);
var q=new qx.ui.menu.Button(cD);
o.setEnabled(false);
n.addListener(dU,this.debugButton);
s.addListener(dU,this.debugButton);
o.addListener(dU,this.debugButton);
r.addListener(dU,this.debugButton);
m.addListener(dU,this.debugButton);
q.addListener(dU,this.debugButton);
p.add(n);
p.add(s);
p.add(o);
p.add(r);
...
p.add(q);
return p;
},getViewMenu:function(){var by=new qx.ui.menu.Menu;
var bA=new qx.ui.menu.Button(cp,null,null,this.getPanesMenu());
var bD=new qx.ui.menu.Button(dz,null,null,this.getSyntaxMenu());
var bC=new qx.ui.menu.CheckBox(cr);
var bB=new qx.ui.menu.CheckBox(dI);
var bz=new qx.ui.menu.Button(bX);
bC.addListener(dT,this.debugCheckBox);
bB.addListener(dT,this.debugCheckBox);
bz.addListener(dU,this.debugButton);
by.add(bA);
by.add(bD);
by.addSeparator();
by.add(bC);
...
by.add(bz);
return by;
},getPanesMenu:function(){var bH=new qx.ui.menu.Menu;
var bJ=new qx.ui.menu.CheckBox(dj);
var bL=new qx.ui.menu.CheckBox(bP);
var bM=new qx.ui.menu.CheckBox(cw);
var bI=new qx.ui.menu.CheckBox(cS);
var bK=new qx.ui.menu.CheckBox(cT);
var bG=new qx.ui.menu.CheckBox(dB);
bJ.setValue(true);
bL.setValue(true);
bI.setValue(true);
bJ.addListener(dT,this.debugCheckBox);
bL.addListener(dT,this.debugCheckBox);
bM.addListener(dT,this.debugCheckBox);
bI.addListener(dT,this.debugCheckBox);
bK.addListener(dT,this.debugCheckBox);
bG.addListener(dT,this.debugCheckBox);
bH.add(bL);
bH.add(bJ);
bH.addSeparator();
bH.add(bM);
...
bH.add(bG);
return bH;
},getSyntaxMenu:function(){var W=new qx.ui.menu.Menu;
var S=new qx.ui.menu.RadioButton(dA);
var U=new qx.ui.menu.RadioButton(ce);
var T=new qx.ui.menu.RadioButton(cz);
var V=new qx.ui.menu.Button(dD,null,null,this.getSyntaxCMenu());
var ba=new qx.ui.menu.RadioButton(ef);
var X=new qx.ui.menu.RadioButton(ep);
W.add(S);
W.add(U);
W.add(T);
W.add(V);
...
Y.add(S,U,T,ba,X);
Y.add.apply(Y,V.getMenu().getChildren());
Y.addListener(dR,this.debugRadio);
return W;
},getSyntaxCMenu:function(){var u=new qx.ui.menu.Menu;
var t=new qx.ui.menu.RadioButton(dW);
var x=new qx.ui.menu.RadioButton(eh);
var w=new qx.ui.menu.RadioButton(dl);
var v=new qx.ui.menu.RadioButton(cd);
u.add(t);
u.add(x);
u.add(w);
u.add(v);
...
var d=new qx.ui.menu.Button(cg,null,null,this.getParagraphMenu());
var h=new qx.ui.menu.Button(di);
var j=new qx.ui.menu.Button(cu);
var c=new qx.ui.menu.Button(cE);
var g=new qx.ui.menu.Button(ds);
var b=new qx.ui.menu.Button(cU);
var l=new qx.ui.menu.Button(cB);
var k=new qx.ui.menu.Button(bR);
h.addListener(dU,this.debugButton);
j.addListener(dU,this.debugButton);
c.addListener(dU,this.debugButton);
g.addListener(dU,this.debugButton);
b.addListener(dU,this.debugButton);
l.addListener(dU,this.debugButton);
k.addListener(dU,this.debugButton);
f.add(d);
f.add(h);
f.add(j);
f.addSeparator();
...
f.add(k);
return f;
},getParagraphMenu:function(){var bt=new qx.ui.menu.Menu;
var bw=new qx.ui.menu.Button(ee,bQ);
var bx=new qx.ui.menu.Button(cv,cq);
var bu=new qx.ui.menu.Button(bS,bV);
var bv=new qx.ui.menu.Button(co,dY);
bw.addListener(dU,this.debugButton);
bx.addListener(dU,this.debugButton);
bu.addListener(dU,this.debugButton);
bv.addListener(dU,this.debugButton);
bt.add(bw);
bt.add(bx);
bt.add(bu);
bt.add(bv);
...
var eQ=new qx.ui.menu.Button(cL,eo);
var eS=new qx.ui.menu.Button(dH);
var eR=new qx.ui.menu.Button(eb);
var eP=new qx.ui.menu.Button(dG);
eQ.addListener(dU,this.debugButton);
eS.addListener(dU,this.debugButton);
eR.addListener(dU,this.debugButton);
eP.addListener(dU,this.debugButton);
eO.add(eQ);
eO.add(eS);
eO.addSeparator();
eO.add(eR);
...
eO.add(eP);
return eO;
},getList:function(){var a=new qx.ui.form.List;
a.setContextMenu(this.getContextMenu());

for(var i=0;i<20;i++){a.add(new qx.ui.form.ListItem(bY+i));
}return a;
},getContextMenu:function(){var bp=new qx.ui.menu.Menu;
var br=new qx.ui.menu.Button(dM,dS,this.__Ri);
var bs=new qx.ui.menu.Button(dP,dN,this.__Rj);
var bq=new qx.ui.menu.Button(dO,dQ,this.__Rk);
br.addListener(dU,this.debugButton);
bs.addListener(dU,this.debugButton);
bq.addListener(dU,this.debugButton);
bp.add(br);
bp.add(bs);
bp.add(bq);
return bp;
}},destruct:function(){this._disposeObjects(ej,dX,cG,dm,cK,ci,el,cj);
}});
})();
...
qx.Class.define(p,{extend:qx.ui.core.Widget,include:[qx.ui.core.MExecutable],implement:[qx.ui.form.IExecutable],construct:function(H,I,J,K){qx.ui.core.Widget.call(this);
this._setLayout(new qx.ui.layout.HBox);
this._createChildControl(k);
...
b.resetOpener();
}},_applyShow:function(L,M){},_onMouseOver:function(e){e.stopPropagation();
this.addState(m);
delete this.__Fi;
...
if(E&&E.isVisible()){this.__Fi=true;
return;
}this.removeState(m);
},_onKeyDown:function(e){var G=this.getChildControl(n);

switch(e.getKeyIdentifier()){case j:case i:G.removeState(h);
G.addState(l);
}},_onKeyUp:function(e){var V=this.getChildControl(n);

switch(e.getKeyIdentifier()){case j:case i:if(V.hasState(l)){V.removeState(h);
V.removeState(l);
V.execute();
}}},_onButtonExecute:function(e){this.execute();
},_onChangeMenuVisibility:function(e){if(!this.getMenu().isVisible()&&this.__Fi){this.removeState(m);
}}}});
})();
