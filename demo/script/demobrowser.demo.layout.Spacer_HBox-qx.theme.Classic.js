...
},getSpacerWithoutFlex:function(){var n=new qx.ui.container.Composite().set({decorator:g,backgroundColor:e,allowGrowX:false});
var o=new qx.ui.layout.HBox();
o.setSpacing(5);
n.setLayout(o);
n.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f}));
n.add(new qx.ui.core.Spacer(30,40));
n.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f}));
n.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f}));
return n;
...
return k;
},getAddRemoveSpacer:function(){var h=new qx.ui.container.Composite().set({decorator:g,backgroundColor:e});
var j=new qx.ui.layout.HBox();
j.setSpacing(5);
h.setLayout(j);
h.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f,maxHeight:40,alignY:d}));
h.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f,maxHeight:40,alignY:b}));
var i=new qx.ui.core.Spacer(30,40);
h.add(i,{flex:1});
h.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f,maxHeight:40,alignY:c}));
h.remove(i);
return h;
}}});
})();
