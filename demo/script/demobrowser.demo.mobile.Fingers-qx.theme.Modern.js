...
qx.$$build = 1282828334877;
qx.$$type = "build";
  
if (!window.qxsettings) qxsettings = {};
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.mobile.Fingers","qx.theme":"qx.theme.Modern"};
...
(function(){var v="px",u="div",t="50px",s="100px",r="white",q="100%",p="absolute",o="touchmove",n="black",m="20px",d="30px",l="blue",h="demobrowser.demo.mobile.Fingers",c="0px",b="innerHTML",g="green",f="touchstart",j="<b>Use your fingers to move the dots</b>",a="yellow",k="red";
qx.Class.define(h,{extend:qx.application.Native,members:{__MD:null,__ME:null,main:function(){qx.application.Native.prototype.main.call(this);
{};
var C={"width":q,"height":q,"backgroundColor":n,"margin":c};
var G=new qx.html.Element(u,C);
G.useElement(document.body);
G.setRoot(G);
var B={"color":r,"position":p,"left":d,"top":m};
var D=new qx.html.Element(u,B);
G.add(D);
D.setAttribute(b,j);
var E=[l,k,g,r,a];

for(var i=0;i<E.length;i++){var A={"backgroundColor":E[i],"width":s,"height":s,"position":p,"-moz-border-radius":t,"-webkit-border-radius":t,"border-radius":t,"top":((i+5)*30)+v,"left":((i+1)*150)+v};
var F=new qx.html.Element(u,A);
G.add(F);
}this.__MD=[];
this.__ME=[];
G.addListener(f,this._onTouchStart,this);
G.addListener(o,this._onTouchMove,this);
},_onTouchStart:function(e){var x=e.getTouches();

for(var i=0;i<x.length;i++){var w=x.item(i);
this.__MD[i]=parseInt(w.target.style.left)-w.pageX;
this.__ME[i]=parseInt(w.target.style.top)-w.pageY;
}},_onTouchMove:function(e){var z=e.getTouches();

for(var i=0;i<z.length;i++){var y=z.item(i);

if(z.target==document.body){continue;
}qx.bom.element.Style.setStyles(y.target,{"left":(y.pageX+this.__MD[i])+v,"top":(y.pageY+this.__ME[i])+v});
}e.stop();
}}});
})();
