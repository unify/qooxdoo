...
qx.Class.define(k,{extend:qx.application.Standalone,members:{__Qc:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var A=this.getRoot();
this.__Qc=[n,p,q,l,o,b,d,m];
...
for(var i=0;i<this.__Qc.length;i++){var w=new qx.ui.form.ListItem(this.__Qc[i]);
u.add(w);

if(this.__Qc[i]==t){y=w;
}}x.add(u);
...
for(var i=0;i<this.__Qc.length;i++){B.add(new qx.ui.form.ListItem(this.__Qc[i]));
}D.add(B);
