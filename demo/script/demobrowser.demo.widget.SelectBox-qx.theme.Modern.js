...
Q.add(new qx.ui.basic.Label(b));
var P=new qx.ui.form.SelectBox();
P.add(new qx.ui.form.ListItem(D));

for(var i=0;i<10;i++){P.add(new qx.ui.form.ListItem(q+(i+1)));
}Q.add(P);
return Q;
}}});
})();
