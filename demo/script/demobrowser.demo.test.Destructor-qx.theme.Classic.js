...
(function(){var e="Window: ",d="interval",c="__Pd",b="Label: ",a="demobrowser.demo.test.Destructor";
qx.Class.define(a,{extend:qx.application.Standalone,members:{__Pb:null,__Pc:0,__Pd:null,main:function(){qx.application.Standalone.prototype.main.call(this);
this.__Pb=[];
this.currentTest=this.testWindows;
this.__Pd=new qx.event.Timer(1000);
this.__Pd.addListener(d,this.runTest,this);
this.__Pd.start();
},runTest:function(){this.__Pc++;
var j=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());
this.debug("Round: "+this.__Pc+" (Registry: "+j+")");
this.currentTest();
...
},testLabels:function(){for(var i=0;i<250;i++){var g=new qx.ui.basic.Label(b+i);
