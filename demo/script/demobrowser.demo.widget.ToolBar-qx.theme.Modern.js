...
var bC=new qx.ui.container.Composite(new qx.ui.layout.VBox(20));
bC.setPadding(20);
...
var bl=new qx.ui.toolbar.Button(j,p);
var by=new qx.ui.toolbar.Button(c,A);
var bm=new qx.ui.toolbar.Button(f,P);
var bF=new qx.ui.toolbar.Button(b,r);
bI.add(bl);
bI.add(new qx.ui.toolbar.Separator());
bI.add(by);
bI.add(bm);
bI.add(bF);
toolbar.add(bI);
var bJ=new qx.ui.toolbar.Part();
var bz=new qx.ui.toolbar.CheckBox(D,R);
bJ.add(bz);
toolbar.add(bJ);
var bK=new qx.ui.toolbar.Part();
var bx=new qx.ui.toolbar.RadioButton(k,O);
var bw=new qx.ui.toolbar.RadioButton(d,T);
var bv=new qx.ui.toolbar.RadioButton(a,E);
bK.add(bx);
bK.add(bw);
bK.add(bv);
toolbar.add(bK);
var bL=new qx.ui.form.RadioGroup(bx,bw,bv);
bL.setAllowEmptySelection(true);
toolbar.addSpacer();
var bA=new qx.ui.toolbar.MenuButton(u);
toolbar.add(bA);
toolbar.setOverflowIndicator(bA);
var bh=new qx.ui.toolbar.Button(x,v);
toolbar.add(bh);
var bp=[bl,by,bm,bF,bz,bx,bw,bv,bh];
toolbar.setRemovePriority(bI,4);
toolbar.setRemovePriority(bK,3);
toolbar.setRemovePriority(bJ,2);
var bi=new qx.ui.menu.Menu();
bA.setMenu(bi);
var bl=new qx.ui.menu.Button(j,B);
var bq=new qx.ui.menu.Separator();
var by=new qx.ui.menu.Button(c,n);
var bm=new qx.ui.menu.Button(f,S);
var bF=new qx.ui.menu.Button(b,K);
bi.add(bl);
bi.add(bq);
bi.add(by);
bi.add(bm);
bi.add(bF);
var br=new qx.ui.menu.Separator();
var bx=new qx.ui.menu.RadioButton(k);
var bw=new qx.ui.menu.RadioButton(d);
var bv=new qx.ui.menu.RadioButton(a);
bx.setIcon(N);
bw.setIcon(C);
bv.setIcon(X);
bi.add(br);
...
for(var i=0;i<bj.length;i++){bj[i].setVisibility(l);
}var bk=function(ba,bb){var bc=[];

if(ba==bI){bc.push(bl,bq,by,bm,bF);
}else if(ba==bK){bc.push(br,bx,bw,bv);
}
for(var i=0;i<bc.length;i++){bc[i].setVisibility(bb);
}};
toolbar.addListener(s,function(e){bk(e.getData(),l);
},this);
toolbar.addListener(J,function(e){bk(e.getData(),m);
},this);
var bs=new qx.ui.layout.Grid();
bs.setSpacing(10);
var bE=new qx.ui.container.Composite(bs);
bC.add(bE);
var bu=new qx.ui.form.RadioButton(U);
bu.setValue(true);
var bM=new qx.ui.form.RadioButton(Q);
var bt=new qx.ui.form.RadioButton(t);
var bB=new qx.ui.form.RadioGroup();
bB.add(bu,bM,bt);
bE.add(new qx.ui.basic.Label(z),{row:0,column:0});
bE.add(bu,{row:0,column:1});
bE.add(bM,{row:0,column:2});
bE.add(bt,{row:0,column:3});
bB.addListener(g,function(e){var bf=e.getData()[0];
var be,bg,bd;

for(var i=0;i<bp.length;i++){be=bp[i];
bd=be.getIcon();

if(bf==bu){bg=22;
}else if(bf==bM){bg=32;
}else if(bf==bt){bg=48;
}bd=bd.replace(/22|32|48/g,bg);
be.setIcon(bd);
}},this);
var bo=new qx.ui.form.RadioButton(L);
bo.setValue(true);
var bH=new qx.ui.form.RadioButton(F);
var bn=new qx.ui.form.RadioButton(W);
var bD=new qx.ui.form.RadioGroup();
bD.add(bo,bH,bn);
bE.add(new qx.ui.basic.Label(q),{row:1,column:0});
bE.add(bo,{row:1,column:1});
bE.add(bH,{row:1,column:2});
bE.add(bn,{row:1,column:3});
bD.addListener(g,function(e){if(e.getData()[0]==bo){toolbar.setShow(y);
}else if(e.getData()[0]==bH){toolbar.setShow(G);
}else if(e.getData()[0]==bn){toolbar.setShow(M);
}},this);
var bG=new qx.ui.form.CheckBox(I);
bE.add(new qx.ui.basic.Label(H),{row:2,column:0});
bE.add(bG,{row:2,column:1});
bG.bind(h,toolbar,w);
bG.bind(h,bD,V,{converter:function(Y){return !Y;
}});
}}});
})();
