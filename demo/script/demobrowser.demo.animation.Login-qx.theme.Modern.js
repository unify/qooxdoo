...
(function(){var o="top",n="right",m="resize",l="Name",k="Password",j="__KI",h="__KJ",g="__KK",f="appear",d="demobrowser.demo.animation.Login",a="50%",c="execute",b="30%";
qx.Class.define(d,{extend:qx.application.Standalone,members:{__KI:null,__KJ:null,__KK:null,checkInput:function(){this.__KI.start();
},__KL:function(){this.__KI=new qx.fx.effect.combination.Shake(this.__KJ.getContainerElement().getDomElement());
...
this.__KJ=new qx.ui.groupbox.GroupBox().set({contentPadding:[16,16,16,16]});
this.__KJ.setLayout(r);
this.__KJ.addListener(m,function(e){var p=this.__KJ.getBounds();
this.__KJ.set({marginTop:Math.round(-p.height/2),marginLeft:Math.round(-p.width/2)});
},this);
this.getRoot().add(this.__KJ,{left:a,top:b});
var q=[l,k];

for(var i=0;i<q.length;i++){this.__KJ.add(new qx.ui.basic.Label(q[i]).set({allowShrinkX:false,paddingTop:3}),{row:i,column:0});
}var s=new qx.ui.form.TextField();
var t=new qx.ui.form.PasswordField();
this.__KJ.add(s.set({allowShrinkX:false,paddingTop:3}),{row:0,column:1});
this.__KJ.add(t.set({allowShrinkX:false,paddingTop:3}),{row:1,column:1});
var u=this.__KK=new qx.ui.form.Button("Login");
u.setAllowStretchX(false);
this.__KJ.add(u,{row:3,column:1});
u.addListener(c,this.checkInput,this);
this.__KJ.addListener(f,this.__KL,this);
}},destruct:function(){this._disposeObjects(h,g,j);
}});
})();
