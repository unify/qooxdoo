...
qx.$$build = 1282828335927;
qx.$$type = "build";
  
if (!window.qxsettings) qxsettings = {};
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.mobile.Pong","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.mobile.Pong-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"06a40448f54c"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var r="absolute",q="20px",p="white",o="100px",n="100%",m="black",l="div",k="50%",j="touchmove",h="1px solid white",c="30px",g="px",f="0 : 0",b="0px",a="50px",d="demobrowser.demo.mobile.Pong";
qx.Class.define(d,{extend:qx.application.Native,members:{__MF:null,__MG:null,__MH:null,__MI:null,__MJ:5,__MK:1,__ML:1,__MM:null,__MN:null,main:function(){qx.application.Native.prototype.main.call(this);
{};
var B={"width":n,"height":n,"backgroundColor":m,"margin":b};
var G=new qx.html.Element(l,B);
G.useElement(document.body);
G.setRoot(G);
var y={"width":k,"height":n,"position":r,"backgroundColor":m,"border-right":h};
var z=new qx.html.Element(l,y);
G.add(z);
var D={"width":c,"height":o,"left":q,"top":o,"position":r,"backgroundColor":p};
this.__MG=new qx.html.Element("div",D);
z.add(this.__MG);
z.addListener(j,function(e){var x=e.getTouches();

for(var i=0;i<x.length;i++){if(x[i].target===z.getDomElement()||x[i].target===this.__MG.getDomElement()){this.__MG.setStyles({"top":(x[i].pageY-50)+g});
}}},this);
var E={"left":k,"width":k,"height":n,"position":r,"backgroundColor":m,"border-left":h};
var A=new qx.html.Element(l,E);
G.add(A);
var F={"width":c,"height":o,"right":q,"top":o,"position":r,"backgroundColor":p};
this.__MF=new qx.html.Element("div",F);
A.add(this.__MF);
A.addListener(j,function(e){var s=e.getTouches();

for(var i=0;i<s.length;i++){if(s[i].target===this.__MF.getDomElement()||s[i].target===A.getDomElement()){this.__MF.setStyles({"top":(s[i].pageY-50)+g});
}}},this);
var H={"width":q,"height":q,"position":r,"backgroundColor":p};
this.__MH=new qx.html.Element("div",H);
G.add(this.__MH);
this.__MM=[0,0];
var C={"left":a,"top":q,"position":r,"color":p};
this.__MN=new qx.html.Element("div",C);
G.add(this.__MN);
qx.html.Element.flush();
this.__MN.getDomElement().innerHTML=f;
this.__MO();
},__MO:function(){this.__MH.setStyles({"left":"200px","top":"200px"});
this.__MI=new qx.event.Timer(40);
this.__MI.addListener("interval",function(){this.__MH.setStyle("left",(parseInt(this.__MH.getStyle("left"))+this.__MJ*this.__MK)+"px");
this.__MH.setStyle("top",(parseInt(this.__MH.getStyle("top"))+this.__MJ*this.__ML)+"px");
this.__MQ();
},this);
this.__MI.start();
},__MP:function(I){this.__MI.stop();
this.__MI.dispose();
this.__MJ=5;
this.__MM[I]=this.__MM[I]+1;
this.__MN.getDomElement().innerHTML=this.__MM[0]+" : "+this.__MM[1];
this.__MO();
},__MQ:function(){var v=this.getBoundsFor(this.__MH);
if(v.top<=0){this.__ML=1;
}if(v.bottom>=window.innerHeight-5){this.__ML=-1;
}if(v.left<=0||v.right>=window.innerWidth){this.__MP(v.left<=0?1:0);
}var w=this.getBoundsFor(this.__MG);

if(v.left<=w.right&&v.bottom>=w.top&&v.top<=w.bottom){this.__MK=1;
this.__MJ=Math.min(this.__MJ+1,20);
}var u=this.getBoundsFor(this.__MF);

if(v.right>=u.left&&v.bottom>=u.top&&v.top<=u.bottom){this.__MK=-1;
this.__MJ++;
}},getBoundsFor:function(t){return qx.bom.element.Location.get(t.getDomElement());
}}});
})();
