...
(function(){var bI="execute",bH="changeValue",bG="icon/16/actions/system-search.png",bF="Online Forum",bE="New",bD="icon/16/actions/edit-cut.png",bC="Search in files",bB="icon/16/actions/format-justify-fill.png",bA="Left aligned",bz="Undo",bo="_openCommand",bn="Uppercase",bm="View",bl="C Dialect",bk="changeSelection",bj="Save as...",bi="Show line numbers",bh="Search previous...",bg="Quickstart",bf="Cut",bP="Ctrl+N",bQ="C",bN="Show console",bO="Search",bL="Help",bM="_redoCommand",bJ="Redo",bK="Show status bar",bR="icon/16/actions/format-justify-left.png",bS="ANSI to OEM",bs="Centered",br="Paragraph",bu="Edit",bt="Ctrl+O",bw="icon/16/actions/document-print.png",bv="icon/16/actions/document-open.png",by="C Sharp",bx="icon/16/actions/edit-undo.png",bq="Close",bp="icon/16/actions/document-save-as.png",i="Python",j="icon/16/apps/utilities-help.png",k="Show tree",l="Spaces to tabs",m="Right aligned",n="OEM to ANSI",o="JavaScript",p="demobrowser.demo.widget.MenuBar",q="_copyCommand",r="XML",bW="Save",bV="_undoCommand",bU="Capitals",bT="icon/16/actions/application-exit.png",cb="C Plus Plus",ca="_saveCommand",bY="Lowercase",bX="Search next...",cd="_newCommand",cc="Replace in files",O="Perl",P="Ctrl+P",M="Topics",N="Panes",S="Justified",T="Ctrl+X",Q="Show macros",R="Show ruler",K="Copy",L="Paste",z="_pasteCommand",y="icon/16/actions/format-justify-right.png",B="Ctrl+Z",A="Ctrl+R",v="icon/16/actions/edit-redo.png",u="Show tags",x="Info...",w="Format",t="File",s="Show tabs",Y="Print",ba="icon/16/actions/document-save.png",bb="icon/16/actions/edit-copy.png",bc="Search...",U="icon/16/actions/format-justify-center.png",V="Open",W="_cutCommand",X="Objective C",bd="Exit",be="Ctrl+S",J="Syntax",I="Ctrl+C",H="icon/16/actions/document-new.png",G="Tabs to spaces",F="ASCII table",E="Replace",D="HTML",C="icon/16/actions/edit-paste.png";
...
var cO=new qx.ui.container.Scroll();
var cN=new qx.ui.container.Composite(new qx.ui.layout.Canvas);
cN.setPadding(20);
cN.setAllowStretchX(false);
cO.add(cN);
this.getRoot().add(cO,{edge:0});
this.createCommands();
cN.add(this.getMenuBar(),{left:20,top:20});
...
},createCommands:function(){this._newCommand=new qx.ui.core.Command(bP);
this._newCommand.addListener(bI,this.debugCommand);
this._openCommand=new qx.ui.core.Command(bt);
this._openCommand.addListener(bI,this.debugCommand);
this._saveCommand=new qx.ui.core.Command(be);
this._saveCommand.addListener(bI,this.debugCommand);
this._undoCommand=new qx.ui.core.Command(B);
this._undoCommand.addListener(bI,this.debugCommand);
this._redoCommand=new qx.ui.core.Command(A);
this._redoCommand.addListener(bI,this.debugCommand);
this._cutCommand=new qx.ui.core.Command(T);
this._cutCommand.addListener(bI,this.debugCommand);
this._copyCommand=new qx.ui.core.Command(I);
this._copyCommand.addListener(bI,this.debugCommand);
this._pasteCommand=new qx.ui.core.Command(P);
this._pasteCommand.addListener(bI,this.debugCommand);
...
c.add(menubar);
var b=new qx.ui.menubar.Button(t,null,this.getFileMenu());
var a=new qx.ui.menubar.Button(bu,null,this.getEditMenu());
var d=new qx.ui.menubar.Button(bO,null,this.getSearchMenu());
var h=new qx.ui.menubar.Button(bm,null,this.getViewMenu());
var g=new qx.ui.menubar.Button(w,null,this.getFormatMenu());
var f=new qx.ui.menubar.Button(bL,null,this.getHelpMenu());
menubar.add(b);
menubar.add(a);
menubar.add(d);
menubar.add(h);
...
var di=new qx.ui.menu.Button(bE,H,this._newCommand);
var dm=new qx.ui.menu.Button(V,bv,this._openCommand);
var dl=new qx.ui.menu.Button(bq);
var dq=new qx.ui.menu.Button(bW,ba,this._saveCommand);
var dp=new qx.ui.menu.Button(bj,bp);
var dn=new qx.ui.menu.Button(Y,bw);
var dj=new qx.ui.menu.Button(bd,bT);
di.addListener(bI,this.debugButton);
dm.addListener(bI,this.debugButton);
dl.addListener(bI,this.debugButton);
dq.addListener(bI,this.debugButton);
dp.addListener(bI,this.debugButton);
dn.addListener(bI,this.debugButton);
dj.addListener(bI,this.debugButton);
dk.add(di);
dk.add(dm);
dk.add(dl);
dk.add(dq);
...
var cy=new qx.ui.menu.Button(bz,bx,this._undoCommand);
var cx=new qx.ui.menu.Button(bJ,v,this._redoCommand);
var cu=new qx.ui.menu.Button(bf,bD,this._cutCommand);
var cz=new qx.ui.menu.Button(K,bb,this._copyCommand);
var cw=new qx.ui.menu.Button(L,C,this._pasteCommand);
cy.addListener(bI,this.debugButton);
cx.addListener(bI,this.debugButton);
cu.addListener(bI,this.debugButton);
cz.addListener(bI,this.debugButton);
cw.addListener(bI,this.debugButton);
cv.add(cy);
cv.add(cx);
cv.addSeparator();
cv.add(cu);
...
var cf=new qx.ui.menu.Button(bc,bG);
var ck=new qx.ui.menu.Button(bX);
var cg=new qx.ui.menu.Button(bh);
var cj=new qx.ui.menu.Button(E);
var ce=new qx.ui.menu.Button(bC,bG);
var ci=new qx.ui.menu.Button(cc);
cg.setEnabled(false);
cf.addListener(bI,this.debugButton);
ck.addListener(bI,this.debugButton);
cg.addListener(bI,this.debugButton);
cj.addListener(bI,this.debugButton);
ce.addListener(bI,this.debugButton);
ci.addListener(bI,this.debugButton);
ch.add(cf);
ch.add(ck);
ch.add(cg);
ch.add(cj);
...
ch.add(ci);
return ch;
},getViewMenu:function(){var cU=new qx.ui.menu.Menu;
var cW=new qx.ui.menu.Button(N,null,null,this.getPanesMenu());
var da=new qx.ui.menu.Button(J,null,null,this.getSyntaxMenu());
var cY=new qx.ui.menu.CheckBox(R);
var cX=new qx.ui.menu.CheckBox(bi);
var cV=new qx.ui.menu.Button(F);
cY.addListener(bH,this.debugCheckBox);
cX.addListener(bH,this.debugCheckBox);
cV.addListener(bI,this.debugButton);
cU.add(cW);
cU.add(da);
cU.addSeparator();
cU.add(cY);
...
cU.add(cV);
return cU;
},getPanesMenu:function(){var dc=new qx.ui.menu.Menu;
var de=new qx.ui.menu.CheckBox(s);
var dg=new qx.ui.menu.CheckBox(bK);
var dh=new qx.ui.menu.CheckBox(k);
var dd=new qx.ui.menu.CheckBox(Q);
var df=new qx.ui.menu.CheckBox(u);
var db=new qx.ui.menu.CheckBox(bN);
de.setValue(true);
dg.setValue(true);
dd.setValue(true);
de.addListener(bH,this.debugCheckBox);
dg.addListener(bH,this.debugCheckBox);
dh.addListener(bH,this.debugCheckBox);
dd.addListener(bH,this.debugCheckBox);
df.addListener(bH,this.debugCheckBox);
db.addListener(bH,this.debugCheckBox);
dc.add(dg);
dc.add(de);
dc.addSeparator();
dc.add(dh);
...
dc.add(db);
return dc;
},getSyntaxMenu:function(){var cJ=new qx.ui.menu.Menu;
var cF=new qx.ui.menu.RadioButton(D);
var cH=new qx.ui.menu.RadioButton(r);
var cG=new qx.ui.menu.RadioButton(o);
var cI=new qx.ui.menu.Button(bl,null,null,this.getSyntaxCMenu());
var cM=new qx.ui.menu.RadioButton(O);
var cK=new qx.ui.menu.RadioButton(i);
cJ.add(cF);
cJ.add(cH);
cJ.add(cG);
cJ.add(cI);
...
cL.add(cF,cH,cG,cM,cK);
cL.add.apply(cL,cI.getMenu().getChildren());
cL.addListener(bk,this.debugRadio);
return cJ;
},getSyntaxCMenu:function(){var ds=new qx.ui.menu.Menu;
var dr=new qx.ui.menu.RadioButton(bQ);
var dv=new qx.ui.menu.RadioButton(by);
var du=new qx.ui.menu.RadioButton(X);
var dt=new qx.ui.menu.RadioButton(cb);
ds.add(dr);
ds.add(dv);
ds.add(du);
ds.add(dt);
...
var cn=new qx.ui.menu.Button(br,null,null,this.getParagraphMenu());
var cq=new qx.ui.menu.Button(G);
var cr=new qx.ui.menu.Button(l);
var cm=new qx.ui.menu.Button(bn);
var cp=new qx.ui.menu.Button(bY);
var cl=new qx.ui.menu.Button(bU);
var ct=new qx.ui.menu.Button(n);
var cs=new qx.ui.menu.Button(bS);
cq.addListener(bI,this.debugButton);
cr.addListener(bI,this.debugButton);
cm.addListener(bI,this.debugButton);
cp.addListener(bI,this.debugButton);
cl.addListener(bI,this.debugButton);
ct.addListener(bI,this.debugButton);
cs.addListener(bI,this.debugButton);
co.add(cn);
co.add(cq);
co.add(cr);
co.addSeparator();
...
co.add(cs);
return co;
},getParagraphMenu:function(){var cP=new qx.ui.menu.Menu;
var cS=new qx.ui.menu.Button(bA,bR);
var cT=new qx.ui.menu.Button(m,y);
var cQ=new qx.ui.menu.Button(bs,U);
var cR=new qx.ui.menu.Button(S,bB);
cS.addListener(bI,this.debugButton);
cT.addListener(bI,this.debugButton);
cQ.addListener(bI,this.debugButton);
cR.addListener(bI,this.debugButton);
...
cP.add(cR);
return cP;
},getHelpMenu:function(){var cA=new qx.ui.menu.Menu;
var cC=new qx.ui.menu.Button(M,j);
var cE=new qx.ui.menu.Button(bg);
var cD=new qx.ui.menu.Button(bF);
var cB=new qx.ui.menu.Button(x);
cC.addListener(bI,this.debugButton);
cE.addListener(bI,this.debugButton);
cD.addListener(bI,this.debugButton);
cB.addListener(bI,this.debugButton);
cA.add(cC);
cA.add(cE);
cA.addSeparator();
cA.add(cD);
...
cA.add(cB);
return cA;
}},destruct:function(){this._disposeObjects(cd,bo,ca,bV,bM,W,q,z);
}});
})();
