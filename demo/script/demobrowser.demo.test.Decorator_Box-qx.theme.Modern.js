...
qx.Class.define(a,{extend:qx.ui.decoration.Abstract,implement:[qx.ui.decoration.IDecorator],construct:function(x,y,z){qx.ui.decoration.Abstract.call(this);
this._setOrientation(z);

if(qx.ui.decoration.css3.BorderImage.IS_SUPPORTED){this.__OS=new qx.ui.decoration.css3.BorderImage();

if(x){this.__OT(x,z);
}if(y!=null){this.__OS.setInsets(y);
}}else{this.__OS=new qx.ui.decoration.BoxDiv(x,y,z);
}},properties:{baseImage:{check:b,nullable:true,apply:d}},members:{__OS:null,_isHorizontal:null,_setOrientation:function(f){this._isHorizontal=f==c;
},getMarkup:function(){return this.__OS.getMarkup();
},resize:function(i,j,k){this.__OS.resize(i,j,k);
},tint:function(l,m){},getInsets:function(){return this.__OS.getInsets();
},_applyInsets:function(A,B,name){var C=e+qx.lang.String.firstUp(name);
this.__OS[C](A);
},_applyBaseImage:function(g,h){if(this.__OS instanceof qx.ui.decoration.BoxDiv){this.__OS.setBaseImage(g);
}else{this.__OT(g);
}},__OT:function(n){this.__OS.setBorderImage(n);
...
if(this._isHorizontal){var w=q.getImageWidth(r+"-l"+s);
var o=q.getImageWidth(r+"-r"+s);
this.__OS.setSlice([0,o,0,w]);
}else{var p=q.getImageHeight(r+"-b"+s);
var v=q.getImageHeight(r+"-t"+s);
this.__OS.setSlice([v,0,p,0]);
...
(function(){var r="px",q="no-repeat",p="0",o="-1px",n="mshtml",m="horizontal",l="qx.ui.decoration.BoxDiv",k='<div style="position:absolute;top:0;left:0;overflow:hidden;font-size:0;line-height:0;">',j='</div>',i="_applyBaseImage",f="repeat-x",h="repeat-y",g="String",e="qx.client";
qx.Class.define(l,{extend:qx.ui.decoration.Abstract,construct:function(I,J,K){qx.ui.decoration.Abstract.call(this);
this._setOrientation(K);
if(I!=null){this.setBaseImage(I);
}
if(J!=null){this.setInsets(J);
}},properties:{baseImage:{check:g,nullable:true,apply:i}},members:{__OX:null,__OY:null,__Pa:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__OX;
},_setOrientation:function(F){this._isHorizontal=F==m;
},getMarkup:function(){if(this.__OX){return this.__OX;
...
if(this._isHorizontal){d.push(a.create(b.l,q,{top:0,left:0}));
d.push(a.create(b.c,f,{top:0,left:c.left+r}));
d.push(a.create(b.r,q,{top:0,right:0}));
}else{d.push(a.create(b.t,q,{top:0,left:0}));
d.push(a.create(b.c,h,{top:c.top+r,left:c.left+r}));
d.push(a.create(b.b,q,{bottom:0,left:0}));
}d.push(j);
return this.__OX=d.join("");
},resize:function(s,t,u){s.style.width=t+r;
s.style.height=u+r;
var v=this.__Pa;

if(this._isHorizontal){var innerWidth=t-v.left-v.right;
s.childNodes[1].style.width=innerWidth+r;
}else{var innerHeight=u-v.top-v.bottom;
s.childNodes[1].style.height=innerHeight+r;
}
if(qx.core.Variant.isSet(e,n)){if(qx.bom.client.Engine.VERSION<7||(qx.bom.client.Feature.QUIRKS_MODE&&qx.bom.client.Engine.VERSION<8)){if(this._isHorizontal){s.childNodes[2].style.marginRight=(t%2==1)?o:p;
}else{s.childNodes[2].style.marginBottom=(u%2==1)?o:p;
}}}},tint:function(G,H){},_applyBaseImage:function(w,x){{};
var y=qx.util.ResourceManager.getInstance();

if(w){var A=qx.util.AliasManager.getInstance();
var C=A.resolve(w);
var D=/(.*)(\.[a-z]+)$/.exec(C);
var B=D[1];
var z=D[2];
var E=this.__OY={t:B+"-t"+z,b:B+"-b"+z,c:B+"-c"+z,l:B+"-l"+z,r:B+"-r"+z};
this.__Pa={top:y.getImageHeight(E.t),bottom:y.getImageHeight(E.b),left:y.getImageWidth(E.l),right:y.getImageWidth(E.r)};
}}},destruct:function(){this.__OX=this.__OY=this.__Pa=null;
}});
})();
