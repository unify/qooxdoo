...
E.execute();
},testCheckBoxEditor:function(){var t={value:[true,false]};
qx.util.Permutation.permute(t,function(J){this._addEditor(new qx.ui.table.celleditor.CheckBox(),J);
},this);
},testComboBoxEditor:function(){var a={value:[n,m,h,2],table:[this.getTableMock()]};
var b=new qx.ui.table.celleditor.ComboBox();
b.setListData([j,m,k]);
qx.util.Permutation.permute(a,function(I){this._addEditor(b,I);
},this);
},testSelectBoxEditor:function(){var u={value:[n,m],table:[this.getTableMock()]};
var v=new qx.ui.table.celleditor.SelectBox();
v.setListData([j,m,k]);
qx.util.Permutation.permute(u,function(y){this._addEditor(v,y);
},this);
},testPasswordEditor:function(){var z={value:[null,10,l]};
qx.util.Permutation.permute(z,function(w){this._addEditor(new qx.ui.table.celleditor.PasswordField(),w);
},this);
},testTextfieldEditor:function(){var r={value:[null,10,l]};
qx.util.Permutation.permute(r,function(q){this._addEditor(new qx.ui.table.celleditor.TextField(),q);
},this);
},testTextfieldEditorDynamic:function(){var o={value:[true,l]};
var p=new qx.ui.table.celleditor.Dynamic();
p.setCellEditorFactoryFunction(function(x){if(typeof x.value==d){return new qx.ui.table.celleditor.CheckBox();
}else{return new qx.ui.table.celleditor.TextField();
}});
qx.util.Permutation.permute(o,function(s){this._addEditor(p,s);
},this);
