...
(function(){var s="value",r="demobrowser.demo.data.Form",q="female",p="Registration",o="male",n="Send",m="gender",l="Ok:",k="selection",j="-please select-",d="execute",i="ok",g="left",c="Name:",b="middle",f="x",e="Gender:",h="name";
...
var H=new qx.ui.groupbox.GroupBox(p);
H.setWidth(200);
this.getRoot().add(H,{left:10,top:10});
var E=new qx.ui.layout.Grid();
E.setSpacing(5);
E.setColumnAlign(0,g,b);
H.setLayout(E);
var u=new qx.ui.basic.Label(c);
H.add(u,{row:0,column:0});
var x=new qx.ui.form.TextField();
H.add(x,{row:0,column:1});
var K=new qx.ui.basic.Label(e);
H.add(K,{row:1,column:0});
var F=new qx.ui.form.SelectBox();
var G=new qx.ui.form.ListItem(j);
F.add(G);
var C=new qx.ui.form.ListItem(o);
F.add(C);
var A=new qx.ui.form.ListItem(q);
F.add(A);
H.add(F,{row:1,column:1});
var M=new qx.ui.basic.Label(l);
H.add(M,{row:2,column:0});
var J=new qx.ui.form.CheckBox();
H.add(J,{row:2,column:1});
var B=new qx.ui.form.Button(n);
H.add(B,{row:3,column:0});
var w={name:null,gender:null,ok:0,hidden:f};
var I=qx.data.marshal.Json.createModel(w);
var z=new qx.data.controller.Object(I);
z.addTarget(x,s,h,true);
z.addTarget(F,k,m,true);
var v={converter:function(a){return a===1;
}};
var y={converter:function(t){return t?1:0;
}};
z.addTarget(J,s,i,true,v,y);
x.setRequired(true);
J.setRequired(true);
var L=new qx.ui.form.validation.Manager();
x.setRequired(true);
L.add(x);
L.add(J);
L.setValidator(function(N){var O=F.getSelection()[0]!==G;
F.setValid(O);
return O;
});
var D=function(P){if(P instanceof qx.ui.form.ListItem){return P.getLabel();
}};
B.addListener(d,function(){if(L.validate()){alert("You are sending: "+qx.util.Serializer.toUriParameter(I,D));
}},this);
}}});
})();
