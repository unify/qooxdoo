...
qx.Class.define(j,{extend:qx.application.Native,members:{__Pe:null,__Pf:0,main:function(){qx.application.Native.prototype.main.call(this);
this.__Pe=[];
var q=new qx.event.Timer(5000);
q.addListener(g,this.runTest,this);
q.start();
this.runTest();
},runTest:function(){for(var i=0;i<5;i++){var n=qx.bom.Element.create(b);
qx.bom.element.Style.set(n,c,d);
qx.bom.element.Style.set(n,f,h);
document.body.appendChild(n);
var o=a+this.__Pf;
this.__Pf++;
qx.bom.Flash.create(n,{movie:e,id:o});
this.debug("created: "+o);
this.__Pe.push(n);
}var p=qx.event.Timer.once(this.clear,this,2500);
p.start();
},clear:function(){var k=this.__Pe;
