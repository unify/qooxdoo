...
qx.Class.define(m,{extend:qx.application.Native,members:{__Me:null,main:function(){qx.application.Native.prototype.main.call(this);
var t=qx.util.ResourceManager.getInstance();
this.__Me=[g,k,h,t.toUri(f)];
var w=qx.bom.Input.create(p);
qx.bom.Input.setValue(w,o);
document.body.appendChild(w);
qx.event.Registration.addListener(w,q,function(e){var z={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};
this.window1=qx.bom.Window.open(this.__Me[0],j,z);
},this);
var v=qx.bom.Input.create(p);
qx.bom.Input.setValue(v,c);
document.body.appendChild(v);
qx.event.Registration.addListener(v,q,function(e){alert(qx.bom.Window.isClosed(this.window1));
},this);
var u=qx.bom.Input.create(p);
qx.bom.Input.setValue(u,n);
document.body.appendChild(u);
qx.event.Registration.addListener(u,q,function(e){var A={width:400,height:200,top:200,left:100,scrollbars:false};
this.window2=qx.bom.Window.open(this.__Me[3],a,A,true);
},this);
var y=qx.bom.Input.create(p);
qx.bom.Input.setValue(y,l);
document.body.appendChild(y);
qx.event.Registration.addListener(y,q,function(e){alert(qx.bom.Window.isClosed(this.window2));
},this);
var x=qx.bom.Input.create(p);
qx.bom.Input.setValue(x,b);
document.body.appendChild(x);
qx.event.Registration.addListener(x,q,function(e){var s={width:800,height:600,top:200,left:100,scrollbars:false};
var r=qx.bom.Window.getBlocker();
r.setBlockerColor(d);
r.setBlockerOpacity(0.5);
this.window3=qx.bom.Window.open(this.__Me[0],i,s,true,false);
},this);
...
qx.Class.define(l,{statics:{__Mf:null,__Mg:null,__Mh:null,__Mi:{"top":b,left:d,width:j,height:q,scrollbars:h,resizable:s},__Mj:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__Mk:function(){return window.showModalDialog!=null;
},open:function(J,name,K,L,M){if(J==null){J=i;
}
if(name==null){name=f+new Date().getTime();
}
if(M==null){M=true;
}var N=this.__Ml(K,L&&M);

if(L){if(this.__Mk()&&M){return window.showModalDialog(J,[window.self],N);
}else{this.getBlocker().block();

if(this.__Mh==null){this.__Mh=new qx.event.Timer(500);
this.__Mh.addListener(k,this.__Mm,this);
this.__Mh.start();
}else{this.__Mh.restart();
}this.__Mg=window.open(J,name,N);
return this.__Mg;
}}else{return window.open(J,name,N);
}},__Ml:function(t,u){var v;
var y;
var w=[];

if(u&&this.__Mk()){for(var x in t){if(qx.bom.Window.__Mi[x]){var z=n;

if(x!=e&&x!=s){z=m;
}y=qx.bom.Window.__Mi[x]+g+t[x]+z;
w.push(y);
}else{qx.log.Logger.warn("Option '"+x+"' is not supported for modal windows.");
}}v=w.join(c);
}else{for(var x in t){if(qx.bom.Window.__Mj[x]){if(qx.lang.Type.isBoolean(t[x])){y=x+r+(t[x]?o:p);
}else{y=x+r+t[x];
}w.push(y);
}else{qx.log.Logger.warn("Option '"+x+"' is not supported for native windows.");
}}v=w.join(a);
}return v;
},__Mm:function(){if(this.isClosed(this.__Mg)){this.getBlocker().unblock();
this.__Mh.stop();
}},getBlocker:function(){if(this.__Mf==null){this.__Mf=new qx.bom.Blocker;
}return this.__Mf;
},close:function(E){if(E){return E.close();
}},isClosed:function(O){var closed=true;

if(O){try{closed=O.closed;
...
(function(){var z="px",y="mshtml",x="0px",w="qx.client",v="resize",u="backgroundColor",t="block",s="zIndex",r="transparent",q="src",n="allowTransparency",p="div",o="javascript:false;",m="qx.bom.Blocker",l="absolute";
qx.Class.define(m,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.__Hg();
},members:{__GY:null,__Ha:null,__Hb:null,__Hc:false,__Hd:10000,__He:0,__Hf:r,block:function(d){if(!this.__Hc){this.__Hb=d;
var f=this.__Hj();
this.__Hk(f);
this.__Hc=true;
...
},setBlockerColor:function(g){qx.bom.element.Style.set(this.__Ha,u,g);
},getBlockerColor:function(){return qx.bom.element.Style.get(this.__Ha,u);
},setBlockerOpacity:function(k){qx.bom.element.Opacity.set(this.__Ha,k);
},getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__Ha);
},setBlockerZIndex:function(c){qx.bom.element.Style.set(this.__Ha,s,c);
},getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__Ha,s);
},__Hg:function(){this.__Hh();

if(qx.core.Variant.isSet(w,y)){this.__Hi();
}qx.event.Registration.addListener(window,v,this.__Hm,this);
},__Hh:function(){this.__Ha=qx.bom.Element.create(p);
qx.bom.element.Style.setStyles(this.__Ha,{display:t,opacity:this.__He,backgroundColor:this.__Hf});
this.setBlockerZIndex(this.__Hd);
},__Hi:function(){this.__GY=qx.bom.Iframe.create();
qx.bom.element.Attribute.set(this.__GY,n,false);
qx.bom.element.Attribute.set(this.__GY,q,o);
qx.bom.element.Style.setStyles(this.__GY,{display:t,opacity:this.__He});
},__Hj:function(){var h={position:l};

if(this.__Ho()){h.left=x;
h.top=x;
h.right=null;
h.bottom=null;
h.width=qx.bom.Document.getWidth()+z;
h.height=qx.bom.Document.getHeight()+z;
}else{h.width=qx.bom.element.Dimension.getWidth(this.__Hb)+z;
h.height=qx.bom.element.Dimension.getHeight(this.__Hb)+z;
h.left=qx.bom.element.Location.getLeft(this.__Hb)+z;
h.top=qx.bom.element.Location.getTop(this.__Hb)+z;
}return h;
},__Hk:function(i){var j=document.body;
qx.bom.element.Style.setStyles(this.__Ha,i);
qx.dom.Element.insertEnd(this.__Ha,j);

if(qx.core.Variant.isSet(w,y)){i.zIndex=this.getBlockerZIndex()-1;
qx.bom.element.Style.setStyles(this.__GY,i);
qx.dom.Element.insertEnd(this.__GY,document.body);
}},__Hl:function(){qx.dom.Element.remove(this.__Ha);

if(qx.core.Variant.isSet(w,y)){qx.dom.Element.remove(this.__GY);
}},__Hm:function(e){if(this.__Ho()){this.__Hn({width:x,height:x});
qx.event.Timer.once(function(){var a={width:qx.bom.Document.getWidth()+z,height:qx.bom.Document.getHeight()+z};
this.__Hn(a);
},this,0);
}},__Hn:function(b){qx.bom.element.Style.setStyles(this.__Ha,b);

if(qx.core.Variant.isSet(w,y)){qx.bom.element.Style.setStyles(this.__GY,b);
}},__Ho:function(){return (this.__Hb==null||qx.dom.Node.isWindow(this.__Hb)||qx.dom.Node.isDocument(this.__Hb));
}},destruct:function(){qx.event.Registration.removeListener(window,v,this.__Hm,this);
this.__GY=this.__Ha=this.__Hb=null;
}});
})();
