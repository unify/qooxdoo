...
z.add(this.getBox4());
z.add(this.getBox5());
},getBox1:function(){var u=new qx.ui.layout.HBox();
var w=new qx.ui.container.Composite(u).set({decorator:e,backgroundColor:c,allowGrowX:false});
u.setSpacing(5);
...
return w;
},getBox2:function(){var k=new qx.ui.layout.HBox();
