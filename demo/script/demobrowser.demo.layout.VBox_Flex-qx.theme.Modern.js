...
},getBox4:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:e,backgroundColor:c,height:300,minHeight:300,allowGrowY:false});
l.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,maxHeight:60}),{flex:1});
l.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,maxHeight:60}),{flex:2});
l.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,maxHeight:60}),{flex:3});
return l;
...
return f;
},getBox6:function(){var k=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({height:150,decorator:e,backgroundColor:c,allowGrowY:false});
k.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,minHeight:60}),{flex:1});
k.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,minHeight:60}),{flex:2});
k.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,minHeight:60}),{flex:3});
return k;
}}});
})();
