...
},addNonEditableSpinner:function(B,C){var D=new qx.ui.form.Spinner(0,50,100);
D.setEditable(false);
B.add(new qx.ui.basic.Label(n),{column:0,row:C});
...
},addSteppedSpinner:function(E,F){var G=new qx.ui.form.Spinner(-3000,0,3000).set({singleStep:25});
E.add(new qx.ui.basic.Label(l),{column:0,row:F});
E.add(new qx.ui.basic.Label(j),{column:1,row:F});
E.add(G,{column:2,row:F});
E.add(new qx.ui.basic.Label(g),{column:3,row:F});
},addDisabledSpinner:function(H,I){var J=new qx.ui.form.Spinner;
J.setEnabled(false);
H.add(new qx.ui.basic.Label(o),{column:0,row:I});
H.add(new qx.ui.basic.Label(s),{column:1,row:I});
H.add(J,{column:2,row:I});
H.add(new qx.ui.basic.Label(q),{column:3,row:I++});
...
M.setNumberFormat(N);
K.add(new qx.ui.basic.Label(d),{column:0,row:L});
K.add(new qx.ui.basic.Label(s),{column:1,row:L});
K.add(M,{column:2,row:L});
K.add(new qx.ui.basic.Label(i),{column:3,row:L++});
},main:function(){qx.application.Standalone.prototype.main.call(this);
var x=new qx.ui.layout.Grid(10,8);
x.setColumnAlign(0,p,r);
x.setColumnAlign(1,h,r);
x.setColumnAlign(2,p,r);
x.setColumnAlign(3,p,r);
var w=new qx.ui.container.Composite(x);
w.setPadding(10);
this.getRoot().add(w,{left:0,top:0});
this.addSimpleSpinner(w,0);
this.addNonEditableSpinner(w,1);
this.addWrappingSpinner(w,2);
this.addSteppedSpinner(w,3);
this.addDisabledSpinner(w,4);
this.addFormattedSpinner(w,5);
}}});
})();
