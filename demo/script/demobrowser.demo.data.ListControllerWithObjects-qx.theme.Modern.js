...
V.setIconOptions(ba);
V.setIconPath(d);
var T={converter:function(K){if(K){return c;
}else{return v;
}}};
var O={bindItem:function(H,I,J){H.bindDefaultProperties(I,J);
H.bindProperty(B,r,T,I,J);
}};
V.setDelegate(O);
var P=new qx.ui.form.Button(G);
P.setWidth(120);
this.getRoot().add(P,{left:180,top:80});
P.addListener(k,function(){for(var i=0;i<Y.length;i++){var L=Y.getItem(i);
L.setEmote(j);
}},this);
