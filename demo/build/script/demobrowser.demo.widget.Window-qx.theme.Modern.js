...
(function(){var W="changeValue",V="execute",U="icon/16/apps/office-calendar.png",T="right",S="demobrowser.demo.widget.Window",R="Yes",Q="Second Window",P="Page 1",O="bottom",N="Use move frame",bM="Show Statusbar",bL="icon/16/actions/dialog-cancel.png",bK="icon/32/status/dialog-error.png",bJ="Show Close",bI="icon/32/apps/office-address-book.png",bH="Third Window",bG="icon/22/apps/utilities-calculator.png",bF="Show Maximize",bE="Allow Close",bD="Use resize frame",be="No",bf="resizable",bc="Allow Maximize",bd="value",ba="The second window",bb="Page 3",X="move",Y="Resizable ",bi="First Window",bj="resize",br="Moveable",bp="Demo loaded",bv="Allow Minimize",bt="Resizable",bz="Open Modal Dialog 2",bx="Open Modal Dialog 1",bl="First Modal Dialog",bC="top",bB="Movable",bA="Show Minimize",bk="Basics",bn="Modal",bo="Do you want to fly to Berlin?",bq="Welcome to your first own Window.<br/>Have fun!",bs="Application is ready",bu="icon/16/apps/internet-feed-reader.png",bw="Second Modal Dialog",by="icon/16/actions/dialog-ok.png",bg="Page 2",bh="left",bm="icon/16/apps/internet-telephony.png";
...
this.createWindow2();
this.createWindow3();
},createWindow1:function(){var c=new qx.ui.window.Window(bi,U);
c.setLayout(new qx.ui.layout.VBox(10));
c.setShowStatusbar(true);
c.setStatus(bp);
c.open();
this.getRoot().add(c,{left:20,top:20});
c.addListener(X,function(e){this.debug("Moved to: "+e.getData().left+"x"+e.getData().top);
},this);
c.addListener(bj,function(e){this.debug("Resized to: "+e.getData().width+"x"+e.getData().height);
},this);
var b=new qx.ui.basic.Atom(bq,bI);
b.setRich(true);
c.add(b);
var a=new qx.ui.tabview.TabView;
c.add(a,{flex:1});
var g=new qx.ui.tabview.Page(P);
a.add(g);
var d=new qx.ui.tabview.Page(bg);
a.add(d);
var f=new qx.ui.tabview.Page(bb);
a.add(f);
},createWindow2:function(){var o=new qx.ui.window.Window(Q,bu);
o.setLayout(new qx.ui.layout.VBox(10));
o.setStatus(bs);
o.open();
this.getRoot().add(o,{left:350,top:120});
var x=new qx.ui.basic.Atom(ba,bG);
o.add(x);
var h=new qx.ui.container.Composite;
h.setLayout(new qx.ui.layout.HBox(10));
o.add(h,{flex:1});
var q=new qx.ui.groupbox.GroupBox(bk);
q.setLayout(new qx.ui.layout.VBox(4));
h.add(q,{flex:1});
var l=new qx.ui.form.CheckBox(bJ);
l.setValue(true);
l.addListener(W,function(e){o.setShowClose(e.getData());
});
q.add(l);
var w=new qx.ui.form.CheckBox(bF);
w.setValue(true);
w.addListener(W,function(e){o.setShowMaximize(e.getData());
});
q.add(w);
var p=new qx.ui.form.CheckBox(bA);
p.setValue(true);
p.addListener(W,function(e){o.setShowMinimize(e.getData());
});
q.add(p);
var s=new qx.ui.form.CheckBox(bE);
s.setValue(true);
s.addListener(W,function(e){o.setAllowClose(e.getData());
});
q.add(s);
var y=new qx.ui.form.CheckBox(bc);
y.setValue(true);
y.addListener(W,function(e){o.setAllowMaximize(e.getData());
});
q.add(y);
var n=new qx.ui.form.CheckBox(bv);
n.setValue(true);
n.addListener(W,function(e){o.setAllowMinimize(e.getData());
});
q.add(n);
var j=new qx.ui.form.CheckBox(bM);
j.setValue(false);
j.addListener(W,function(e){o.setShowStatusbar(e.getData());
});
q.add(j);
var A=new qx.ui.groupbox.GroupBox(bt);
A.setLayout(new qx.ui.layout.VBox(4));
h.add(A,{flex:1});
var u=new qx.ui.form.CheckBox(bD);
u.setValue(true);
u.addListener(W,function(e){o.setUseResizeFrame(e.getData());
});
A.add(u);
var v=[bC,T,O,bh];

for(var i=0;i<v.length;i++){var t=v[i];
var m=new qx.ui.form.CheckBox(Y+t).set({value:true});
m.bind(bd,o,bf+qx.lang.String.firstUp(t));
A.add(m);
}var k=new qx.ui.groupbox.GroupBox(br);
k.setLayout(new qx.ui.layout.VBox(4));
h.add(k,{flex:1});
var r=new qx.ui.form.CheckBox(bB);
r.setValue(true);
r.addListener(W,function(e){o.setMovable(e.getData());
});
k.add(r);
var z=new qx.ui.form.CheckBox(N);
z.addListener(W,function(e){o.setUseMoveFrame(e.getData());
});
k.add(z);
},createWindow3:function(){var K=new qx.ui.window.Window(bH,bm);
K.setLayout(new qx.ui.layout.VBox);
K.setMaxWidth(450);
K.setMaxHeight(400);
K.setAllowMaximize(false);
K.open();
this.getRoot().add(K,{left:100,top:250});
var L=this.getModalWindow1();
var M=new qx.ui.form.Button(bx,U);
M.addListener(V,L.open,L);
K.add(M);
},getModalWindow1:function(){var H=new qx.ui.window.Window(bl);
H.setLayout(new qx.ui.layout.VBox(10));
H.setModal(true);
H.moveTo(150,150);
this.getRoot().add(H);
var G=this.getModalWindow2();
var J=new qx.ui.form.Button(bz,U);
J.addListener(V,G.open,G);
H.add(J);
var I=new qx.ui.form.CheckBox(bn);
I.setValue(true);
H.add(I);
I.addListener(W,function(e){H.setModal(e.getData());
});
return H;
},getModalWindow2:function(){var C=new qx.ui.window.Window(bw);
C.setLayout(new qx.ui.layout.VBox(10));
C.setModal(true);
C.setShowClose(false);
C.moveTo(300,300);
this.getRoot().add(C);
var B=new qx.ui.basic.Atom(bo,bK);
C.add(B);
var E=new qx.ui.container.Composite;
E.setLayout(new qx.ui.layout.HBox(10,T));
C.add(E);
var F=new qx.ui.form.Button(R,by);
F.addListener(V,function(e){C.close();
});
E.add(F);
var D=new qx.ui.form.Button(be,bL);
D.addListener(V,function(e){alert("Sorry, please click 'Yes'!");
});
E.add(D);
return C;
}}});
