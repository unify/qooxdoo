...
qx.$$build = 1282826938126;
qx.$$type = "build";
  
if (!window.qxsettings) qxsettings = {};
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.data.NamesList","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.data.NamesList-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"e1bf3f7c2914"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
