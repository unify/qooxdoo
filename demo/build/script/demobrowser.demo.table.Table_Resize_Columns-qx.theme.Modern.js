...
(function(){var s="execute",r="Add 10 rows",q="Remove 10 rows",p="Whether the the first visible row should ",o="demobrowser.demo.table.Table_Resize_Columns",n="A number",m="_tableModel",l="1*",k="icon/22/actions/list-add.png",j="50%",d="A date",i="changeValue",g="Boolean test",c="be rendered completely when scrolling.",b="Table with automatic column sizes",f="Keep first row",e="icon/22/actions/list-remove.png",h="ID";
qx.Class.define(o,{extend:demobrowser.demo.table.TableDemo,members:{getCaption:function(){return b;
},createTable:function(){var D=this.createRandomRows(50);
var B=this._tableModel=this._tableModel=new qx.ui.table.model.Simple();
B.setColumns([h,n,d,g]);
B.setData(D);
var A={tableColumnModel:function(a){return new qx.ui.table.columnmodel.Resize(a);
}};
var E=this._table=new qx.ui.table.Table(B,A);
E.set({width:600,height:400});
E.getSelectionModel().setSelectionMode(qx.ui.table.selection.Model.MULTIPLE_INTERVAL_SELECTION);
var C=E.getTableColumnModel();
var z=C.getBehavior();
z.set(0,{width:l,minWidth:40,maxWidth:80});
z.setWidth(1,j);
z.setMinWidth(1,100);
z.setMaxWidth(1,320);
var C=E.getTableColumnModel();
C.setDataCellRenderer(3,new qx.ui.table.cellrenderer.Boolean());
return E;
},createControls:function(){var x=new qx.ui.toolbar.ToolBar();
var v,w,y;
w=new qx.ui.toolbar.Part();
x.add(w);
v=new qx.ui.toolbar.Button(r,k);
v.addListener(s,function(F){var G=this.createRandomRows(10);
this._tableModel.addRows(G);
this.info("10 rows added");
},this);
w.add(v);
v=new qx.ui.toolbar.Button(q,e);
v.addListener(s,function(H){var I=this._tableModel.getRowCount();
this._tableModel.removeRows(I-10,10);
...
x.add(w);
var u=this._table;
y=new qx.ui.toolbar.CheckBox(f);
y.set({value:u.getKeepFirstVisibleRowComplete(),toolTip:new qx.ui.tooltip.ToolTip(p+c)});
y.addListener(i,function(t){u.setKeepFirstVisibleRowComplete(this.getValue());
},y);
w.add(y);
return x;
