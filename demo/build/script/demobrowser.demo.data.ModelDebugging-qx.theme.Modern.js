...
var x=new demobrowser.demo.data.store.Twitter(h);
...
x.addListener(o,function(){var r=x.getModel();
this.debug(qx.dev.Debug.debugProperties(r));
v.setHtml(qx.dev.Debug.debugProperties(r,10,true));
},this);
...
qx.Class.define(f,{extend:qx.data.store.Json,statics:{saveResult:function(z){this.__Ms=z;
}},construct:function(s){var t=b+s+a;
qx.data.store.Json.call(this,t);
},members:{_createRequest:function(p){var q=new qx.io.ScriptLoader();
p+=l;
q.load(p,function(y){this.__Mt();
},this);
},__Mt:function(){var u=demobrowser.demo.data.store.Twitter.__Ms;

if(u==undefined){this.setState(i);
return;
