...
p.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return p;
},getBox2:function(){var s=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:i,backgroundColor:g,minWidth:60,allowGrowY:false});
s.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxWidth:40,alignX:b}));
s.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxWidth:40,alignX:c}));
s.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxWidth:40,alignX:a}));
return s;
},getBox3:function(){var j=new qx.ui.layout.VBox();
var k=new qx.ui.container.Composite(j).set({decorator:i,backgroundColor:g,height:300,allowGrowY:false});
j.setSpacing(5);
j.setAlignY(e);
...
k.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return k;
},getBox4:function(){var q=new qx.ui.layout.VBox();
var r=new qx.ui.container.Composite(q).set({decorator:i,backgroundColor:g,height:300,allowGrowY:false});
q.setSpacing(5);
q.setAlignY(f);
r.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
r.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
r.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return r;
},getBox5:function(){var m=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:i,backgroundColor:g,allowGrowY:false});
var o=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10});
var n=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10,marginTop:20});
var l=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10});
m.add(o);
m.add(n);
m.add(l);
return m;
},getBox6:function(){var t=new qx.ui.layout.VBox();
var v=new qx.ui.container.Composite(t).set({decorator:i,backgroundColor:g,height:300,allowGrowY:false});
t.setSpacing(5);
t.setAlignY(e);
var x=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10});
var w=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10,marginTop:20});
