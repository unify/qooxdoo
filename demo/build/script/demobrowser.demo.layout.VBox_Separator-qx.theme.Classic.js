...
i.add(this.getBox2());
i.add(this.getBox3());
},getBox1:function(){var n=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,f)).set({decorator:h,backgroundColor:e,allowGrowY:false});
n.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
n.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
n.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
return n;
},getBox2:function(){var o=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,f)).set({decorator:h,backgroundColor:e,minWidth:60,allowGrowY:false});
o.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxWidth:40,alignX:b}));
o.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxWidth:40,alignX:d}));
o.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxWidth:40,alignX:a}));
return o;
