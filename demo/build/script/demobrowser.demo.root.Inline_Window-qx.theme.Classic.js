...
var m=1;
k.addListener(j,function(e){var q=new qx.ui.window.Window(f+m++).set({width:200,height:150});
q.moveTo(m*15,m*15);
q.open();
});
n.add(k);
...
n.add(l);
},cModWin:1,newModalWindow:function(){var o=new qx.ui.window.Window(c+this.cModWin++).set({modal:true});
o.moveTo(300+this.cModWin*15,this.cModWin*15);
o.setLayout(new qx.ui.layout.HBox());
var p=new qx.ui.form.Button(i);
p.addListener(j,this.newModalWindow,this);
o.add(p);
o.open();
}}});
})();
