...
return S;
},getContextMenu:function(){var L=new qx.ui.menu.Menu();
var N=new qx.ui.menu.Button(E,h);
var O=new qx.ui.menu.Button(p,I);
var M=new qx.ui.menu.Button(o,A);
L.add(N);
L.add(O);
L.add(M);
return L;
