...
}},_initLogger:function(p,q,r){this.__My=e+p.join(h)+k;
this.__Mz=r||50;
this.__MA=q;
this._clearLog();
},_clearLog:function(){this.__MA.innerHTML=this.__My+l;
this.__MB=[];
},_log:function(n){this.__MB.unshift(n);
this.__MB=this.__MB.slice(0,this.__Mz);
var o=[this.__My];

for(var i=0;i<this.__MB.length;i++){o.push(d,this.__MB[i].join(f),a);
}o.push(l);
this.__MA.innerHTML=o.join(g);
this.__MA.scrollTop=0;
},__My:null,__Mz:null,__MA:null,__MB:null},destruct:function(){this.__MA=this.__MB=null;
}});
})();
