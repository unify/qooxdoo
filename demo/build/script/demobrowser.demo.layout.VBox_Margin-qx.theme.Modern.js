...
C.add(this.getBox4());
C.add(this.getBox5());
},getBox1:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:e,backgroundColor:c,allowGrowY:false});
...
k.setMarginRight(30);
return l;
},getBox2:function(){var p=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:e,backgroundColor:c,allowGrowY:false});
...
var u=new qx.ui.container.Composite(s).set({decorator:e,backgroundColor:c,width:150,allowGrowY:false});
s.setSpacing(5);
s.setAlignX(b);
...
var h=new qx.ui.container.Composite(f).set({decorator:e,backgroundColor:c,width:150,allowGrowY:false});
f.setSpacing(5);
f.setAlignX(b);
...
var z=new qx.ui.container.Composite(x).set({decorator:e,backgroundColor:c,width:150,allowGrowY:false});
x.setSpacing(5);
x.setAlignX(b);
