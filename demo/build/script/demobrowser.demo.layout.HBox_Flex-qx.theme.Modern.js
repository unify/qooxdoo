...
n.add(this.getBox5());
n.add(this.getBox6());
},getBox1:function(){var l=new qx.ui.layout.HBox();
var m=new qx.ui.container.Composite(l).set({width:500,decorator:d,backgroundColor:b,allowGrowX:false});
l.setSpacing(5);
m.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{flex:1});
m.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{flex:2});
m.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{flex:3});
return m;
},getBox2:function(){var o=new qx.ui.layout.HBox();
var p=new qx.ui.container.Composite(o).set({width:500,decorator:d,backgroundColor:b,allowGrowX:false});
o.setSpacing(5);
p.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxWidth:30}),{flex:1});
p.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{flex:2});
p.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxWidth:150}),{flex:3});
return p;
},getBox3:function(){var q=new qx.ui.layout.HBox();
var s=new qx.ui.container.Composite(q).set({width:500,decorator:d,backgroundColor:b,allowGrowX:false});
q.setSpacing(5);

for(var i=0;i<25;i++){var r=new qx.ui.core.Widget();
r.set({decorator:d,backgroundColor:c,width:5});
s.add(r,{flex:1});
}return s;
},getBox4:function(){var e=new qx.ui.layout.HBox();
var f=new qx.ui.container.Composite(e).set({width:600,minWidth:600,decorator:d,backgroundColor:b,allowGrowX:false});
e.setSpacing(5);
f.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxWidth:120}),{flex:1});
f.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxWidth:120}),{flex:2});
f.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxWidth:120}),{flex:3});
return f;
},getBox5:function(){var j=new qx.ui.layout.HBox();
var k=new qx.ui.container.Composite(j).set({width:300,minWidth:0,decorator:d,backgroundColor:b,allowGrowX:false});
j.setSpacing(5);
...
return k;
},getBox6:function(){var g=new qx.ui.layout.HBox();
var h=new qx.ui.container.Composite(g).set({width:300,decorator:d,backgroundColor:b,allowGrowX:false});
g.setSpacing(5);
h.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minWidth:120}),{flex:1});
h.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minWidth:120}),{flex:2});
h.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minWidth:120}),{flex:3});
return h;
}}});
})();
...
qx.Class.define(k,{extend:qx.ui.layout.Abstract,construct:function(bO,bP,bQ,bR){qx.ui.layout.Abstract.call(this);

if(bO){this.setSpacingX(bO);
}
if(bP){this.setSpacingY(bP);
}
if(bQ){this.setSeparatorX(bQ);
}
if(bR){this.setSeparatorY(bR);
}},properties:{sort:{check:[l,m,n],init:l,apply:j},separatorX:{check:p,nullable:true,apply:s},separatorY:{check:p,nullable:true,apply:s},connectSeparators:{check:e,init:false,apply:s},spacingX:{check:o,init:0,apply:s},spacingY:{check:o,init:0,apply:s}},members:{__Ju:null,__Jv:null,verifyLayoutProperty:null,_applySort:function(){this._invalidChildrenCache=true;
this._applyLayoutChange();
},__Jw:{north:1,south:2,west:3,east:4,center:5},__Jx:{1:q,2:d,3:r,4:g},__Jy:function(){var t=this._getLayoutChildren();
var B,v;
var length=t.length;
var x=[];
var A=[];
...
},renderLayout:function(bb,bc){if(this._invalidChildrenCache){this.__Jy();
}var bv=qx.ui.layout.Util;
var bi=this.__Ju;
var bw=this.__Jv;
var length=bi.length;
var bl,be,bk,bq,br,bB,bo,bf,by;
var bF=[];
var bn=[];
...
for(var i=0;i<length;i++){be=bi[i];
bq=be.getLayoutProperties();
bk=be.getSizeHint();
bo=bk.width;
bf=bk.height;

if(bq.width!=null){bo=Math.floor(bb*parseFloat(bq.width)/100);

if(bo<bk.minWidth){bo=bk.minWidth;
}else if(bo>bk.maxWidth){bo=bk.maxWidth;
}}
if(bq.height!=null){bf=Math.floor(bc*parseFloat(bq.height)/100);

if(bf<bk.minHeight){bf=bk.minHeight;
}else if(bf>bk.maxHeight){bf=bk.maxHeight;
}}bF[i]=bo;
bn[i]=bf;
switch(bw[i]){case 1:case 2:bx+=bf+be.getMarginTop()+be.getMarginBottom()+bI;

if(bE.y){bx+=bE.y+bI;
}break;
case 3:case 4:bj+=bo+be.getMarginLeft()+be.getMarginRight()+bJ;

if(bE.x){bj+=bE.x+bJ;
}break;
default:bj+=bo+be.getMarginLeft()+be.getMarginRight()+bJ;
bx+=bf+be.getMarginTop()+be.getMarginBottom()+bI;
...
switch(bw[i]){case 3:case 4:case 5:br=be.getLayoutProperties().flex;
if(br==null&&bw[i]==5){br=1;
}
if(br>0){bk=be.getSizeHint();
bl[i]={min:bk.minWidth,value:bF[i],max:bk.maxWidth,flex:br};
}}}var bg=bv.computeFlexOffsets(bl,bb,bj);

for(var i in bg){by=bg[i].offset;
bF[i]+=by;
bj+=by;
}}if(bx!=bc){bl=[];
bB=bx<bc;
...
switch(bw[i]){case 1:case 2:case 5:br=be.getLayoutProperties().flex;
if(br==null&&bw[i]==5){br=1;
}
if(br>0){bk=be.getSizeHint();
bl[i]={min:bk.minHeight,value:bn[i],max:bk.maxHeight,flex:br};
}}}var bg=bv.computeFlexOffsets(bl,bc,bx);
...
bk=be.getSizeHint();
bL=be.getMarginTop();
bm=be.getMarginBottom();
bp=be.getMarginLeft();
bh=be.getMarginRight();
switch(bK){case 1:case 2:bo=bb-bp-bh;
if(bo<bk.minWidth){bo=bk.minWidth;
}else if(bo>bk.maxWidth){bo=bk.maxWidth;
}bf=bn[i];
top=bt+bv.computeVerticalAlignOffset(bz[bK],bf,bc,bL,bm);
bN=bA+bv.computeHorizontalAlignOffset(be.getAlignX()||r,bo,bb,bp,bh);
if(bE.y){if(bK==1){bH=bt+bf+bL+bI+bm;
}else{bH=bt+bc-bf-bL-bI-bm-bE.y;
}bu=bN;
bM=bb;
...
}this._renderSeparator(bD,{left:bu,top:bH,width:bM,height:bE.y});
}bs=bf+bL+bm+bI;
...
case 3:case 4:bf=bc-bL-bm;
if(bf<bk.minHeight){bf=bk.minHeight;
}else if(bf>bk.maxHeight){bf=bk.maxHeight;
}bo=bF[i];
bN=bA+bv.computeHorizontalAlignOffset(bz[bK],bo,bb,bp,bh);
top=bt+bv.computeVerticalAlignOffset(be.getAlignY()||q,bf,bc,bL,bm);
if(bE.x){if(bK==3){bu=bA+bo+bp+bJ+bh;
}else{bu=bA+bb-bo-bp-bJ-bh-bE.x;
}bH=top;
bd=bc;
...
}this._renderSeparator(bC,{left:bu,top:bH,width:bE.x,height:bd});
}bs=bo+bp+bh+bJ;
...
},_computeSizeHint:function(){if(this._invalidChildrenCache){this.__Jy();
}var G=this.__Ju;
var Q=this.__Jv;
var length=G.length;
var K,R;
...
var O=0,X=0;
var E=0,S=0;
var U=this._getSeparatorWidths();
var W=this.getSpacingX(),V=this.getSpacingY();
var I=-W,H=-V;

if(U.x){I-=U.x+W;
}
if(U.y){H-=U.y+V;
}for(var i=0;i<length;i++){R=G[i];
K=R.getSizeHint();
M=R.getMarginLeft()+R.getMarginRight();
L=R.getMarginTop()+R.getMarginBottom();
switch(Q[i]){case 1:case 2:O=Math.max(O,K.width+N+M);
X=Math.max(X,K.minWidth+Y+M);
E+=K.height+L;
S+=K.minHeight+L;
H+=V;
...
case 3:case 4:D=Math.max(D,K.height+E+L);
T=Math.max(T,K.minHeight+S+L);
N+=K.width+M;
Y+=K.minWidth+M;
I+=W;
...
if(U.y){H+=U.y+V;
}}}var J=Math.max(Y,X)+I;
var ba=Math.max(N,O)+I;
var P=Math.max(T,S)+H;
var F=Math.max(D,E)+H;
return {minWidth:J,width:ba,minHeight:P,height:F};
}},destruct:function(){this.__Jv=this.__Ju=null;
}});
})();
...
(function(){var m="bold",l="wlpe_qx.ui.layout.Grid",k="black",j="demobrowser.demo.util.PropertyEditor",i="Widget Properties",h="lpe_qx.ui.layout.HBox",g="wlpe_qx.ui.layout.Dock",f="wlpe_",d="lpe_qx.ui.layout.Dock",c="lpe_",A="solid",z="string",y="wlpe_qx.ui.layout.HBox",x="wlpe_qx.ui.layout.Canvas",w="wlpe_qx.ui.layout.VBox",v=" layout properties",u="_applyWidget",t="qx.ui.core.Widget",s=" properties",r="wlpe_qx.ui.layout.Basic",p="Selected Widget",q="lpe_qx.ui.layout.Grid",n="pane",o="white";
qx.Class.define(j,{extend:qx.ui.core.scroll.AbstractScrollArea,construct:function(){qx.ui.core.scroll.AbstractScrollArea.call(this);
this.setWidth(null);
this._editorGroups={};
...
return H;
},_createLabel:function(D){return new qx.ui.basic.Label(D).set({font:m,allowGrowX:true,padding:[5,0,5,0]});
},_createContainer:function(O,P){var Q=new qx.ui.container.Composite(new qx.ui.layout.VBox().set({spacing:5}));
Q.add(this._createLabel(O));
Q.add(P);
return Q;
},updateWidgetLayoutPropertyEditor:function(E){var G=E.getLayoutParent()?E.getLayoutParent()._getLayout():null;
var F=this.getWidgetLayoutPropertyEditor(G);

if(F){F.getChildren()[1].setSelected(E);
}
if(F===this._wlpe){return;
}
if(this._wlpe){this._pane.remove(this._wlpe);
}
if(!F){this._wlpe=F;
return;
}this._pane.addAfter(F,this._layoutControls);
this._wlpe=F;
},updateLayoutPropertyEditor:function(S){var U=S.getLayout?S.getLayout():null;
var T=this.getLayoutPropertyEditor(U);

if(T){T.getChildren()[1].setSelected(U);
}
if(T===this._lpe){return;
}
...
}var name=f+a.constructor.classname;
var b;

if(this._editorGroups[name]){return this._editorGroups[name];
}
switch(name){case y:case w:b=new demobrowser.demo.util.LayoutPropertyGroup(demobrowser.demo.util.LayoutPropertyGroup.BOX_PROPERTIES);
break;
case x:b=new demobrowser.demo.util.LayoutPropertyGroup(demobrowser.demo.util.LayoutPropertyGroup.CANVAS_PROPERTIES);
break;
case r:b=new demobrowser.demo.util.LayoutPropertyGroup(demobrowser.demo.util.LayoutPropertyGroup.BASIC_PROPERTIES);
break;
case g:b=new demobrowser.demo.util.LayoutPropertyGroup(demobrowser.demo.util.LayoutPropertyGroup.DOCK_PROPERTIES);
break;
case l:b=new demobrowser.demo.util.LayoutPropertyGroup(demobrowser.demo.util.LayoutPropertyGroup.GRID_PROPERTIES);
break;
}
if(!b){return null;
}this._editorGroups[name]=this._createContainer(a.constructor.classname+v,b);
return this._editorGroups[name];
},getLayoutPropertyEditor:function(I){if(!I){return null;
}var name=c+I.constructor.classname;
var J;

if(this._editorGroups[name]){return this._editorGroups[name];
}
switch(name){case h:J=new demobrowser.demo.util.PropertyGroup(demobrowser.demo.util.PropertyGroup.HBOX_PROPERTIES);
break;
case d:J=new demobrowser.demo.util.PropertyGroup(demobrowser.demo.util.PropertyGroup.DOCK_PROPERTIES);
break;
case q:J=new demobrowser.demo.util.PropertyGroup(demobrowser.demo.util.PropertyGroup.GRID_PROPERTIES);
break;
}
if(!J){return null;
}this._editorGroups[name]=this._createContainer(I.constructor.classname+s,J);
return this._editorGroups[name];
},_applyWidget:function(B,C){this._layoutControls.setSelected(B);
this._widgetIndicator.setBackgroundColor(B.getBackgroundColor());
this._widgetIndicator.setDecorator(B.getDecorator());
this._widgetIndicator.setValue(B.toString());
this.updateLayoutPropertyEditor(B);
this.updateWidgetLayoutPropertyEditor(B);
...
(function(){var z="value",y="changeValue",x="enum",w="set",v="int",u="string",t="bool",s="function",r="null",q="demobrowser.demo.util.PropertyGroup",n="_applySelected",p="get",o="top",m="changeSelection",k="right";
qx.Class.define(q,{extend:qx.ui.core.Widget,construct:function(L){qx.ui.core.Widget.call(this);
this._properties=L;
var N=new qx.ui.layout.Grid(10,5);
N.setColumnAlign(0,k,o);
N.setColumnMinWidth(0,110);
this._setLayout(N);
this.set({allowShrinkX:false,allowShrinkY:false});
var U=0;

for(var Q in this._properties){var T=this._properties[Q].type;
var P=this._properties[Q].nullable;
this._add(new qx.ui.basic.Label(Q).set({paddingTop:4}),{row:U,column:0});

if(P){var O=new qx.ui.form.CheckBox(r);
O.addListener(y,this._createOnNullPropertyChange(Q),this);
this._add(O,{row:U,column:2});
this._properties[Q].nullWidget=O;
}
if(T==v){var S=new qx.ui.form.Spinner().set({minimum:this._properties[Q].min||0,maximum:this._properties[Q].max!==undefined?this._properties[Q].max:1000});
S.addListener(y,this._createOnIntPropertyChange(Q),this);
this._add(S,{row:U++,column:1});
}else if(T==t){var S=new qx.ui.form.CheckBox();
S.addListener(y,this._createOnBoolPropertyChange(Q),this);
this._add(S,{row:U++,column:1});
}else if(T==x){var R=this._properties[Q].values;
var S=new qx.ui.form.RadioGroup();

for(var i=0;i<R.length;i++){var M=new qx.ui.form.RadioButton(R[i]);
M.setUserData(z,R[i]);
S.add(M);
this._add(M,{row:U++,column:1});
}S.addListener(m,this._createOnEnumPropertyChange(Q,S),this);
}else if(T==u){var S=new qx.ui.form.TextField();
S.setLiveUpdate(true);
S.addListener(y,this._createOnIntPropertyChange(Q),this);
this._add(S,{row:U++,column:1});
}this._properties[Q].formItem=S;
}},statics:{WIDGET_PROPERTIES:{"width":{type:"int",nullable:true},"height":{type:"int",nullable:true},"minWidth":{type:"int",nullable:true},"minHeight":{type:"int",nullable:true},"maxWidth":{type:"int",nullable:true},"maxHeight":{type:"int",nullable:true},"allowGrowX":{type:"bool",nullable:false},"allowGrowY":{type:"bool",nullable:false},"allowShrinkX":{type:"bool",nullable:false},"allowShrinkY":{type:"bool",nullable:false},"marginTop":{type:"int",min:-1000,nullable:false},"marginRight":{type:"int",min:-1000,nullable:false},"marginBottom":{type:"int",min:-1000,nullable:false},"marginLeft":{type:"int",min:-1000,nullable:false},"paddingTop":{type:"int",nullable:false},"paddingRight":{type:"int",nullable:false},"paddingBottom":{type:"int",nullable:false},"paddingLeft":{type:"int",nullable:false},"alignX":{type:"enum",values:["left","center","right"],nullable:true},"alignY":{type:"enum",values:["top","middle","bottom","baseline"],nullable:true}},HBOX_PROPERTIES:{"alignX":{type:"enum",values:["left","center","right"],nullable:false},"alignY":{type:"enum",values:["top","middle","bottom","baseline"],nullable:false},"spacing":{type:"int",nullable:false},"reversed":{type:"bool",nullable:false}},DOCK_PROPERTIES:{"sort":{type:"enum",values:["auto","y","x"],nullable:false},"spacingX":{type:"int",nullable:false},"spacingY":{type:"int",nullable:false}},GRID_PROPERTIES:{"horizontalSpacing":{type:"int",nullable:false},"verticalSpacing":{type:"int",nullable:false}}},properties:{selected:{apply:n,nullable:true}},members:{_applySelected:function(F,G){this._updateControls(F);
},_setProperty:function(bc,name,bd){if(!bc){return;
}var bf=w+qx.lang.String.firstUp(name);
var be=this._properties[name].convert;

if(be){bd=be(bd);
}bc[bf](bd);
},_getProperty:function(B,name){var C=p+qx.lang.String.firstUp(name);
return B[C]();
},_hasProperty:function(D,name){var E=w+qx.lang.String.firstUp(name);
return (typeof (D[E])==s);
},_createOnIntPropertyChange:function(W){return function(e){var bb=this.getSelected();
this._setProperty(bb,W,e.getTarget().getValue());
};
},_createOnBoolPropertyChange:function(X){return function(e){var V=this.getSelected();
this._setProperty(V,X,e.getTarget().getValue());
};
},_createOnEnumPropertyChange:function(Y,ba){return function(e){var A=this.getSelected();
this._setProperty(A,Y,ba.getSelection()[0].getUserData(z));
};
},_createOnNullPropertyChange:function(H){return function(e){var J=this.getSelected();
var I=e.getTarget();

if(I.getValue()){this._setProperty(J,H,null);
this._properties[H].formItem.setEnabled(false);
}else{var K=null;

if(this._properties[H].type==x){K=this._properties[H].formItem.getSelection()[0].getUserData(z);
}else{K=this._properties[H].formItem.getValue();
}this._setProperty(J,H,K);
this._properties[H].formItem.setEnabled(true);
}};
},_updateControls:function(a){for(var h in this._properties){var j=this._properties[h].type;
var d=this._properties[h].formItem;
var b=this._properties[h].nullable;

if(!this._hasProperty(a,h)){d.setEnabled(false);

if(b){this._properties[h].nullWidget.setEnabled(false);
}return;
}d.setEnabled(true);
var g=this._getProperty(a,h);

if(g!==null){if(j==v){d.setValue(parseInt(g));
}else if(j==u){d.setValue(g.toString());
}else if(j==t){d.setValue(!!g);
}else if(j==x){var c=d.getItems();

for(var i=0,l=c.length;i<l;i++){var f=c[i];

if(f.getUserData(z)==g){d.setSelection([f]);
break;
}}}}
if(b){this._properties[h].nullWidget.setValue(g==null);
this._properties[h].nullWidget.setEnabled(true);
d.setEnabled(g!==null);
...
}},"right":{type:"string",nullable:true,convert:function(n){if(parseInt(n).toString()==n){n=parseInt(n);
}return n||null;
}},"bottom":{type:"string",nullable:true,convert:function(f){if(parseInt(f).toString()==f){f=parseInt(f);
}return f||null;
}},"left":{type:"string",nullable:true,convert:function(c){if(parseInt(c).toString()==c){c=parseInt(c);
}return c||null;
}},"width":{type:"int",nullable:true,convert:function(d){return d==null?null:d+"%";
}},"height":{type:"int",nullable:true,convert:function(e){return e==null?null:e+"%";
}}},DOCK_PROPERTIES:{"width":{type:"int",nullable:true,convert:function(o){return o==null?null:o+"%";
...
},_getProperty:function(l,name){return l.getLayoutProperties()[name]||null;
},_hasProperty:function(m,name){return true;
}}});
})();
