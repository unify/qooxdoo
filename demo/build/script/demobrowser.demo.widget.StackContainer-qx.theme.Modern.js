...
u.add(t);
}u.addListener(h,function(e){var E=e.getData()[0];
this.debug("Selected: "+E.getBackgroundColor()+" ("+E.getWidth()+"x"+E.getHeight()+")");
});
u.addListener(a,function(e){var F=this.getBounds();
