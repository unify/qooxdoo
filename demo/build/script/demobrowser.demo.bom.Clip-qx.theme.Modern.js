...
qx.log.Logger.debug("Clip init: "+n.left+","+n.top+"  "+n.width+","+n.height);
},set0:function(){var k=document.getElementById(b);
...
},set1:function(){var e=document.getElementById(b);
qx.log.Logger.debug("Setting to: 20,20  null,40");
qx.bom.element.Clip.set(e,{left:20,top:20,height:40});
