...
qx.$$build = 1282827041314;
qx.$$type = "build";
  
if (!window.qxsettings) qxsettings = {};
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.mobile.Pong","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.mobile.Pong-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"620c7956077a"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
