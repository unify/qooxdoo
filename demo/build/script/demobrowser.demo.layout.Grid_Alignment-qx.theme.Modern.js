...
return v;
},getColumnAlignGrid:function(){var t=new qx.ui.container.Composite().set({decorator:m,backgroundColor:l,allowGrowX:false,allowGrowY:false});
var u=new qx.ui.layout.Grid();
u.setSpacing(3);
u.setColumnAlign(0,h,j);
u.setColumnAlign(1,f,e);
u.setColumnAlign(2,g,k);
t.setLayout(u);

for(var x=0;x<3;x++){for(var y=0;y<6;y++){t.add(this.getNewWidget(),{row:y,column:x});
}}return t;
},getRowAlignGrid:function(){var o=new qx.ui.container.Composite().set({decorator:m,backgroundColor:l,allowGrowX:false,allowGrowY:false});
...
for(var x=0;x<6;x++){for(var y=0;y<3;y++){o.add(this.getNewWidget(),{row:y,column:x});
}}return o;
},getCellAlignGrid:function(){var q=new qx.ui.container.Composite().set({decorator:m,backgroundColor:l,allowGrowX:false,allowGrowY:false});
var s=new qx.ui.layout.Grid();
s.setSpacing(3);
q.setLayout(s);

for(var x=0;x<5;x++){s.setColumnAlign(x,f,e);

for(var y=0;y<5;y++){q.add(this.getNewWidget(),{row:y,column:x});
}}var r=s.getCellWidget(0,0);
r.set({alignX:h,alignY:j});
r.set({backgroundColor:d,width:20,height:20});
var r=s.getCellWidget(4,4);
r.set({alignX:g,alignY:k});
r.set({backgroundColor:d,width:20,height:20});
return q;
