...
this.getRoot().add(B);
var C=new qx.ui.basic.Label(j).set({decorator:s,width:200});
B.add(C);
this.getRoot().add(this.createConfigureButton(C,e),{left:240,top:20});
var D=new qx.ui.basic.Label(l).set({decorator:s,rich:true});
B.add(D);
this.getRoot().add(this.createConfigureButton(D,g),{left:240,top:60});
var E=new qx.ui.basic.Label(m).set({decorator:s,width:80});
B.add(E);
var F=new qx.ui.basic.Label().set({value:h,decorator:s,rich:true,width:120});
B.add(F);
var G=new qx.ui.basic.Label(a).set({decorator:s,font:new qx.bom.Font(28,[r,q])});
B.add(G);
var H=new qx.ui.basic.Label(n).set({decorator:s,font:new qx.bom.Font(28,[r,q]),width:150});
B.add(H);
},createConfigureButton:function(I,J){var L=new qx.ui.form.Button(J);
var K;
L.addListener(i,function(){if(!K){K=this.createEditDialog(I,J);
}K.open();
},this);
return L;
