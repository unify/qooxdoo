...
},_createDefaultExample:function(){var D=new qx.ui.basic.Label(c);
D.setFont(t);
this.getRoot().add(D,{left:20,top:25});
var B=new qx.ui.form.ComboBox();
for(var i=1;i<31;i++){var C=new qx.ui.form.ListItem(g+i+s+Math.pow(2,i));
B.add(C);
}B.addListener(j,function(e){this.debug("ChangeValue: "+e.getData());
});
this.getRoot().add(B,{left:20,top:40});
},_createIconExample:function(){var w=new qx.ui.basic.Label(k);
w.setFont(t);
this.getRoot().add(w,{left:160,top:25});
var u=new qx.ui.form.ComboBox();
for(var i=1;i<31;i++){var v=new qx.ui.form.ListItem(i+l,f);
u.add(v);
}this.getRoot().add(u,{left:160,top:40});
},_createHtmlExample:function(){var A=new qx.ui.basic.Label(d);
A.setFont(t);
