...
var G=new qx.ui.layout.Grid(10,10);
this.container=new qx.ui.container.Composite(G).set({padding:20});
...
},__Rn:4,__Ro:0,add:function(C){this.container.add(C,{row:Math.floor(this.__Ro/this.__Rn),column:this.__Ro%this.__Rn});
this.__Ro+=1;
},createSharedToolTip:function(){var F=new qx.ui.tooltip.ToolTip(r);
F.addListener(t,function(e){var K=b;

if(this.getOpener()==E){K+=q;
}else{K+=s;
}F.setLabel(K);
});
...
D.setToolTip(F);
this.add(D);
},createIconToolTip:function(){var L=new qx.ui.form.Button(x).set({toolTip:new qx.ui.tooltip.ToolTip(null,l)});
this.add(L);
...
this.add(M);
M.setToolTip(N);
},createRichToolTip:function(){var J=new qx.ui.tooltip.ToolTip(p+u+n,j);
J.setWidth(200);
J.setRich(true);
J.setShowTimeout(50);
var I=new qx.ui.form.Button(z);
this.add(I);
I.setToolTip(J);
},createToolTipText:function(){var O=new qx.ui.form.Button(o).set({toolTipText:k});
this.add(O);
},createToolTipIcon:function(){var a=new qx.ui.form.Button(m).set({toolTipIcon:l});
this.add(a);
},createToolTipTextIcon:function(){var B=new qx.ui.form.Button(d).set({toolTipText:k,toolTipIcon:l});
this.add(B);
