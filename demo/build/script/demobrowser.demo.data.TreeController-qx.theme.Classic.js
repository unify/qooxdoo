...
(function(){var s="qx.data.Array",r="demobrowser.demo.data.model.Node",q="String",p="changeNames",o="changeName",n="Validation Error: ",m="- ",l="",k="changeChild",j="changeColor",c="Marge",h="AFFE",f="is no number (parseFloat says so!).",b="__Mn",a="Homer",e="\n",d="changeName2",g="changeChildren";
qx.Class.define(r,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.setChildren(new qx.data.Array());
},properties:{children:{check:s,event:g},child:{check:r,event:k,nullable:true},names:{check:s,event:p,init:new qx.data.Array(a,c)},name:{check:q,init:h,event:o},name2:{check:q,event:d},number:{init:10,validate:b},color:{event:j,nullable:true}},members:{__Mn:function(t){if(!isNaN(parseFloat(t))){if(/^\d+$/.test(t)){return;
