...
(function(){var n="execute",m="-",l="+",k="n",j="/",i="*",h="=",g="sans-serif",f="Verdana",d=".",L="black",K="Del",J="C",I="5",H="7",G="demobrowser.demo.showcase.Calculator",F="CE",E="solid",D="icon/22/apps/utilities-calculator.png",C="3",u="0",v="__Oe",s="8",t="6",q="4",r="Calculator",o="right",p="2",w="__Of",x="1",z="demobrowser.demo.showcase.CalculatorLogic",y="white",B="+/-",A="9";
qx.Class.define(G,{extend:qx.application.Standalone,members:{__Oe:null,__Of:null,main:function(){qx.application.Standalone.prototype.main.call(this);
{};
this.__Of=new demobrowser.demo.showcase.CalculatorLogic();
this.createCalculator();
},createCalculator:function(){var S=new qx.ui.window.Window(r,D);
S.setLayout(new qx.ui.layout.VBox(16));
var U=new qx.ui.decoration.Single(1,E,L);
var bd=new qx.ui.container.Composite().set({minWidth:180,minHeight:280,padding:3,allowGrowX:true,allowGrowY:true});
var bn=new qx.ui.layout.Grid(5,5);
bd.setLayout(bn);
this.__Oe=new qx.ui.basic.Label(this.__Of.getCurrentValue().toString()).set({decorator:U,backgroundColor:y,allowGrowX:true,allowGrowY:true,minWidth:160,height:50,font:new qx.bom.Font().set({size:22,family:[f,g],bold:true}),textAlign:o});
this.__Oe.setEnabled(false);
var bo=new qx.bom.Font().set({size:14,family:[f,g],bold:true});
var bi=new qx.ui.form.Button(u).set({font:bo,minWidth:40});
var bh=new qx.ui.form.Button(x).set({font:bo,minWidth:40});
var bg=new qx.ui.form.Button(p).set({font:bo,minWidth:40});
var bf=new qx.ui.form.Button(C).set({font:bo,minWidth:40});
var bm=new qx.ui.form.Button(q).set({font:bo,minWidth:40});
var bl=new qx.ui.form.Button(I).set({font:bo,minWidth:40});
var bk=new qx.ui.form.Button(t).set({font:bo,minWidth:40});
var bj=new qx.ui.form.Button(H).set({font:bo,minWidth:40});
var bq=new qx.ui.form.Button(s).set({font:bo,minWidth:40});
var bp=new qx.ui.form.Button(A).set({font:bo,minWidth:40});
var R=new qx.ui.form.Button(J).set({font:bo,minWidth:40});
var T=new qx.ui.form.Button(F).set({font:bo,minWidth:40});
var Y=new qx.ui.form.Button(K).set({font:bo,minWidth:40});
var X=new qx.ui.form.Button(B).set({font:bo,minWidth:40});
var bb=new qx.ui.form.Button(d).set({font:bo,minWidth:40});
var W=new qx.ui.form.Button(l).set({font:bo,minWidth:40});
var be=new qx.ui.form.Button(m).set({font:bo,minWidth:40});
var bc=new qx.ui.form.Button(i).set({font:bo,minWidth:40});
var ba=new qx.ui.form.Button(j).set({font:bo,minWidth:40});
var V=new qx.ui.form.Button(h).set({font:bo,minWidth:40});
bn.setColumnFlex(0,1);
bn.setColumnFlex(1,1);
bn.setColumnFlex(2,1);
bn.setColumnFlex(3,1);
bn.setRowFlex(1,1);
bn.setRowFlex(2,1);
bn.setRowFlex(3,1);
bn.setRowFlex(4,1);
bn.setRowFlex(5,1);
bn.setRowFlex(6,1);
bd.add(this.__Oe,{row:0,column:0,rowSpan:0,colSpan:4});
bd.add(R,{row:1,column:2,rowSpan:1,colSpan:2});
bd.add(T,{row:1,column:1});
bd.add(Y,{row:1,column:0});
bd.add(bj,{row:2,column:0});
bd.add(bq,{row:2,column:1});
bd.add(bp,{row:2,column:2});
bd.add(ba,{row:2,column:3});
bd.add(bm,{row:3,column:0});
bd.add(bl,{row:3,column:1});
bd.add(bk,{row:3,column:2});
bd.add(bc,{row:3,column:3});
bd.add(bh,{row:4,column:0});
bd.add(bg,{row:4,column:1});
bd.add(bf,{row:4,column:2});
bd.add(be,{row:4,column:3});
bd.add(bi,{row:5,column:0});
bd.add(X,{row:5,column:1});
bd.add(bb,{row:5,column:2});
bd.add(W,{row:5,column:3});
bd.add(V,{row:6,column:0,rowSpan:1,colSpan:4});
S.setWidth(260);
S.setMinWidth(260);
S.setHeight(260);
S.open();
this.getRoot().add(S,{left:20,top:20});
S.add(bd,{flex:1});
R.addListener(n,function(e){this.__Of.cleanDisplay();
this.__Oe.setValue(this.__Of.getCurrentValue().toString());
},this);
T.addListener(n,function(e){this.__Of.clearEntry();

if(this.__Of.getResult()!=null){this.__Oe.setValue(this.__Of.getCurrentValue().toString());
}},this);
Y.addListener(n,function(e){this.__Of.deleteNumber();
this.__Oe.setValue(this.__Of.getCurrentValue().toString());
},this);
X.addListener(n,function(e){this.__Of.setSign();

if(this.__Of.getResult()!=null){this.__Oe.setValue(this.__Of.getResult().toString());
}},this);
bi.addListener(n,function(e){this.__Of.setCurrentValue(0);
this.__Oe.setValue(this.__Of.getCurrentValue().toFixed(this.__Of.getZeroCounter()).toString());
},this);
bh.addListener(n,function(e){this.__Of.setCurrentValue(1);
this.__Oe.setValue(this.__Of.getCurrentValue().toString());
},this);
bg.addListener(n,function(e){this.__Of.setCurrentValue(2);
this.__Oe.setValue(this.__Of.getCurrentValue().toString());
},this);
bf.addListener(n,function(e){this.__Of.setCurrentValue(3);
this.__Oe.setValue(this.__Of.getCurrentValue().toString());
},this);
bm.addListener(n,function(e){this.__Of.setCurrentValue(4);
this.__Oe.setValue(this.__Of.getCurrentValue().toString());
},this);
bl.addListener(n,function(e){this.__Of.setCurrentValue(5);
this.__Oe.setValue(this.__Of.getCurrentValue().toString());
},this);
bk.addListener(n,function(e){this.__Of.setCurrentValue(6);
this.__Oe.setValue(this.__Of.getCurrentValue().toString());
},this);
bj.addListener(n,function(e){this.__Of.setCurrentValue(7);
this.__Oe.setValue(this.__Of.getCurrentValue().toString());
},this);
bq.addListener(n,function(e){this.__Of.setCurrentValue(8);
this.__Oe.setValue(this.__Of.getCurrentValue().toString());
},this);
bp.addListener(n,function(e){this.__Of.setCurrentValue(9);
this.__Oe.setValue(this.__Of.getCurrentValue().toString());
},this);
W.addListener(n,function(e){this.__Of.calculate(l);

if(this.__Of.getResult()!=null){this.__Oe.setValue(this.__Of.getResult().toString());
}this.__Of.resetCurrentValue();
},this);
be.addListener(n,function(e){this.__Of.calculate(m);

if(this.__Of.getResult()!=null){this.__Oe.setValue(this.__Of.getResult().toString());
}this.__Of.resetCurrentValue();
},this);
bc.addListener(n,function(e){this.__Of.calculate(i);

if(this.__Of.getResult()!=null){this.__Oe.setValue(this.__Of.getResult().toString());
}this.__Of.resetCurrentValue();
},this);
ba.addListener(n,function(e){this.__Of.calculate(j);

if(this.__Of.getResult()!=null){this.__Oe.setValue(this.__Of.getResult().toString());
}this.__Of.resetCurrentValue();
},this);
V.addListener(n,function(e){this.__Of.calculate(h);

if(this.__Of.getResult()!=null){this.__Oe.setValue(this.__Of.getResult().toString());
}this.__Of.resetCurrentValue();
},this);
bb.addListener(n,function(e){this.__Of.setComma();
},this);
...
},members:{__Og:0,__Oh:0,__Oi:k,__Oj:0,__Ok:0,__Ol:0,__Om:false,__On:1,__Oo:0,__Op:false,__Oq:0,setCurrentValue:function(a){if(this.__Om){this.__On*=10;
this.__Og=this.__Og+(a/this.__On);

if(a==0){this.__Oo++;
}}else{this.__Om=false;

if(this.__Og<0){this.__Og=this.__Og*10-a;
}else{this.__Og=this.__Og*10+a;
}}},getZeroCounter:function(){return this.__Oo;
},setComma:function(){this.__Om=true;
},getCurrentValue:function(){return this.__Og;
},resetCurrentValue:function(){this.__Og=null;
},cleanDisplay:function(){this.__Oq=0;
this.__Ok=0;
this.__Oi=k;
this.__Oo=0;
this.__On=1;
...
this.__Oh=0;
this.__Op=false;
},setResult:function(M){this.__Oh=M;
},getResult:function(){return Math.round(this.__Oh*10000000)/10000000;
},setCurrentOperation:function(b){this.__Oi=b;
},getCurrentOperation:function(){return this.__Oi;
},clearEntry:function(){this.__Op=false;
this.__Oo=0;
this.__On=1;
this.__Om=false;
this.__Ol++;
...
if(this.__Ol<2){this.__Ok=this.__Oh;
}
if(this.__Oj>=2){this.__Oh=0;
this.__Oj=0;
}},setSign:function(){this.__Oq++;

if(this.__Oq%2==0){this.__Op=false;
}else{this.__Op=true;
}
if(this.__Og==null){this.__Og=this.__Oh;
}this.__Og=this.__Og*(-1);

if(this.__Oh==0){this.__Oh=this.__Og;
}
if(this.__Oh!=0){this.__Ok=this.__Oh;
this.__Oh=this.__Og;
}},deleteNumber:function(){var N=false;
var Q=false;

if(this.__Og<0){this.__Og=this.__Og*(-1);
Q=true;
}
if(this.__Og!=null){if(this.__Og.toString().lastIndexOf(d)!=-1){this.__Og=this.__Og*this.__On;
N=true;
}}var O=this.__Og%10;
var P=O/10;
this.__Og=this.__Og/10;
this.__Og=this.__Og-P;

if(N){this.__On/=10;
this.__Og=this.__Og/(this.__On);
N=false;
}
if(Q){this.__Og=this.__Og*(-1);
Q=false;
}},calculate:function(c){if(c==l||c==i||c==j||c==m||c==h){this.__Om=false;
this.__On=1;
this.__Oo=0;

if(this.__Oi!=k){if(this.__Oi==l){if(this.__Oh==null){this.__Oh=this.__Ok;
}
if(this.__Op){this.__Oh=this.__Ok+this.__Og;
}else{this.__Oh=this.__Oh+this.__Og;
}this.__Og=this.__Oh;
this.__Ok=this.__Oh;
}
if(this.__Oi==m){if(this.__Oh==0){this.__Oh=this.__Og;
this.__Og=0;
}
if(this.__Oh==null){this.__Oh=this.__Ok;
}
if(this.__Op){this.__Oh=this.__Ok-this.__Og;
}else{this.__Oh=this.__Oh-this.__Og;
}this.__Og=this.__Oh;
...
if(this.__Oi==j){if(this.__Oh==0){this.__Oh=this.__Og;
this.__Og=1;
}
if(this.__Oh==null){this.__Oh=this.__Ok;
}
if(this.__Og!=null){if(this.__Og!=0){if(this.__Op){this.__Oh=this.__Ok/this.__Og;
}else{this.__Oh=this.__Oh/this.__Og;
}}else{alert("You can't divide by 0!");
}}this.__Og=this.__Oh;
this.__Ok=this.__Oh;
}
if(this.__Oi==i){if(this.__Oh==0){this.__Oh=1;
}
if(this.__Og==null){this.__Og=1;
}
if(this.__Oh==null){this.__Oh=this.__Ok;
}
if(this.__Op){this.__Oh=this.__Ok*this.__Og;
