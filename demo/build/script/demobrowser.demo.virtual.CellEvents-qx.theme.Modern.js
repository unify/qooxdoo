...
var r=s.getPane();
r.addListener(i,this._onCellClick,this);
r.addListener(c,this._onContextMenu,this);
r.addListener(a,this._onDblclickPane,this);
...
this.__Qi(o);
},_onContextMenu:function(e){var t=h+e.getRow()+m+e.getColumn()+n;
this.__Qi(t);
},_onDblclickPane:function(e){var p=g+e.getRow()+m+e.getColumn()+n;
this.__Qi(p);
},__Qi:function(q){this.logger.setHtml(this.logger.getHtml()+q);
