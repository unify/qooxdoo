...
},bindItem:function(A,B,C){A.bindProperty(x,o,null,B,C);
A.bindProperty(h,j,null,B,C);
A.bindPropertyReverse(h,j,null,B,C);
}};
F.setDelegate(E);
F.setModel(L);
var D=new qx.ui.form.Button(r);
D.setWidth(120);
this.getRoot().add(D,{left:180,top:80});
D.addListener(k,function(){for(var i=0;i<L.length;i++){L.getItem(i).toggleOnline();
}},this);
var J=new qx.ui.form.Button(w);
J.setWidth(120);
this.getRoot().add(J,{left:180,top:115});
J.addListener(k,function(){qx.log.appender.Console.show();
