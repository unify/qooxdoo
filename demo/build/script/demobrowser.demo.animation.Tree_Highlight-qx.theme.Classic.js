...
(function(){var Y="execute",X="appear",W="changeSelection",V="Trash",U="mode",T="Windows (C:)",S="Documents (D:)",R="Add before",Q="Add after",P="Add at begin",bz="Inbox",by="Desktop",bx="Show open button:",bw="New tree item name: ",bv="auto",bu="Hello",bt="Presets",bs="Data 123213234325345234523453453245",br="demobrowser.demo.animation.Tree_Highlight",bq="Network",bg="Control",bh="Sent",be="Files",bf="Remove tree item",bc="Add file",bd="Workspace",ba="Junk #",bb="Tree",bi="never",bj="Add folder",bl="Root",bk="always",bn="Move to parent",bm="Reset tree",bp="Edit",bo="Remove all children";
qx.Class.define(br,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);
...
var bE=new qx.ui.groupbox.GroupBox(bb).set({contentPadding:[4,4,4,4]});
bE.setLayout(new qx.ui.layout.Canvas());
this._container.add(bE);
this._treeGroup=bE;
var bF=this.getTree();
bE.add(bF,{edge:0});
this._tree=bF;
this._container.add(this.getCommandFrame());
},getTree:function(){var s=new qx.ui.tree.Tree().set({width:200,height:400});
var x=new qx.ui.tree.TreeFolder(bl);
x.setOpen(true);
s.setRoot(x);
var v=new qx.ui.tree.TreeFolder(by);
v.setOpen(true);
x.add(v);
var n=new qx.ui.tree.TreeFolder(be);
var l=new qx.ui.tree.TreeFolder(bd);
var m=new qx.ui.tree.TreeFolder(bq);
var k=new qx.ui.tree.TreeFolder(V);
v.add(n,l,m,k);
var t=new qx.ui.tree.TreeFile(T);
var j=new qx.ui.tree.TreeFile(S);
l.add(t,j);
var w=new qx.ui.tree.TreeFolder(bz);
var o=new qx.ui.tree.TreeFolder(bt);
var r=new qx.ui.tree.TreeFolder(bh);
var q=new qx.ui.tree.TreeFolder(V);

for(var i=0;i<100;i++){q.add(new qx.ui.tree.TreeFile(ba+i));
}var u=new qx.ui.tree.TreeFolder(bs);
var p=new qx.ui.tree.TreeFolder(bp);
w.add(o,r,q,u,p);
x.add(w);
return s;
},getCommandFrame:function(){var K=new qx.ui.groupbox.GroupBox(bg);
K.setLayout(new qx.ui.layout.Grid(3,5));
var M=0;
K.add(new qx.ui.basic.Label(bw).set({paddingTop:4}),{row:M,column:0});
this.inputItemName=new qx.ui.form.TextField(bu);
K.add(this.inputItemName,{row:M++,column:1});
this.btnAddFolder=new qx.ui.form.Button(bj);
this.btnAddFolder.addListener(Y,this._addFolder,this);
K.add(this.btnAddFolder,{row:M++,column:0,colSpan:2});
this.btnAddFile=new qx.ui.form.Button(bc);
this.btnAddFile.addListener(Y,this._addFile,this);
K.add(this.btnAddFile,{row:M++,column:0,colSpan:2});
this.btnAddAfter=new qx.ui.form.Button(Q);
this.btnAddAfter.addListener(Y,this._addAfter,this);
K.add(this.btnAddAfter,{row:M++,column:0,colSpan:2});
this.btnAddBefore=new qx.ui.form.Button(R);
this.btnAddBefore.addListener(Y,this._addBefore,this);
K.add(this.btnAddBefore,{row:M++,column:0,colSpan:2});
this.btnAddBegin=new qx.ui.form.Button(P);
this.btnAddBegin.addListener(Y,this._addBegin,this);
K.add(this.btnAddBegin,{row:M++,column:0,colSpan:2});
K.add(new qx.ui.core.Spacer(5,5),{row:M++,column:0});
this.btnRemove=new qx.ui.form.Button(bf);
this.btnRemove.addListener(Y,this._removeTreeItem,this);
K.add(this.btnRemove,{row:M++,column:0,colSpan:2});
this.btnRemoveAll=new qx.ui.form.Button(bo);
this.btnRemoveAll.addListener(Y,this._removeAll,this);
K.add(this.btnRemoveAll,{row:M++,column:0,colSpan:2});
K.add(new qx.ui.core.Spacer(5,5),{row:M++,column:0});
this.btnMoveToParent=new qx.ui.form.Button(bn);
this.btnMoveToParent.addListener(Y,this._moveToParent,this);
K.add(this.btnMoveToParent,{row:M++,column:0,colSpan:2});
K.add(new qx.ui.core.Spacer(5,5),{row:M++,column:0});
K.add(new qx.ui.basic.Label(bx),{row:M,column:0});
var I=[bk,bi,bv];
this.showOpenButtons={};
this.mgrShowRootOpen=new qx.ui.form.RadioGroup();

for(var i=0;i<I.length;i++){var L=I[i];
var J=new qx.ui.form.RadioButton(L).set({value:L==this._tree.getRootOpenClose()});
J.setUserData(U,L);
this.showOpenButtons[L]=J;
this.mgrShowRootOpen.add(J);
K.add(J,{row:M++,column:1});
}this.mgrShowRootOpen.addListener(W,this._onChangeShowOpen,this);
K.add(new qx.ui.core.Spacer(5,5),{row:M++,column:0});
this.btnReset=new qx.ui.form.Button(bm);
this.btnReset.addListener(Y,this._resetTree,this);
K.add(this.btnReset,{row:M++,column:0,colSpan:2});
this._tree.addListener(W,this._updateControls,this);
this._updateControls();
return K;
},_addFolder:function(){var bA=this._tree.getSelection()[0];
var bB=new qx.ui.tree.TreeFolder(this.inputItemName.getValue());
bB.addListenerOnce(X,function(){var H=new qx.fx.effect.core.Highlight(bB.getContainerElement().getDomElement());
H.start();
},this);
bA.setOpen(true);
bA.add(bB);
...
E.addListenerOnce(X,function(){var A=new qx.fx.effect.core.Highlight(E.getContainerElement().getDomElement());
A.start();
},this);
D.setOpen(true);
D.add(E);
},_addBefore:function(){var y=this._tree.getSelection()[0];
var z=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
z.addListenerOnce(X,function(){var F=new qx.fx.effect.core.Highlight(z.getContainerElement().getDomElement());
F.start();
},this);
y.getParent().addBefore(z,y);
},_addAfter:function(){var b=this._tree.getSelection()[0];
var c=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
c.addListenerOnce(X,function(){var bD=new qx.fx.effect.core.Highlight(c.getContainerElement().getDomElement());
bD.start();
},this);
b.getParent().addAfter(c,b);
},_addBegin:function(){var B=this._tree.getSelection()[0];
var C=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
C.addListenerOnce(X,function(){var d=new qx.fx.effect.core.Highlight(C.getContainerElement().getDomElement());
d.start();
},this);
...
parent.remove(a);
},_removeAll:function(){var G=this._tree.getSelection()[0];
G.removeAll();
},_moveToParent:function(){var bC=this._tree.getSelection()[0];
var parent=bC.getParent();
parent.remove(bC);
parent.getParent().add(bC);
this._updateControls();
},_onChangeShowOpen:function(){var N=this._tree.getSelection()[0];

if(N!=null){var O=this.mgrShowRootOpen.getSelection()[0].getUserData(U);
N.setOpenSymbolMode(O);
...
},_updateControls:function(){var e=this._tree.getSelection()[0];

if(!e){this.btnAddFolder.setEnabled(false);
...
var f=h==-1;
var g=e instanceof qx.ui.tree.TreeFolder;
this.btnAddFolder.setEnabled(g);
this.btnAddFile.setEnabled(g);
this.btnAddBefore.setEnabled(!f);
this.btnAddAfter.setEnabled(!f);
this.btnAddBegin.setEnabled(!f);
this.btnRemove.setEnabled(!f);
this.btnRemoveAll.setEnabled(true);
this.mgrShowRootOpen.setEnabled(g);
this.showOpenButtons[e.getOpenSymbolMode()].setValue(true);
this.btnMoveToParent.setEnabled(h>0);
