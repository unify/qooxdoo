...
l.add(this.getGrid2());
l.add(this.getGrid3());
},getGrid1:function(){var o=new qx.ui.container.Composite(new qx.ui.layout.Grid(10,20)).set({decorator:k,backgroundColor:i,allowGrowX:false,allowGrowY:false});
o.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:0,column:0});
o.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:0,column:1});
o.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:1,column:0});
o.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:1,column:1});
return o;
},getGrid2:function(){var r=new qx.ui.layout.Grid();
r.setColumnAlign(1,f,d);
r.setColumnAlign(0,b,c);
r.setSpacing(5);
var q=new qx.ui.container.Composite(r).set({decorator:k,backgroundColor:i,allowGrowX:false});
q.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j,width:150}),{row:0,column:0});
var p=new qx.ui.basic.Label(h).set({decorator:k,backgroundColor:j,allowGrowX:false,width:50,height:50});
q.add(p,{row:0,column:1});
q.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j,maxHeight:60,allowGrowX:false}),{row:1,column:0});
q.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j,height:80}),{row:1,column:1});
q.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:2,column:0});
q.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:2,column:1});
var s=10;
p.addListener(g,function(e){p.setWidth(50+s);
s=-s;
});
return q;
},getGrid3:function(){var n=new qx.ui.container.Composite().set({decorator:k,backgroundColor:i,width:400,height:300,allowShrinkX:false,allowShrinkY:false});
var m=new qx.ui.layout.Grid();
m.setColumnFlex(1,2);
m.setRowFlex(1,3);
m.setSpacing(5);
n.setLayout(m);
n.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:0,column:0});
n.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:0,column:1});
n.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:1,column:0});
n.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:1,column:1});
return n;
}}});
})();
