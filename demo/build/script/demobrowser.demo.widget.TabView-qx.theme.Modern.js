...
var E=new qx.ui.container.Composite(new qx.ui.layout.VBox(10));
E.setPadding(20);
E.setAllowStretchX(false);
F.add(E);
this.getRoot().add(F,{edge:0});
E.add(this.getTabView1());
E.add(this.getTabView2());
E.add(this.getTabView3());
},getTabView1:function(){var V=new qx.ui.tabview.TabView();
V.setWidth(500);
var ba=new qx.ui.tabview.Page(c,k);
ba.setLayout(new qx.ui.layout.VBox());
ba.add(new qx.ui.basic.Label(q));
V.add(ba);
var X=new qx.ui.tabview.Page(f,z);
X.setLayout(new qx.ui.layout.VBox());
X.add(new qx.ui.basic.Label(t));
V.add(X);
var Y=new qx.ui.tabview.Page(w,j);
Y.setLayout(new qx.ui.layout.VBox());
Y.add(new qx.ui.basic.Label(A));
V.add(Y);
var W=new qx.ui.tabview.Page(u,D);
W.setLayout(new qx.ui.layout.VBox());
W.add(new qx.ui.basic.Label(s));
V.add(W);
return V;
},getTabView2:function(){var G=new qx.ui.tabview.TabView();
G.setWidth(500);

for(var i=1;i<=20;i++){var H=new qx.ui.tabview.Page(n+i,k);
H.setLayout(new qx.ui.layout.VBox());
H.setShowCloseButton(true);
H.add(new qx.ui.basic.Label(n+i+p));
G.add(H);
}return G;
},getTabView3:function(){var K=new qx.ui.tabview.TabView();
K.setWidth(500);
K.setHeight(300);

for(var i=1;i<=3;i++){var T=new qx.ui.tabview.Page(n+i,l);
T.setLayout(new qx.ui.layout.VBox(4));
K.add(T);
T.add(new qx.ui.basic.Label(n+i));
}var M=K.getChildren()[0];
var R=new qx.ui.basic.Label(y);
var P=new qx.ui.form.RadioButton(x);
var J=new qx.ui.form.RadioButton(g);
var O=new qx.ui.form.RadioButton(o);
var Q=new qx.ui.form.RadioButton(v);
...
M.add(O);
M.add(Q);
var S=new qx.ui.form.RadioGroup(P,J,O,Q);
S.addListener(B,function(e){this.setBarPosition(e.getData()[0].getLabel());
},K);
O.setValue(true);
var L=new qx.ui.form.Button(C);
var N=new qx.ui.form.Button(d);
var I=new qx.ui.form.Button(r);
M.add(new qx.ui.core.Spacer(10,10));
M.add(L);
M.add(N);
M.add(I);
L.addListener(m,function(e){var a=K.getChildren().length+1;
var b=new qx.ui.tabview.Page(n+a,l);
K.add(b);
});
N.addListener(m,function(e){var bb=K.getChildren();

if(bb.length>0){K.remove(bb[0]);
}});
I.addListener(m,function(e){var U=K.getChildren();

if(U.length>0){K.remove(U[U.length-1]);
}});
return K;
}}});
})();
