...
u.setMaxListHeight(null);

for(var i=0;i<300;i++){var v=new qx.ui.form.ListItem(j+i);
u.add(v);
}this.container.add(u,{left:20,top:40});
},addBox2:function(){this.container.add(new qx.ui.basic.Label(h),{left:25,bottom:45});
var t=new qx.ui.form.SelectBox();
var o=new qx.bom.Font(12,[e]);
var p=new qx.bom.Font(15,[a]);
var n=new qx.bom.Font(18,[d]);
var r=new qx.bom.Font(21,[m]);
var q=[o,p,n,r];

for(var i=0;i<q.length;i++){var s=new qx.ui.form.ListItem(f+(i+1));
s.setFont(q[i]);
t.add(s);
}this.container.add(t,{left:20,bottom:20});
},addBox3:function(){this.container.add(new qx.ui.basic.Label(k),{left:205,top:20});
var w=new qx.ui.form.SelectBox();
w.setWidth(300);
w.setMaxListHeight(100);

for(var i=0;i<20;i++){var x=new qx.ui.form.ListItem(c+i);
if(i%5==1){x.setEnabled(false);
}w.add(x);
}this.container.add(w,{left:200,top:40});
