...
z.setLabelPath(p);
z.setIconOptions({converter:function(s){return q+s+l;
}});
z.setIconPath(j);
...
qx.Mixin.define(c,{members:{sortByType:function(){var D=this.getItems();
D.sort(function(a,b){if(a.getType()>b.getType()){return 1;
}else if(a.getType()<b.getType()){return -1;
}else{return 0;
}});
},sortByName:function(){var u=this.getItems();
u.sort(function(a,b){return a.getName()>b.getName()?1:-1;
});
}}});
})();
