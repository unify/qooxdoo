...
var x=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});
scroll.add(x);
x.add(this.getBox1());
x.add(this.getBox2());
x.add(this.getBox3());
...
s.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return s;
},getBox2:function(){var D=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:i,backgroundColor:g,minHeight:60,allowGrowX:false});
D.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxHeight:40,alignY:c}));
D.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxHeight:40,alignY:a}));
D.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxHeight:40,alignY:b}));
return D;
},getBox3:function(){var q=new qx.ui.layout.HBox();
var r=new qx.ui.container.Composite(q).set({decorator:i,backgroundColor:g,width:500,allowGrowX:false});
q.setSpacing(5);
q.setAlignX(e);
...
r.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return r;
},getBox4:function(){var j=new qx.ui.layout.HBox();
var k=new qx.ui.container.Composite(j).set({decorator:i,backgroundColor:g,width:500,allowGrowX:false});
j.setSpacing(5);
j.setAlignX(f);
...
k.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return k;
},getBox5:function(){var u=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:i,backgroundColor:g,allowGrowX:false});
...
var n=new qx.ui.container.Composite(l).set({decorator:i,backgroundColor:g,width:500,allowGrowX:false});
l.setSpacing(5);
l.setAlignX(e);
var p=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
...
m.setMarginRight(10);
return n;
},getBox7:function(){var y=new qx.ui.layout.HBox();
var A=new qx.ui.container.Composite(y).set({decorator:i,backgroundColor:g,width:500,allowGrowX:false});
y.setSpacing(5);
y.setAlignX(f);
