...
qx.Class.define(d,{extend:qx.application.Standalone,members:{__NX:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var R=p;
...
--this.__NX;
this.debug("Found ["+this.imageData[j].url+"].  loadCount="+this.__NX+", end="+this.imageData.length);
if(this.__NX==0){this.doLoad();
}return;
...
if(j===undefined){this.__NY=j;
}else{this.__NY=16;
}
if(k===undefined){this.__Oa=k;
}else{this.__Oa=16;
}},members:{__NY:null,__Oa:null,_identifyImage:function(d){var h={imageWidth:this.__NY,imageHeight:this.__Oa};
var i;
